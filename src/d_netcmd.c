...
static CV_PossibleValue_t usemouse_cons_t[] = {
    {0, "Off"}, {1, "On"}, {2, "Force"}, {0, NULL}};
#if (defined(__unix__) && !defined(MSDOS)) || defined(__APPLE__) ||            \
    defined(UNIXCOMMON)
static CV_PossibleValue_t mouse2port_cons_t[] = {
    {0, "/dev/gpmdata"}, {1, "/dev/ttyS0"}, {2, "/dev/ttyS1"},
    {3, "/dev/ttyS2"},   {4, "/dev/ttyS3"}, {0, NULL}};
#else
static CV_PossibleValue_t mouse2port_cons_t[] = {
...
#ifdef LJOYSTICK
static CV_PossibleValue_t joyport_cons_t[] = {{1, "/dev/js0"},
                                              {2, "/dev/js1"},
                                              {3, "/dev/js2"},
                                              {4, "/dev/js3"},
                                              {0, NULL}};
...
static CV_PossibleValue_t autobalance_cons_t[] = {
    {0, "MIN"}, {4, "MAX"}, {0, NULL}};
static CV_PossibleValue_t teamscramble_cons_t[] = {
    {0, "Off"}, {1, "Random"}, {2, "Points"}, {0, NULL}};

static CV_PossibleValue_t startingliveslimit_cons_t[] = {
    {1, "MIN"}, {99, "MAX"}, {0, NULL}};
static CV_PossibleValue_t sleeping_cons_t[] = {
    {0, "MIN"}, {1000 / TICRATE, "MAX"}, {0, NULL}};
static CV_PossibleValue_t competitionboxes_cons_t[] = {
    {0, "Normal"}, {1, "Random"}, {2, "Teleports"}, {3, "None"}, {0, NULL}};

static CV_PossibleValue_t matchboxes_cons_t[] = {
    {0, "Normal"}, {1, "Random"}, {2, "Non-Random"}, {3, "None"}, {0, NULL}};

// static CV_PossibleValue_t chances_cons_t[] = {{0, "MIN"}, {9, "MAX"}, {0,
// NULL}};
static CV_PossibleValue_t match_scoring_cons_t[] = {
    {0, "Normal"}, {1, "Classic"}, {0, NULL}};
static CV_PossibleValue_t pause_cons_t[] = {
    {0, "Server"}, {1, "All"}, {0, NULL}};

static CV_PossibleValue_t timetic_cons_t[] = {
    {0, "Normal"}, {1, "Tics"}, {2, "Centiseconds"}, {0, NULL}};

#ifdef NETGAME_DEVMODE
static consvar_t cv_fishcake = {"fishcake",
                                "Off",
                                CV_CALL | CV_NOSHOWHELP | CV_RESTRICT,
                                CV_OnOff,
                                Fishcake_OnChange,
                                0,
                                NULL,
                                ...
                                NULL};
#endif
static consvar_t cv_dummyconsvar = {"dummyconsvar",
                                    "Off",
                                    CV_CALL | CV_NOSHOWHELP,
                                    CV_OnOff,
...
consvar_t cv_restrictskinchange = {"restrictskinchange",
                                   "No",
                                   CV_NETVAR | CV_CHEAT,
                                   CV_YesNo,
                                   NULL,
                                   ...
                                   0,
                                   NULL};
consvar_t cv_allowteamchange = {"allowteamchange",
                                "Yes",
                                CV_NETVAR,
                                CV_YesNo,
                                NULL,
...
static CV_PossibleValue_t ingamecap_cons_t[] = {
    {0, "MIN"}, {MAXPLAYERS - 1, "MAX"}, {0, NULL}};
consvar_t cv_ingamecap = {"ingamecap", "0", CV_NETVAR, ingamecap_cons_t,
                          NULL,        0,   NULL,      NULL,
                          0,           0,   NULL};

static CV_PossibleValue_t spectatorreentry_cons_t[] = {
    {0, "MIN"}, {10 * 60, "MAX"}, {0, NULL}};
consvar_t cv_spectatorreentry = {"spectatorreentry",
                                 "30",
                                 CV_NETVAR,
                                 spectatorreentry_cons_t,
                                 NULL,
                                 0,
                                 NULL,
                                 NULL,
...
static CV_PossibleValue_t antigrief_cons_t[] = {
    {20, "MIN"}, {180, "MAX"}, {0, "Off"}, {0, NULL}};
consvar_t cv_antigrief = {"antigrief", "30", CV_NETVAR, antigrief_cons_t,
                          NULL,        0,    NULL,      NULL,
                          0,           0,    NULL};

consvar_t cv_startinglives = {"startinglives",
                              "3",
                              CV_NETVAR | CV_CHEAT | CV_NOSHOWHELP,
                              startingliveslimit_cons_t,
                              NULL,
                              0,
                              NULL,
                              NULL,
...
static CV_PossibleValue_t respawntime_cons_t[] = {
    {0, "MIN"}, {30, "MAX"}, {0, NULL}};
consvar_t cv_respawntime = {"respawndelay",
                            "1",
                            CV_NETVAR | CV_CHEAT,
                            respawntime_cons_t,
                            NULL,
...
consvar_t cv_competitionboxes = {"competitionboxes",
                                 "Random",
                                 CV_NETVAR | CV_CHEAT | CV_NOSHOWHELP,
...
#ifdef SEENAMES
static CV_PossibleValue_t seenames_cons_t[] = {
    {0, "Off"}, {1, "Colorless"}, {2, "Team"}, {3, "Ally/Foe"}, {0, NULL}};
consvar_t cv_seenames = {
    "seenames", "Off", CV_SAVE, seenames_cons_t, 0, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_allowseenames = {"allowseenames",
                              "No",
                              CV_NETVAR,
                              CV_YesNo,
                              NULL,
...
consvar_t cv_playername = {"name", "Sonic",       CV_SAVE | CV_CALL | CV_NOINIT,
                           NULL,   Name_OnChange, 0,
                           NULL,   NULL,          0,
                           0,      NULL};
consvar_t cv_playername2 = {"name2",
                            "Tails",
                            ...
                            0,
                            NULL};
consvar_t cv_playername3 = {"name3",
                            "Knuckles",
                            CV_SAVE | CV_CALL | CV_NOINIT,
                            NULL,
                            Name3_OnChange,
                            ...
                            0,
                            NULL};
consvar_t cv_playername4 = {"name4",
                            "Dr. Eggman",
                            CV_SAVE | CV_CALL | CV_NOINIT,
                            NULL,
                            Name4_OnChange,
                            ...
                            NULL};
// player colors
consvar_t cv_playercolor = {"color",
                            "Blue",
                            CV_SAVE | CV_CALL | CV_NOINIT,
                            Color_cons_t,
                            Color_OnChange,
                            ...
                            0,
                            NULL};
consvar_t cv_playercolor2 = {"color2",
                             "Orange",
                             CV_SAVE | CV_CALL | CV_NOINIT,
                             Color_cons_t,
                             Color2_OnChange,
                             ...
                             0,
                             NULL};
consvar_t cv_playercolor3 = {"color3",
                             "Red",
                             CV_SAVE | CV_CALL | CV_NOINIT,
                             Color_cons_t,
                             Color3_OnChange,
                             ...
                             0,
                             NULL};
consvar_t cv_playercolor4 = {"color4",
                             "Red",
                             CV_SAVE | CV_CALL | CV_NOINIT,
                             Color_cons_t,
                             Color4_OnChange,
...
consvar_t cv_skin = {"skin", DEFAULTSKIN,   CV_SAVE | CV_CALL | CV_NOINIT,
                     NULL,   Skin_OnChange, 0,
                     NULL,   NULL,          0,
                     0,      NULL};
consvar_t cv_skin2 = {"skin2",
                      DEFAULTSKIN2,
                      CV_SAVE | CV_CALL | CV_NOINIT,
                      NULL,
                      Skin2_OnChange,
...
consvar_t cv_skipmapcheck = {"skipmapcheck", "Off", CV_SAVE, CV_OnOff, NULL, 0,
                             NULL,           NULL,  0,       0,        NULL};

INT32 cv_debug;

consvar_t cv_usemouse = {"use_mouse",
                         "Off",
                         CV_SAVE | CV_CALL,
                         usemouse_cons_t,
                         I_StartupMouse,
                         ...
                         0,
                         NULL};
consvar_t cv_usemouse2 = {"use_mouse2",
                          "Off",
                          CV_SAVE | CV_CALL,
                          usemouse_cons_t,
                          I_StartupMouse2,
...
consvar_t cv_usejoystick = {"use_joystick",
                            "1",
                            CV_SAVE | CV_CALL,
                            usejoystick_cons_t,
                            I_InitJoystick,
                            ...
                            0,
                            NULL};
consvar_t cv_usejoystick2 = {"use_joystick2",
                             "2",
                             CV_SAVE | CV_CALL,
                             usejoystick_cons_t,
                             I_InitJoystick2,
                             ...
                             0,
                             NULL};
consvar_t cv_usejoystick3 = {"use_joystick3",
                             "3",
                             CV_SAVE | CV_CALL,
                             usejoystick_cons_t,
                             I_InitJoystick3,
                             ...
                             0,
                             NULL};
consvar_t cv_usejoystick4 = {"use_joystick4",
                             "4",
                             CV_SAVE | CV_CALL,
                             usejoystick_cons_t,
                             I_InitJoystick4,
...
consvar_t cv_joyport = {"joyport", "/dev/js0", CV_SAVE, joyport_cons_t,
                        NULL,      0,          NULL,    NULL,
                        0,         0,          NULL};
consvar_t cv_joyport2 = {"joyport2", "/dev/js0", CV_SAVE, joyport_cons_t,
                         NULL,       0,          NULL,    NULL,
                         0,          0,          NULL}; // Alam: for later
#endif
consvar_t cv_joyscale = {
    "joyscale", "1", CV_SAVE | CV_CALL, NULL, I_JoyScale, 0, NULL, NULL, 0,
    0,          NULL};
consvar_t cv_joyscale2 = {
    "joyscale2", "1", CV_SAVE | CV_CALL, NULL, I_JoyScale2, 0, NULL, NULL, 0,
    0,           NULL};
consvar_t cv_joyscale3 = {
    "joyscale3", "1", CV_SAVE | CV_CALL, NULL, I_JoyScale3, 0, NULL, NULL, 0,
    0,           NULL};
consvar_t cv_joyscale4 = {
    "joyscale4", "1", CV_SAVE | CV_CALL, NULL, I_JoyScale4, 0, NULL, NULL, 0,
    0,           NULL};
#if (defined(__unix__) && !defined(MSDOS)) || defined(__APPLE__) ||            \
    defined(UNIXCOMMON)
consvar_t cv_mouse2port = {"mouse2port",
                           "/dev/gpmdata",
                           CV_SAVE,
                           mouse2port_cons_t,
                           NULL,
                           ...
                           0,
                           NULL};
consvar_t cv_mouse2opt = {"mouse2opt", "0",  CV_SAVE, NULL, NULL, 0,
                          NULL,        NULL, 0,       0,    NULL};
#else
consvar_t cv_mouse2port = {
    "mouse2port", "COM2", CV_SAVE, mouse2port_cons_t, NULL, 0, NULL, NULL, 0, 0,
    NULL};
#endif

consvar_t cv_matchboxes = {"matchboxes",
                           "Normal",
                           CV_NETVAR | CV_CHEAT | CV_NOSHOWHELP,
                           matchboxes_cons_t,
                           NULL,
                           ...
                           0,
                           NULL};
consvar_t cv_specialrings = {"specialrings",
                             "On",
                             ...
                             0,
                             NULL};
consvar_t cv_powerstones = {"powerstones",
                            "On",
                            CV_NETVAR | CV_NOSHOWHELP,
                            CV_OnOff,
                            NULL,
...
/*consvar_t cv_recycler =      {"tv_recycler",      "5", CV_NETVAR|CV_CHEAT,
chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL}; consvar_t cv_teleporters =
{"tv_teleporter",    "5", CV_NETVAR|CV_CHEAT, chances_cons_t, NULL, 0, NULL,
NULL, 0, 0, NULL}; consvar_t cv_superring =     {"tv_superring",     "5",
CV_NETVAR|CV_CHEAT, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL}; consvar_t
cv_supersneakers = {"tv_supersneaker",  "5", CV_NETVAR|CV_CHEAT, chances_cons_t,
NULL, 0, NULL, NULL, 0, 0, NULL}; consvar_t cv_invincibility =
{"tv_invincibility", "5", CV_NETVAR|CV_CHEAT, chances_cons_t, NULL, 0, NULL,
NULL, 0, 0, NULL}; consvar_t cv_jumpshield =    {"tv_jumpshield",    "5",
CV_NETVAR|CV_CHEAT, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL}; consvar_t
cv_watershield =   {"tv_watershield",   "5", CV_NETVAR|CV_CHEAT, chances_cons_t,
NULL, 0, NULL, NULL, 0, 0, NULL}; consvar_t cv_ringshield =    {"tv_ringshield",
"5", CV_NETVAR|CV_CHEAT, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_forceshield =   {"tv_forceshield",   "5", CV_NETVAR|CV_CHEAT,
chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL}; consvar_t cv_bombshield =
{"tv_bombshield",    "5", CV_NETVAR|CV_CHEAT, chances_cons_t, NULL, 0, NULL,
NULL, 0, 0, NULL}; consvar_t cv_1up =           {"tv_1up",           "5",
CV_NETVAR|CV_CHEAT, chances_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL}; consvar_t
cv_eggmanbox =     {"tv_eggman",        "5", CV_NETVAR|CV_CHEAT, chances_cons_t,
NULL, 0, NULL, NULL, 0, 0, NULL};*/

// SRB2kart
consvar_t cv_sneaker = {
    "sneaker", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,         NULL};
consvar_t cv_rocketsneaker = {"rocketsneaker",
                              "On",
                              CV_NETVAR | CV_CHEAT,
                              CV_OnOff,
                              NULL,
                              ...
                              0,
                              NULL};
consvar_t cv_invincibility = {"invincibility",
                              "On",
                              CV_NETVAR | CV_CHEAT,
                              CV_OnOff,
                              NULL,
                              ...
                              NULL};
consvar_t cv_banana = {
    "banana", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,        NULL};
consvar_t cv_eggmanmonitor = {"eggmanmonitor",
                              "On",
                              CV_NETVAR | CV_CHEAT,
                              CV_OnOff,
                              NULL,
                              ...
                              0,
                              NULL};
consvar_t cv_orbinaut = {
    "orbinaut", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,          NULL};
consvar_t cv_jawz = {
    "jawz", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,      NULL};
consvar_t cv_mine = {
    "mine", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,      NULL};
consvar_t cv_ballhog = {
    "ballhog", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,         NULL};
consvar_t cv_selfpropelledbomb = {"selfpropelledbomb",
                                  "On",
                                  CV_NETVAR | CV_CHEAT,
                                  CV_OnOff,
                                  NULL,
                                  ...
                                  NULL};
consvar_t cv_grow = {
    "grow", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,      NULL};
consvar_t cv_shrink = {
    "shrink", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,        NULL};
consvar_t cv_thundershield = {"thundershield",
                              "On",
                              CV_NETVAR | CV_CHEAT,
                              CV_OnOff,
                              NULL,
                              ...
                              0,
                              NULL};
consvar_t cv_hyudoro = {
    "hyudoro", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,         NULL};
consvar_t cv_pogospring = {"pogospring",
                           "On",
                           CV_NETVAR | CV_CHEAT,
                           CV_OnOff,
                           NULL,
                           ...
                           0,
                           NULL};
consvar_t cv_kitchensink = {"kitchensink",
                            "On",
                            CV_NETVAR | CV_CHEAT,
                            CV_OnOff,
                            NULL,
...
consvar_t cv_triplesneaker = {"triplesneaker",
                              "On",
                              CV_NETVAR | CV_CHEAT,
                              CV_OnOff,
                              NULL,
                              ...
                              0,
                              NULL};
consvar_t cv_triplebanana = {"triplebanana",
                             "On",
                             CV_NETVAR | CV_CHEAT,
                             CV_OnOff,
                             NULL,
                             ...
                             0,
                             NULL};
consvar_t cv_decabanana = {"decabanana",
                           "On",
                           CV_NETVAR | CV_CHEAT,
                           CV_OnOff,
                           NULL,
                           ...
                           0,
                           NULL};
consvar_t cv_tripleorbinaut = {"tripleorbinaut",
                               "On",
                               CV_NETVAR | CV_CHEAT,
                               CV_OnOff,
                               NULL,
                               ...
                               0,
                               NULL};
consvar_t cv_quadorbinaut = {"quadorbinaut",
                             "On",
                             CV_NETVAR | CV_CHEAT,
                             CV_OnOff,
                             NULL,
                             ...
                             0,
                             NULL};
consvar_t cv_dualjawz = {
    "dualjawz", "On", CV_NETVAR | CV_CHEAT, CV_OnOff, NULL, 0, NULL, NULL, 0,
    0,          NULL};

static CV_PossibleValue_t kartminimap_cons_t[] = {
    {0, "MIN"}, {10, "MAX"}, {0, NULL}};
consvar_t cv_kartminimap = {
    "kartminimap", "4", CV_SAVE, kartminimap_cons_t, NULL, 0, NULL, NULL, 0, 0,
    NULL};
consvar_t cv_kartcheck = {"kartcheck", "Yes", CV_SAVE, CV_YesNo, NULL, 0,
                          NULL,        NULL,  0,       0,        NULL};
static CV_PossibleValue_t kartinvinsfx_cons_t[] = {
    {0, "Music"}, {1, "SFX"}, {0, NULL}};
consvar_t cv_kartinvinsfx = {"kartinvinsfx",
                             "SFX",
                             CV_SAVE,
                             kartinvinsfx_cons_t,
                             NULL,
                             ...
                             0,
                             NULL};
consvar_t cv_kartspeed = {"kartspeed",
                          "Normal",
                          ...
                          0,
                          NULL};
static CV_PossibleValue_t kartbumpers_cons_t[] = {
    {1, "MIN"}, {12, "MAX"}, {0, NULL}};
consvar_t cv_kartbumpers = {"kartbumpers",
                            "3",
                            CV_NETVAR | CV_CHEAT,
                            kartbumpers_cons_t,
                            NULL,
                            ...
                            0,
                            NULL};
consvar_t cv_kartfrantic = {"kartfrantic",
                            "Off",
                            CV_NETVAR | CV_CHEAT | CV_CALL | CV_NOINIT,
                            CV_OnOff,
                            KartFrantic_OnChange,
                            0,
                            NULL,
                            NULL,
                            0,
                            0,
                            NULL};
consvar_t cv_kartcomeback = {"kartcomeback",
                             "On",
                             CV_NETVAR | CV_CHEAT | CV_CALL | CV_NOINIT,
                             CV_OnOff,
                             KartComeback_OnChange,
                             0,
                             NULL,
                             NULL,
                             0,
                             0,
                             NULL};
consvar_t cv_kartencore = {"kartencore",
                           "Off",
                           CV_NETVAR | CV_CALL | CV_NOINIT,
                           CV_OnOff,
                           KartEncore_OnChange,
                           ...
                           0,
                           NULL};
static CV_PossibleValue_t kartvoterulechanges_cons_t[] = {
    {0, "Never"}, {1, "Sometimes"}, {2, "Frequent"}, {3, "Always"}, {0, NULL}};
consvar_t cv_kartvoterulechanges = {"kartvoterulechanges",
                                    "Frequent",
                                    CV_NETVAR,
                                    kartvoterulechanges_cons_t,
                                    NULL,
                                    0,
                                    NULL,
                                    NULL,
                                    ...
                                    0,
                                    NULL};
static CV_PossibleValue_t kartgametypepreference_cons_t[] = {
    {-1, "None"}, {GT_RACE, "Race"}, {GT_MATCH, "Battle"}, {0, NULL}};
consvar_t cv_kartgametypepreference = {"kartgametypepreference",
                                       "None",
                                       CV_NETVAR,
                                       kartgametypepreference_cons_t,
                                       NULL,
                                       0,
                                       NULL,
                                       NULL,
                                       ...
                                       0,
                                       NULL};
static CV_PossibleValue_t kartspeedometer_cons_t[] = {
    {0, "Off"}, {1, "Kilometers"}, {2, "Miles"}, {3, "Fracunits"}, {0, NULL}};
consvar_t cv_kartspeedometer = {"kartdisplayspeed",
                                "Off",
                                CV_SAVE,
                                kartspeedometer_cons_t,
                                NULL,
                                0,
                                NULL,
                                NULL,
                                0,
                                0,
                                NULL}; // use tics in display
static CV_PossibleValue_t kartvoices_cons_t[] = {
    {0, "Never"}, {1, "Tasteful"}, {2, "Meme"}, {0, NULL}};
consvar_t cv_kartvoices = {"kartvoices",
                           "Tasteful",
                           CV_SAVE,
                           kartvoices_cons_t,
                           NULL,
...
consvar_t cv_karteliminatelast = {"karteliminatelast",
                                  "Yes",
                                  CV_NETVAR | CV_CHEAT | CV_CALL |
                                      CV_NOSHOWHELP,
                                  CV_YesNo,
                                  KartEliminateLast_OnChange,
                                  0,
                                  NULL,
                                  NULL,
                                  0,
...
static CV_PossibleValue_t kartdebugitem_cons_t[] = {
    {-1, "MIN"}, {NUMKARTITEMS - 1, "MAX"}, {0, NULL}};
consvar_t cv_kartdebugitem = {"kartdebugitem",
                              "0",
                              CV_NETVAR | CV_CHEAT | CV_NOSHOWHELP,
                              kartdebugitem_cons_t,
                              NULL,
                              0,
                              NULL,
                              NULL,
                              ...
                              0,
                              NULL};
static CV_PossibleValue_t kartdebugamount_cons_t[] = {
    {1, "MIN"}, {255, "MAX"}, {0, NULL}};
consvar_t cv_kartdebugamount = {"kartdebugamount",
                                "1",
                                CV_NETVAR | CV_CHEAT | CV_NOSHOWHELP,
                                kartdebugamount_cons_t,
                                NULL,
                                0,
                                NULL,
                                NULL,
                                ...
                                0,
                                NULL};
consvar_t cv_kartdebugshrink = {"kartdebugshrink",
                                "Off",
                                CV_NETVAR | CV_CHEAT | CV_NOSHOWHELP,
                                CV_OnOff,
                                NULL,
                                ...
                                0,
                                NULL};
consvar_t cv_kartdebugdistribution = {"kartdebugdistribution",
                                      "Off",
                                      CV_NETVAR | CV_CHEAT | CV_NOSHOWHELP,
                                      CV_OnOff,
                                      NULL,
                                      ...
                                      0,
                                      NULL};
consvar_t cv_kartdebughuddrop = {"kartdebughuddrop",
                                 "Off",
                                 CV_NETVAR | CV_CHEAT | CV_NOSHOWHELP,
                                 CV_OnOff,
                                 NULL,
...
consvar_t cv_kartdebugcheckpoint = {"kartdebugcheckpoint",
                                    "Off",
                                    CV_NOSHOWHELP,
                                    CV_OnOff,
                                    NULL,
                                    ...
                                    0,
                                    NULL};
consvar_t cv_kartdebugnodes = {"kartdebugnodes",
                               "Off",
                               CV_NOSHOWHELP,
                               CV_OnOff,
                               NULL,
                               ...
                               0,
                               NULL};
consvar_t cv_kartdebugcolorize = {"kartdebugcolorize",
                                  "Off",
                                  CV_NOSHOWHELP,
                                  CV_OnOff,
                                  NULL,
...
static CV_PossibleValue_t votetime_cons_t[] = {
    {10, "MIN"}, {3600, "MAX"}, {0, NULL}};
consvar_t cv_votetime = {"votetime", "20", CV_NETVAR, votetime_cons_t,
                         NULL,       0,    NULL,      NULL,
                         0,          0,    NULL};

consvar_t cv_ringslinger = {"ringslinger",
                            "No",
                            CV_NETVAR | CV_NOSHOWHELP | CV_CALL | CV_CHEAT,
                            CV_YesNo,
                            ...
                            0,
                            NULL};
consvar_t cv_gravity = {"gravity",
                        "0.8",
                        CV_RESTRICT | CV_FLOAT | CV_CALL,
                        NULL,
                        Gravity_OnChange,
                        0,
                        NULL,
...
consvar_t cv_soundtest = {"soundtest", "0",  CV_CALL, NULL, SoundTest_OnChange,
                          0,           NULL, NULL,    0,    0,
                          NULL};

static CV_PossibleValue_t minitimelimit_cons_t[] = {
    {15, "MIN"}, {9999, "MAX"}, {0, NULL}};
consvar_t cv_countdowntime = {"countdowntime",
                              "30",
                              CV_NETVAR | CV_CHEAT,
                              minitimelimit_cons_t,
                              NULL,
                              0,
                              NULL,
                              NULL,
...
consvar_t cv_touchtag = {"touchtag", "Off", CV_NETVAR | CV_NOSHOWHELP,
                         CV_OnOff,   NULL,  0,
                         NULL,       NULL,  0,
                         0,          NULL};
consvar_t cv_hidetime = {"hidetime",
                         "30",
                         CV_NETVAR | CV_CALL | CV_NOSHOWHELP,
                         minitimelimit_cons_t,
                         Hidetime_OnChange,
                         0,
                         NULL,
...
consvar_t cv_autobalance = {"autobalance",
                            "0",
                            CV_NETVAR | CV_CALL,
                            autobalance_cons_t,
                            AutoBalance_OnChange,
                            0,
                            NULL,
                            NULL,
                            0,
                            0,
                            NULL};
consvar_t cv_teamscramble = {"teamscramble",
                             "Off",
                             CV_NETVAR | CV_CALL | CV_NOINIT,
                             teamscramble_cons_t,
                             ...
                             0,
                             NULL};
consvar_t cv_scrambleonchange = {"scrambleonchange",
                                 "Off",
                                 CV_NETVAR,
                                 teamscramble_cons_t,
                                 NULL,
...
consvar_t cv_friendlyfire = {"friendlyfire",
                             ...
                             0,
                             NULL};
consvar_t cv_itemfinder = {"itemfinder",
                           "Off",
                           CV_CALL | CV_NOSHOWHELP,
                           CV_OnOff,
                           ItemFinder_OnChange,
...
consvar_t cv_match_scoring = {"matchscoring",
                              "Normal",
                              CV_NETVAR | CV_CHEAT | CV_NOSHOWHELP,
                              match_scoring_cons_t,
                              NULL,
                              0,
                              NULL,
                              NULL,
                              ...
                              0,
                              NULL};
consvar_t cv_overtime = {"overtime", "Yes", CV_NETVAR, CV_YesNo, NULL, 0,
                         NULL,       NULL,  0,         0,        NULL};

consvar_t cv_rollingdemos = {"rollingdemos", "On", CV_SAVE, CV_OnOff, NULL, 0,
                             NULL,           NULL, 0,       0,        NULL};

consvar_t cv_timetic = {"timerres",
                        "Normal",
                        CV_SAVE | CV_NOSHOWHELP,
                        timetic_cons_t,
                        NULL,
                        0,
                        NULL,
...
static CV_PossibleValue_t pointlimit_cons_t[] = {
    {0, "MIN"}, {999999990, "MAX"}, {0, NULL}};
consvar_t cv_pointlimit = {"pointlimit",
                           "0",
                           CV_NETVAR | CV_CALL | CV_NOINIT,
                           pointlimit_cons_t,
                           PointLimit_OnChange,
                           ...
                           0,
                           NULL};
static CV_PossibleValue_t timelimit_cons_t[] = {
    {0, "MIN"}, {30, "MAX"}, {0, NULL}};
consvar_t cv_timelimit = {"timelimit",
                          "0",
                          CV_NETVAR | CV_CALL | CV_NOINIT,
                          timelimit_cons_t,
                          TimeLimit_OnChange,
                          ...
                          0,
                          NULL};
static CV_PossibleValue_t numlaps_cons_t[] = {
    {1, "MIN"}, {50, "MAX"}, {0, NULL}};
consvar_t cv_numlaps = {"numlaps",
                        "3",
                        CV_NETVAR | CV_CALL | CV_NOINIT,
                        numlaps_cons_t,
                        NumLaps_OnChange,
                        ...
                        0,
                        NULL};
static CV_PossibleValue_t basenumlaps_cons_t[] = {
    {1, "MIN"}, {50, "MAX"}, {0, "Map default"}, {0, NULL}};
consvar_t cv_basenumlaps = {"basenumlaps",
                            "Map default",
                            CV_NETVAR | CV_CALL | CV_CHEAT,
                            basenumlaps_cons_t,
                            BaseNumLaps_OnChange,
                            0,
                            NULL,
                            NULL,
                            0,
...
consvar_t cv_forceskin = {"forceskin",
                          "Off",
                          CV_NETVAR | CV_CALL | CV_CHEAT,
                          Forceskin_cons_t,
                          ForceSkin_OnChange,
                          ...
                          0,
                          NULL};
consvar_t cv_downloading = {"downloading", "On", 0, CV_OnOff, NULL, 0,
                            NULL,          NULL, 0, 0,        NULL};
consvar_t cv_allowexitlevel = {"allowexitlevel",
                               "No",
                               CV_NETVAR,
                               CV_YesNo,
                               NULL,
...
consvar_t cv_killingdead = {"killingdead",
                            "Off",
                            CV_NETVAR | CV_NOSHOWHELP,
                            CV_OnOff,
                            NULL,
...
consvar_t cv_netstat = {
    "netstat", "Off", 0, CV_OnOff, NULL, 0,
    NULL,      NULL,  0, 0,        NULL}; // show bandwidth statistics
static CV_PossibleValue_t nettimeout_cons_t[] = {
    {TICRATE / 7, "MIN"}, {60 * TICRATE, "MAX"}, {0, NULL}};
consvar_t cv_nettimeout = {"nettimeout",
                           "210",
                           CV_CALL | CV_SAVE,
                           nettimeout_cons_t,
                           NetTimeout_OnChange,
                           ...
                           0,
                           NULL};
// static CV_PossibleValue_t jointimeout_cons_t[] = {{5*TICRATE, "MIN"},
// {60*TICRATE, "MAX"}, {0, NULL}};
consvar_t cv_jointimeout = {"jointimeout",
                            "210",
                            CV_CALL | CV_SAVE,
                            nettimeout_cons_t,
                            JoinTimeout_OnChange,
                            0,
                            NULL,
                            NULL,
                            0,
                            0,
                            NULL};
consvar_t cv_maxping = {"maxdelay", "20", CV_SAVE, CV_Unsigned, NULL, 0,
                        NULL,       NULL, 0,       0,           NULL};

static CV_PossibleValue_t pingtimeout_cons_t[] = {
    {8, "MIN"}, {120, "MAX"}, {0, NULL}};
consvar_t cv_pingtimeout = {"maxdelaytimeout",
                            "10",
                            CV_SAVE,
                            pingtimeout_cons_t,
                            NULL,
...
// show your ping on the HUD next to framerate. Defaults to warning only (shows
// up if your ping is > maxping)
static CV_PossibleValue_t showping_cons_t[] = {
    {0, "Off"}, {1, "Always"}, {2, "Warning"}, {0, NULL}};
consvar_t cv_showping = {"showping", "Always", CV_SAVE, showping_cons_t,
                         NULL,       0,        NULL,    NULL,
                         0,          0,        NULL};

static CV_PossibleValue_t pingmeasurement_cons_t[] = {
    {0, "Frames"}, {1, "Milliseconds"}, {0, NULL}};
consvar_t cv_pingmeasurement = {"pingmeasurement",
                                "Frames",
                                CV_SAVE,
                                pingmeasurement_cons_t,
                                NULL,
                                0,
                                NULL,
                                NULL,
...
static CV_PossibleValue_t inttime_cons_t[] = {
    {0, "MIN"}, {3600, "MAX"}, {0, NULL}};
consvar_t cv_inttime = {"inttime", "20", CV_NETVAR, inttime_cons_t,
                        NULL,      0,    NULL,      NULL,
                        0,         0,    NULL};

static CV_PossibleValue_t advancemap_cons_t[] = {
    {0, "Same"}, {1, "Next"}, {2, "Random"}, {3, "Vote"}, {0, NULL}};
consvar_t cv_advancemap = {"advancemap",
                           "Vote",
                           CV_NETVAR,
                           advancemap_cons_t,
                           NULL,
                           ...
                           0,
                           NULL};
static CV_PossibleValue_t playersforexit_cons_t[] = {
    {0, "One"}, {1, "All"}, {0, NULL}};
consvar_t cv_playersforexit = {"playersforexit",
                               "One",
                               CV_NETVAR,
                               playersforexit_cons_t,
                               NULL,
                               0,
                               NULL,
                               NULL,
...
consvar_t cv_runscripts = {"runscripts", "Yes", 0, CV_YesNo, NULL, 0,
                           NULL,         NULL,  0, 0,        NULL};

consvar_t cv_pause = {"pausepermission",
                      "Server",
                      CV_NETVAR,
                      pause_cons_t,
                      NULL,
                      ...
                      0,
                      NULL};
consvar_t cv_mute = {"mute",   "Off",         CV_NETVAR | CV_CALL,
                     CV_OnOff, Mute_OnChange, 0,
                     NULL,     NULL,          0,
                     0,        NULL};

consvar_t cv_sleep = {"cpusleep", "1", CV_SAVE, sleeping_cons_t,
                      NULL,       -1,  NULL,    NULL,
                      0,          0,   NULL};
...
const char *netxcmdnames[MAXNETXCMD - 1] = {
    "NAMEANDCOLOR", "WEAPONPREF",  "KICK",       "NETVAR",   "SAY",
    "MAP",          "EXITLEVEL",   "ADDFILE",    "PAUSE",    "ADDPLAYER",
    "TEAMCHANGE",   "CLEARSCORES", "LOGIN",      "VERIFIED", "RANDOMSEED",
    "RUNSOC",       "REQADDFILE",  "DELFILE",    "SETMOTD",  "RESPAWN",
    "DEMOTED",      "SETUPVOTE",   "MODIFYVOTE", "PICKVOTE", "REMOVEPLAYER",
    "LUACMD",       "LUAVAR"};
...
void D_RegisterServerCommands(void) {
  ...
  // Set the values to 0/NULL, it will be overwritten later when a skin is
  ...
  COM_AddCommand(
      "login", Command_Login_f); // useful in dedicated to kick off remote admin
...
static void SetPlayerName(INT32 playernum, char *newname) {
  if (EnsurePlayerNameIsGood(newname, playernum)) {
    if (strcasecmp(newname, player_names[playernum]) != 0) {
      if (netgame)
        HU_AddChatText(
            va("\x82*%s renamed to %s", player_names[playernum], newname),
            false);
...
CanChangeSkin(INT32 playernum) {
  ...
  if (client && (cv_forceskin.value != -1) &&
      !(IsPlayerAdmin(playernum) && serverplayer == -1))
    return false;
  ...
  if (cv_restrictskinchange.value) {
    ...
    if (G_TagGametype()) {
      ...
      // IT players can always change skins to persue players hiding in
      // character only locations.
...
static void ForceAllSkins(INT32 forcedskin) {
  ...
  for (i = 0; i < MAXPLAYERS; ++i) {
    ...
    // If it's me (or my brother (or my sister (or my trusty pet dog))), set
    // appropriate skin value in cv_skin
...
static INT32 snacpending = 0, snac2pending = 0, snac3pending = 0,
             snac4pending = 0, chmappending = 0;
...
static void SendNameAndColor(void) {
  ...
  if (G_GametypeHasTeams()) {
    if (players[consoleplayer].ctfteam == 1 &&
        cv_playercolor.value != skincolor_redteam)
      CV_StealthSetValue(&cv_playercolor, skincolor_redteam);
    else if (players[consoleplayer].ctfteam == 2 &&
             cv_playercolor.value != skincolor_blueteam)
  ...
  if (!cv_playercolor.value) {
    if (players[consoleplayer].skincolor)
      ...
      CV_StealthSetValue(&cv_playercolor,
                         skins[players[consoleplayer].skin].prefcolor);
    else
  ...
  if (!netgame) {
    ...
    if (metalrecording) { // Metal Sonic is Sonic, obviously.
      ...
      {
              CV_StealthSetValue(&cv_playercolor,
      skins[cv_skin.value].prefcolor);

              players[consoleplayer].skincolor = (cv_playercolor.value&0x3F) %
      MAXSKINCOLORS;

              if (players[consoleplayer].mo)
                      players[consoleplayer].mo->color =
      (UINT8)players[consoleplayer].skincolor;
      }*/
    } else {
...
static void SendNameAndColor2(void) {
  ...
  // normal player colors
  if (G_GametypeHasTeams()) {
    if (players[secondplaya].ctfteam == 1 &&
        cv_playercolor2.value != skincolor_redteam)
      CV_StealthSetValue(&cv_playercolor2, skincolor_redteam);
    else if (players[secondplaya].ctfteam == 2 &&
             cv_playercolor2.value != skincolor_blueteam)
  ...
  if (!cv_playercolor2.value) {
    if (players[secondplaya].skincolor)
      ...
      CV_StealthSetValue(&cv_playercolor2,
                         skins[players[secondplaya].skin].prefcolor);
    else
  ...
  if (botingame) {
    ...
    if ((foundskin = R_SkinAvailable(cv_skin2.string)) != -1) {
      ...
      skins[players[secondplaya].skin].prefcolor);
              ...
              players[secondplaya].skincolor = (cv_playercolor2.value&0x3F) %
      MAXSKINCOLORS;

              if (players[secondplaya].mo)
                      players[secondplaya].mo->color =
      players[secondplaya].skincolor;
      }*/
    } else {
...
static void SendNameAndColor3(void) {
  ...
  // normal player colors
  if (G_GametypeHasTeams()) {
    if (players[thirdplaya].ctfteam == 1 &&
        cv_playercolor3.value != skincolor_redteam)
      CV_StealthSetValue(&cv_playercolor3, skincolor_redteam);
    else if (players[thirdplaya].ctfteam == 2 &&
             cv_playercolor3.value != skincolor_blueteam)
  ...
  if (!cv_playercolor3.value) {
    if (players[thirdplaya].skincolor)
      ...
      CV_StealthSetValue(&cv_playercolor3,
                         skins[players[thirdplaya].skin].prefcolor);
    else
  ...
  if (!netgame) {
    ...
    if ((foundskin = R_SkinAvailable(cv_skin3.string)) != -1) {
      ...
      skins[players[thirdplaya].skin].prefcolor);
              ...
              players[thirdplaya].skincolor = (cv_playercolor3.value&0x3F) %
      MAXSKINCOLORS;

              if (players[thirdplaya].mo)
                      players[thirdplaya].mo->color =
      players[thirdplaya].skincolor;
      }*/
    } else {
...
static void SendNameAndColor4(void) {
  ...
  // normal player colors
  if (G_GametypeHasTeams()) {
    if (players[fourthplaya].ctfteam == 1 &&
        cv_playercolor4.value != skincolor_redteam)
      CV_StealthSetValue(&cv_playercolor4, skincolor_redteam);
    else if (players[fourthplaya].ctfteam == 2 &&
             cv_playercolor4.value != skincolor_blueteam)
  ...
  if (!cv_playercolor4.value) {
    if (players[fourthplaya].skincolor)
      ...
      CV_StealthSetValue(&cv_playercolor4,
                         skins[players[fourthplaya].skin].prefcolor);
    else
  ...
  if (botingame) {
    ...
    if ((foundskin = R_SkinAvailable(cv_skin4.string)) != -1) {
      ...
      skins[players[fourthplaya].skin].prefcolor);
              ...
              players[fourthplaya].skincolor = (cv_playercolor4.value&0x3F) %
      MAXSKINCOLORS;

              if (players[fourthplaya].mo)
                      players[fourthplaya].mo->color =
      players[fourthplaya].skincolor;
      }*/
    } else {
...
static void Got_NameAndColor(UINT8 **cp, INT32 playernum) {
  ...
  if (playernum == consoleplayer)
    snacpending--; // TODO: make snacpending an array instead of 4 separate
                   // vars?
...
#ifdef PARANOIA
  if (snacpending < 0 || snac2pending < 0 || snac3pending < 0 ||
      snac4pending < 0)
  ...
  // normal player colors
  if (server &&
      (p != &players[consoleplayer] && p != &players[displayplayers[1]] &&
  ...
  if (cv_forceskin.value >= 0 &&
      (netgame || multiplayer)) // Server wants everyone to use the same player
  {
...
static void Command_Playdemo_f(void) {
  ...
  if (COM_Argc() < 2) {
    ...
    CONS_Printf(M_GetText("Play back a demo file. The full path from your Kart "
                          "directory must be given.\n\n"

                          "* With \"-addfiles\", any required files are added "
                          "from a list contained within the demo file.\n"
                          "* With \"-force\", the demo is played even if the "
                          "necessary files have not been added.\n"));
    return;
  }
...
static void Command_StopMovie_f(void) { M_StopMovie(); }
 ...
 * \author Graue <graue@oceanbase.org>
 */
void D_MapChange(INT32 mapnum, INT32 newgametype, boolean pencoremode,
                 boolean resetplayers, INT32 delay, boolean skipprecutscene,
                 boolean FLS) {
  ...
  CONS_Debug(DBG_GAMELOGIC,
             "Map change: mapnum=%d gametype=%d encoremode=%d resetplayers=%d "
             "delay=%d skipprecutscene=%d\n",
             mapnum, newgametype, pencoremode, resetplayers, delay,
             skipprecutscene);
  ...
  if (delay == 1)
    ...
    if (!IsPlayerAdmin(consoleplayer)) {
      if (SV_SpawnServer())
        buf[0] &= ~(1 << 1);
      if (!Playing()) // you failed to start a server somehow, so cancel the map
                      // change
        return;
    }
...
void D_SetupVote(void) {
  UINT8 buf[5 * 2]; // four UINT16 maps (at twice the width of a UINT8), and two
                    // gametypes
  UINT8 *p = buf;
  INT32 i;
  ...
  for (i = 0; i < 4; i++) {
    ...
    if (i == 2) // sometimes a different gametype
      ...
      m = G_RandMap(G_TOLFlag(gt), prevmap, false, (i - 2), (i < 4),
                    votebuffer);
    else
      m = G_RandMap(G_TOLFlag(gt), prevmap, false, 0, true, votebuffer);
    if (i < 3)
      votebuffer[min(i, 2)] =
          m; // min() is a dumb workaround for gcc 4.4 array-bounds error
    WRITEUINT16(p, m);
  }
...
static void Command_Map_f(void) {
  ...
  if (option_gametype) {
    ...
    {
      CONS_Alert(CONS_ERROR, "No gametype name follows parameter '%s'.\n",
  ...
  if (first_option < 2) {
    ...
    CONS_Printf("map <name / [MAP]code / number> [-gametype <type>] [-encore] "
                "[-force]:\n");
    CONS_Printf(M_GetText(
        "Warp to a map, by its name, two character code, with optional \"MAP\" "
        "prefix, or by its number (though why would you).\n"
  ...
  if (newmapnum == 0) {
    CONS_Alert(CONS_ERROR,
               M_GetText("Could not find any map described as '%s'.\n"),
               mapname);
    Z_Free(mapname);
    return;
  }
  ...
  if (option_gametype) {
    ...
    if (newgametype == -1) // reached end of the list with no match
    {
      ...
      if (isdigit(gametypename[0])) {
        ...
        CONS_Alert(CONS_ERROR, "'%s' is not a gametype.\n", gametypename);
        Z_Free(realmapname);
        Z_Free(mapname);
        return;
      }
  ...
  // G_TOLFlag handles both multiplayer gametype and ignores it for !multiplayer
    ...
    if (!(mapheaderinfo[newmapnum - 1]->typeoflevel & G_TOLFlag(newgametype))) {
      CONS_Alert(CONS_WARNING,
                 M_GetText("Course %s (%s) doesn't support %s mode!\n(Use "
                           "-force to override)\n"),
                 realmapname, G_BuildMapName(newmapnum),
                 (multiplayer ? gametype_cons_t[newgametype].strvalue
                              : "Single Player"));
      Z_Free(realmapname);
      Z_Free(mapname);
      return;
  ...
  // ... unless you're in a dedicated server.  Yes, technically this means you
  // can view any level by running a dedicated server and joining it yourself,
  // but that's better than making dedicated server's lives hell.
  if (!dedicated && M_MapLocked(newmapnum)) {
    CONS_Alert(
        CONS_NOTICE,
        M_GetText(
            "You need to unlock this level before you can warp to it!\n"));
    Z_Free(realmapname);
    Z_Free(mapname);
    return;
  }
  ...
  if (option_encore) {
    ...
    if (!M_SecretUnlocked(SECRET_ENCORE) && newencoremode) {
      CONS_Alert(CONS_NOTICE,
                 M_GetText("You haven't unlocked Encore Mode yet!\n"));
      return;
    }
  }

  fromlevelselect = false;
  D_MapChange(newmapnum, newgametype, newencoremode, newresetplayers, 0, false,
              false);
...
static void Got_Mapcmd(UINT8 **cp, INT32 playernum) {
  ...
  if (!skipprecutscene) {
    DEBFILE(va(
        "Warping to %s [resetplayer=%d lastgametype=%d gametype=%d cpnd=%d]\n",
  ...
  if (modeattacking) // i remember moving this here in internal fixed a
                     // heisenbug so
  ...
  demo.savemode =
      (cv_recordmultiplayerdemos.value == 2) ? DSM_WILLAUTOSAVE : DSM_NOTSAVING;
  demo.savebutton = 0;
...
static void Got_Pause(UINT8 **cp, INT32 playernum) {
  ...
  if (netgame && !cv_pause.value && playernum != serverplayer &&
      !IsPlayerAdmin(playernum)) {
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal pause command received from %s\n"),
               player_names[playernum]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
...
static void Command_Respawn(void) {
  ...
  if (players[consoleplayer].mo &&
      !P_IsObjectOnGround(
          players[consoleplayer].mo)) // KART: Nice try, but no, you won't be
                                      // cheesing spb anymore.
  {
  ...
  if (players[consoleplayer].mo &&
      (players[consoleplayer].kartstuff[k_spinouttimer] ||
       spbplace ==
           players[consoleplayer]
               .kartstuff[k_position])) // KART: Nice try, but no, you won't be
                                        // cheesing spb anymore (x2)
  {
    CONS_Printf(M_GetText("Nice try.\n"));
    return;
  }

  /*if (!G_RaceGametype()) // srb2kart: not necessary, respawning makes you lose
  a bumper in battle, so it's not desirable to use as a way to escape a hit
  {
          CONS_Printf(M_GetText("You may only use this in co-op, race, and
  competition!\n")); return;
  }*/
  ...
  /*if (!(netgame || multiplayer))
  {
          CONS_Printf(M_GetText("You can't use this in Single Player! Use
  \"retry\" instead.\n")); return;
  }*/
...
static void Got_Respawn(UINT8 **cp, INT32 playernum) {
  ...
  if (respawnplayer != playernum ||
      players[respawnplayer].kartstuff[k_spinouttimer] ||
      spbplace ==
          players[respawnplayer]
              .kartstuff[k_position]) // srb2kart: "|| (!G_RaceGametype())"
  {
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal respawn command received from %s\n"),
               player_names[playernum]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
  ...
  // incase the above checks were modified to allow sending a respawn on these
  // occasions:
  if (players[respawnplayer].mo &&
      !P_IsObjectOnGround(players[respawnplayer].mo))
    return;
...
static void Got_Clearscores(UINT8 **cp, INT32 playernum) {
  ...
  if (playernum != serverplayer && !IsPlayerAdmin(playernum)) {
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal clear scores command received from %s\n"),
               player_names[playernum]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
...
static void Command_Teamchange_f(void) {
  ...
  if (COM_Argc() <= 1) {
    if (G_GametypeHasTeams())
      ...
      CONS_Alert(CONS_NOTICE,
                 M_GetText("This command cannot be used in this gametype.\n"));
    return;
  }
  ...
  if (G_GametypeHasTeams()) {
    ...
    else if (!strcasecmp(COM_Argv(1), "spectator") ||
             !strcasecmp(COM_Argv(1), "0"))
    ...
    if (!strcasecmp(COM_Argv(1), "spectator") || !strcasecmp(COM_Argv(1), "0"))
      NetPacket.packet.newteam = 0;
    else if (!strcasecmp(COM_Argv(1), "playing") ||
             !strcasecmp(COM_Argv(1), "1"))
  ...
  if (players[consoleplayer].spectator)
    error = !(NetPacket.packet.newteam ||
              (players[consoleplayer].pflags & PF_WANTSTOJOIN)); // :lancer:
  else if (G_GametypeHasTeams())
    error =
        (NetPacket.packet.newteam == (unsigned)players[consoleplayer].ctfteam);
  ...
  if (!cv_allowteamchange.value &&
      NetPacket.packet
          .newteam) // allow swapping to spectator even in locked teams.
  {
    CONS_Alert(
        CONS_NOTICE,
        M_GetText("The server is not allowing team changes at the moment.\n"));
    return;
  }

  // additional check for hide and seek. Don't allow change of status after
  // hidetime ends.
  if (gametype == GT_HIDEANDSEEK && leveltime >= (hidetime * TICRATE)) {
    CONS_Alert(
        CONS_NOTICE,
        M_GetText(
            "Hiding time expired; no Hide and Seek status changes allowed!\n"));
    return;
  }
...
static void Command_Teamchange2_f(void) {
  ...
  if (players[displayplayers[1]].spectator)
    error = !(NetPacket.packet.newteam ||
              (players[displayplayers[1]].pflags & PF_WANTSTOJOIN));
  else if (G_GametypeHasTeams())
    error = (NetPacket.packet.newteam ==
             (unsigned)players[displayplayers[1]].ctfteam);
...
static void Command_Teamchange3_f(void) {
  ...
  if (players[displayplayers[2]].spectator)
    error = !(NetPacket.packet.newteam ||
              (players[displayplayers[2]].pflags & PF_WANTSTOJOIN));
  else if (G_GametypeHasTeams())
    error = (NetPacket.packet.newteam ==
             (unsigned)players[displayplayers[2]].ctfteam);
...
static void Command_Teamchange4_f(void) {
  ...
  if (players[displayplayers[3]].spectator)
    error = !(NetPacket.packet.newteam ||
              (players[displayplayers[3]].pflags & PF_WANTSTOJOIN));
  else if (G_GametypeHasTeams())
    error = (NetPacket.packet.newteam ==
             (unsigned)players[displayplayers[3]].ctfteam);
...
static void Command_ServerTeamChange_f(void) {
  ...
  if (COM_Argc() < 3) {
    if (G_TagGametype())
      CONS_Printf(M_GetText("serverchangeteam <playernum> <team>: switch "
  ...
  if (G_TagGametype()) {
    if (!strcasecmp(COM_Argv(2), "it") || !strcasecmp(COM_Argv(2), "1"))
      ...
      NetPacket.packet.newteam = 2;
    else if (!strcasecmp(COM_Argv(2), "playing") ||
             !strcasecmp(COM_Argv(2), "3"))
      NetPacket.packet.newteam = 3;
    else if (!strcasecmp(COM_Argv(2), "spectator") ||
             !strcasecmp(COM_Argv(2), "0"))
      NetPacket.packet.newteam = 0;
    else
      error = true;
  } else if (G_GametypeHasTeams()) {
  ...
  if (G_TagGametype()) {
    if (((players[NetPacket.packet.playernum].pflags & PF_TAGIT) &&
         NetPacket.packet.newteam == 1) ||
        (!(players[NetPacket.packet.playernum].pflags & PF_TAGIT) &&
         NetPacket.packet.newteam == 2) ||
        (players[NetPacket.packet.playernum].spectator &&
    ...
    if (NetPacket.packet.newteam ==
            (unsigned)players[NetPacket.packet.playernum].ctfteam ||
        (players[NetPacket.packet.playernum].spectator &&
         !NetPacket.packet.newteam))
      error = true;
  } else if (G_GametypeHasSpectators()) {
    if ((players[NetPacket.packet.playernum].spectator &&
         !NetPacket.packet.newteam) ||
        (!players[NetPacket.packet.playernum].spectator &&
         NetPacket.packet.newteam == 3))
      error = true;
  ...
  if (error) {
    CONS_Alert(CONS_NOTICE,
               M_GetText("That player is already on that team!\n"));
    return;
  }
  ...
  NetPacket.packet.verification =
      true; // This signals that it's a server change

  usvalue = SHORT(NetPacket.value.l | NetPacket.value.b);
  SendNetXCmd(XD_TEAMCHANGE, &usvalue, sizeof(usvalue));
}

// todo: This and the other teamchange functions are getting too long and messy.
// Needs cleaning.
static void Got_Teamchange(UINT8 **cp, INT32 playernum) {
  changeteam_union NetPacket;
  ...
  if (!G_GametypeHasTeams() &&
      !G_GametypeHasSpectators()) // Make sure you're in the right gametype.
  {
    // this should never happen unless the client is hacked/buggy
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal team change received from player %s\n"),
               player_names[playernum]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
  ...
  if (NetPacket.packet
          .verification) // Special marker that the server sent the request
  {
    if (playernum != serverplayer && (!IsPlayerAdmin(playernum))) {
      CONS_Alert(CONS_WARNING,
                 M_GetText("Illegal team change received from player %s\n"),
  ...
  if (players[playernum].spectator &&
    ...
    if (NetPacket.packet.newteam &&
        (NetPacket.packet.newteam == (unsigned)players[playernum].ctfteam))
      return;
  } else if (G_GametypeHasSpectators()) {
  ...
  // Make sure that the right team number is sent. Keep in mind that normal
  // clients cannot change to certain teams in certain gametypes.
  switch (gametype) {
  case GT_HIDEANDSEEK:
  ...
  default:
    ...
    if (!cv_allowteamchange.value) {
      if (!NetPacket.packet.verification && NetPacket.packet.newteam)
        error =
            true; // Only admin can change status, unless changing to spectator.
    }
    break; // Otherwise, you don't need special permissions.
  }

  if (server &&
      ((NetPacket.packet.newteam < 0 || NetPacket.packet.newteam > 3) ||
       error)) {
    XBOXSTATIC UINT8 buf[2];
  ...
  if (G_TagGametype()) {
    ...
    {
      players[playernum].pflags |=
          PF_WANTSTOJOIN; // players[playernum].spectator = false;
    ...
    } else // Just join the game.
    {
      ...
      if (gametype == GT_TAG && (leveltime > (hidetime * TICRATE))) {
        NetPacket.packet.newteam =
            1; // minor hack, causes the "is it" message to be printed later.
  ...
  if (NetPacket.packet.autobalance) {
    if (NetPacket.packet.newteam == 1)
      CONS_Printf(M_GetText("%s was autobalanced to the %c%s%c.\n"),
                  player_names[playernum], '\x85', M_GetText("Red Team"),
                  '\x80');
    else if (NetPacket.packet.newteam == 2)
      CONS_Printf(M_GetText("%s was autobalanced to the %c%s%c.\n"),
                  player_names[playernum], '\x84', M_GetText("Blue Team"),
                  '\x80');
    ...
    HU_AddChatText(
        va("\x82*%s became a spectator.", player_names[playernum]),
        false); // "entered the game" text was moved to P_SpectatorJoinGame
...
//
#include "md5.h"
static void D_MD5PasswordPass(const UINT8 *buffer, size_t len, const char *salt,
                              void *dest) {
#ifdef NOMD5
  (void)buffer;
  (void)len;
...
static void Command_Changepassword_f(void) {
#ifdef NOMD5
  // If we have no MD5 support then completely disable XD_LOGIN responses for
  // security.
  CONS_Alert(
      CONS_NOTICE,
      "Remote administration commands are not supported in this build.\n");
#else
  ...
  if (COM_Argc() != 2) {
    CONS_Printf(
        M_GetText("password <password>: change remote admin password\n"));
    return;
  }
...
static void Command_Login_f(void) {
  ...
  D_MD5PasswordPass(finalmd5, MD5_LEN, va("PNUM%02d", consoleplayer),
                    &finalmd5);

  CONS_Printf(M_GetText(
      "Sending login... (Notice only given if password is correct.)\n"));
...
static void Got_Login(UINT8 **cp, INT32 playernum) {
  ...
  D_MD5PasswordPass(adminpassmd5, MD5_LEN, va("PNUM%02d", playernum),
                    &finalmd5);
...
void SetAdminPlayer(INT32 playernum) {
  ...
  for (i = 0; i < MAXPLAYERS; i++) {
    ...
    if (adminplayers[i] == -1) {
      ...
      break; // End the loop now. If it keeps going, the same player might get
...
static void Command_RemoveAdmin_f(void) {
  ...
  if (COM_Argc() != 2) {
    CONS_Printf(
        M_GetText("demote <node>: remove admin privileges from a node\n"));
    return;
  }
...
static void Got_Removal(UINT8 **cp, INT32 playernum) {
  ...
  if (playernum != serverplayer) // it's not from the server (hacker or bug)
  {
    CONS_Alert(
        CONS_WARNING,
        M_GetText("Illegal demotion received from %s (serverplayer is %s)\n"),
        player_names[playernum], player_names[serverplayer]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
...
static void Command_MotD_f(void) {
  ...
  if ((netgame || multiplayer) && client)
    SendNetXCmd(XD_SETMOTD, mymotd,
                i); // send the actual size of the motd string, not the full
                    // buffer's size
  else {
    strcpy(motd, mymotd);
...
static void Got_MotD_f(UINT8 **cp, INT32 playernum) {
  ...
  if ((playernum != serverplayer && !IsPlayerAdmin(playernum)) || kick) {
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal motd change received from %s\n"),
               player_names[playernum]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
...
static void Got_RunSOCcmd(UINT8 **cp, INT32 playernum) {
  ...
  if (playernum != serverplayer && !IsPlayerAdmin(playernum)) {
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal runsoc command received from %s\n"),
               player_names[playernum]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
...
static void Command_Addfile(void) {
  ...
  // Add file on your client directly if it is trivial, or you aren't in a
  // netgame.
...
static void Got_RequestAddfilecmd(UINT8 **cp, INT32 playernum) {
  ...
  if ((playernum != serverplayer && !IsPlayerAdmin(playernum)) || kick) {
    ...
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal addfile command received from %s\n"),
               player_names[playernum]);
...
static void Got_Delfilecmd(UINT8 **cp, INT32 playernum) {
  if (playernum != serverplayer && playernum != adminplayer) {
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal delfile command received from %s\n"),
               player_names[playernum]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
  ...
  if (ncs != FS_FOUND || !P_AddWadFile(filename)) {
    ...
    if (ncs == FS_FOUND) {
      CONS_Printf(M_GetText("The server tried to add %s,\nbut you have too "
                            "many files added.\nRestart the game to clear "
                            "loaded files\nand play on this server."),
                  filename);
      M_StartMessage(
          va("The server added a file \n(%s)\nbut you have too many files "
      ...
      CONS_Printf(
          ...
          filename);
      M_StartMessage(
          va("Checksum mismatch while loading \n%s.\nThe server seems to have "
             "a\ndifferent version of this file.\n\nPress ESC\n",
             filename),
          NULL, MM_NOTHING);
    } else {
      CONS_Printf(
          M_GetText("Unknown error finding wad file (%s) the server added.\n"),
          filename);
      M_StartMessage(va("Unknown error trying to load a file\nthat the server "
                        "added \n(%s).\n\nPress ESC\n",
                        filename),
...
static void Command_Version_f(void) {
#ifdef DEVELOP
  CONS_Printf("SRB2Kart %s-%s (%s %s)\n", compbranch, comprevision, compdate,
              comptime);
#else
 ...
 */
FUNCNORETURN static ATTRNORETURN void Command_Quit_f(void) { I_Quit(); }
...
static void PointLimit_OnChange(void) {
  ...
  if (cv_pointlimit.value) {
    CONS_Printf(M_GetText("Levels will end after %s scores %d point%s.\n"),
                G_GametypeHasTeams() ? M_GetText("a team")
                                     : M_GetText("someone"),
...
static void NumLaps_OnChange(void) {
  ...
  if (server && Playing() && (netgame || multiplayer) &&
...
static void TimeLimit_OnChange(void) {
  ...
  if (cv_timelimit.value != 0) {
    CONS_Printf(M_GetText("Levels will end after %d minute%s.\n"),
                cv_timelimit.value,
                cv_timelimit.value == 1 ? "" : "s"); // Graue 11-17-2003
...
void D_GameTypeChanged(INT32 lastgametype) {
  ...
  if (server && (multiplayer || netgame)) {
    ...
    case GT_MATCH:
    case GT_TEAMMATCH:
      if (!cv_timelimit.changed &&
          !cv_pointlimit.changed) // user hasn't changed limits
      {
      ...
      if (!cv_itemrespawntime.changed)
        CV_Set(&cv_itemrespawntime,
               cv_itemrespawntime.defaultvalue); // respawn normally
      break;
    case GT_TAG:
    case GT_HIDEANDSEEK:
      if (!cv_timelimit.changed &&
          !cv_pointlimit.changed) // user hasn't changed limits
      {
        ...
        // Note that tag mode also uses an alternate timing mechanism in
        // tandem with timelimit.
  ...
  if (server) {
    if (G_RaceGametype()) {
      ...
      if (cv_pointlimit.value)
        CV_SetValue(&cv_pointlimit, 0);
    } else if ((cv_pointlimit.changed || cv_timelimit.changed) &&
               cv_pointlimit.value) {
  ...
  // don't retain teams in other modes or between changes from ctf to team
  // match. also, stop any and all forms of team scrambling that might otherwise
  // take place.
  if (G_GametypeHasTeams()) {
    INT32 i;
    for (i = 0; i < MAXPLAYERS; i++)
...
static void Ringslinger_OnChange(void) {
  if (!M_SecretUnlocked(SECRET_PANDORA) && !netgame && cv_ringslinger.value &&
      !cv_debug) {
    CONS_Printf(M_GetText("You haven't earned this yet.\n"));
...
static void TeamScramble_OnChange(void) {
  ...
  // If a team scramble is already in progress, do not allow another one to be
  // started!
  if (teamscramble)
    return;
...
retryscramble:
  ...
  // Clear related global variables. These will get used again in
  // p_tick.c/y_inter.c as the teams are scrambled.
  ...
  if (cv_teamscramble.value == 1) {
    ...
    for (i = 0; i < playercount; i++) {
      ...
      // One team has the most players they can get, assign the rest to the
      // other team.
  ...
  } else if (cv_teamscramble.value ==
             2) // Same as before, except split teams based on current score.
  {
    ...
    for (i = 1; i < playercount; i++) {
      for (j = i; j < playercount; j++) {
        ...
        if ((players[scrambleplayers[i - 1]].score >
             players[scrambleplayers[j]].score)) {
    ...
    // If there is an odd number, one team will end up with the unlucky slob who
    // has no points. =(
    for (i = 0; i < playercount; i++) {
      if (repick) {
        newteam = (INT16)((M_RandomByte() % 2) + 1);
  ...
  // Display a witty message, but only during scrambles specifically triggered
  // by an admin.
  if (cv_teamscramble.value) {
...
static void Hidetime_OnChange(void) {
  ...
  if (G_TagGametype())
    timelimitintics =
        (cv_timelimit.value * 60 * TICRATE) + (hidetime * TICRATE);
}
  ...
  if (gamestate == GS_LEVEL) {
    if (mapheaderinfo[gamemap - 1]->zonttl[0] &&
      ...
      if (mapheaderinfo[gamemap - 1]->actnum[0])
        CONS_Printf("%s (%d): %s %s %s\n", G_BuildMapName(gamemap), gamemap,
                    mapheaderinfo[gamemap - 1]->lvlttl,
                    mapheaderinfo[gamemap - 1]->zonttl,
...
static void Got_ExitLevelcmd(UINT8 **cp, INT32 playernum) {
  ...
  if (playernum != serverplayer && !IsPlayerAdmin(playernum)) {
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal exitlevel command received from %s\n"),
               player_names[playernum]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
...
void Command_Retry_f(void) {
  ...
  /*else if (!&players[consoleplayer] || players[consoleplayer].lives <= 1)
          CONS_Printf(M_GetText("You can't retry without any lives
...
static void Command_Isgamemodified_f(void) {
  if (majormods)
    CONS_Printf("The game has been modified with major addons, so you cannot "
                "play Record Attack.\n");
  else if (savemoddata)
    CONS_Printf("The game has been modified with an addon with its own save "
                "data, so you can play Record Attack and earn medals.\n");
  else if (modifiedgame)
    CONS_Printf("The game has been modified with only minor addons. You can "
                "play Record Attack, earn medals and unlock extras.\n");
  else
    CONS_Printf("The game has not been modified. You can play Record Attack, "
                "earn medals and unlock extras.\n");
}
...
static void Command_Cheats_f(void) {
  ...
  if (CV_CheatsEnabled()) {
    ...
    if (server || (IsPlayerAdmin(consoleplayer)))
      CONS_Printf(M_GetText(
          "Type CHEATS OFF to reset all cheat variables to default.\n"));
  } else
    CONS_Printf(M_GetText(
        "No CHEAT-marked variables are changed -- Cheats are disabled.\n"));
}

#ifdef _DEBUG
static void Command_Togglemodified_f(void) { modifiedgame = !modifiedgame; }
...
static void Name_OnChange(void) {
  if (cv_mute.value && !(server || IsPlayerAdmin(consoleplayer))) {
    CONS_Alert(CONS_NOTICE,
               M_GetText("You may not change your name when chat is muted.\n"));
    CV_StealthSet(&cv_playername, player_names[consoleplayer]);
  } else
    SendNameAndColor();
}
...
static void Skin_OnChange(void) {
  ...
  if (CanChangeSkin(consoleplayer) && !P_PlayerMoving(consoleplayer))
    ...
    CONS_Alert(CONS_NOTICE,
               M_GetText("You can't change your skin at the moment.\n"));
    CV_StealthSet(&cv_skin, skins[players[consoleplayer].skin].name);
  }
}
...
static void Color_OnChange(void) {
  ...
  if (!(cv_debug || devparm) &&
      !(multiplayer || netgame || modeattacking)) // In single player.
  {
    CV_StealthSet(&cv_skin, skins[players[consoleplayer].skin].name);
    return;
  }
...
static void Color2_OnChange(void) {
  ...
  if (!P_PlayerMoving(displayplayers[1])) {
    ...
    CV_StealthSetValue(&cv_playercolor2, players[displayplayers[1]].skincolor);
  }
}
...
static void Color3_OnChange(void) {
  ...
  if (!P_PlayerMoving(displayplayers[2])) {
    ...
    CV_StealthSetValue(&cv_playercolor3, players[displayplayers[2]].skincolor);
  }
}
...
static void Color4_OnChange(void) {
  ...
  if (!P_PlayerMoving(displayplayers[3])) {
    ...
    CV_StealthSetValue(&cv_playercolor4, players[displayplayers[3]].skincolor);
  }
}
...
static void Mute_OnChange(void) {
  /*if (server || (IsPlayerAdmin(consoleplayer)))
          return;*/
  // Kinda dumb IMO, you should be able to see confirmation for having muted the
  // chat as the host or admin.

  if (leveltime <= 1)
    return; // avoid having this notification put in our console / log when we
            // boot the server.
...
static void BaseNumLaps_OnChange(void) {
  if (gamestate == GS_LEVEL) {
    if (cv_basenumlaps.value)
      CONS_Printf(
          M_GetText("Number of laps will be changed to %d next round.\n"),
          cv_basenumlaps.value);
    else
      CONS_Printf(M_GetText(
          "Number of laps will be changed to map defaults next round.\n"));
  }
}
...
static void KartSpeed_OnChange(void) {
  if (G_RaceGametype()) {
    if ((UINT8)cv_kartspeed.value != gamespeed && gamestate == GS_LEVEL &&
        leveltime > starttime)
      CONS_Printf(
          M_GetText("Game speed will be changed to \"%s\" next round.\n"),
          cv_kartspeed.string);
    else {
...
static void KartEncore_OnChange(void) {
  if (G_RaceGametype()) {
    if ((boolean)cv_kartencore.value != encoremode &&
...
static void KartComeback_OnChange(void) {
  if (G_BattleGametype()) {
    if ((boolean)cv_kartcomeback.value != comeback && gamestate == GS_LEVEL &&
        leveltime > starttime)
...
void Got_DiscordInfo(UINT8 **p, INT32 playernum) {
  if (playernum != serverplayer /*&& !IsPlayerAdmin(playernum)*/) {
    ...
    CONS_Alert(CONS_WARNING,
               M_GetText("Illegal Discord info command received from %s\n"),
               player_names[playernum]);
    if (server) {
      XBOXSTATIC UINT8 buf[2];
