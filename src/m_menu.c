...
// static saveinfo_t savegameinfo[MAXSAVEGAMES]; // Extra info about the save
// games.
...
static INT32 (*setupcontrols)[2]; // pointer to the gamecontrols of the player
                                  // being edited
...
// static menu_t SP_NightsAttackDef, SP_NightsReplayDef,
// SP_NightsGuestReplayDef, SP_NightsGhostDef;
...
static UINT8 playback_enterheld =
    0; // horrid hack to prevent holding the button from being extremely fucked
...
consvar_t cv_showfocuslost = {
    "showfocuslost", "Yes", CV_SAVE, CV_YesNo, NULL, 0, NULL, NULL, 0, 0, NULL};

static CV_PossibleValue_t map_cons_t[] = {
    {0, "MIN"}, {NUMMAPS, "MAX"}, {0, NULL}};
consvar_t cv_nextmap = {"nextmap",
                        "1",
                        CV_HIDEN | CV_CALL,
                        map_cons_t,
                        Nextmap_OnChange,
...
consvar_t cv_chooseskin = {"chooseskin",
                           DEFAULTSKIN,
                           CV_HIDEN | CV_CALL,
                           skins_cons_t,
                           Nextmap_OnChange,
...
// When you add gametypes here, don't forget to update them in dehacked.c and
// doomstat.h!
CV_PossibleValue_t gametype_cons_t[NUMGAMETYPES + 1];

consvar_t cv_newgametype = {"newgametype",
                            "Race",
                            CV_HIDEN | CV_CALL,
                            gametype_cons_t,
...
static CV_PossibleValue_t serversort_cons_t[] = {{0, "Ping"},
                                                 {1, "Modified State"},
                                                 {2, "Most Players"},
                                                 {3, "Least Players"},
                                                 {4, "Max Player Slots"},
                                                 {5, "Gametype"},
                                                 {0, NULL}};
consvar_t cv_serversort = {"serversort",
                           "Ping",
                           CV_CALL,
                           serversort_cons_t,
                           M_SortServerList,
...
static consvar_t cv_autorecord = {"autorecord", "Yes", 0, CV_YesNo, NULL, 0,
                                  NULL,         NULL,  0, 0,        NULL};

CV_PossibleValue_t ghost_cons_t[] = {
    {0, "Hide"}, {1, "Show Character"}, {2, "Show All"}, {0, NULL}};
CV_PossibleValue_t ghost2_cons_t[] = {{0, "Hide"}, {1, "Show"}, {0, NULL}};

consvar_t cv_ghost_besttime = {"ghost_besttime",
                               "Show All",
                               CV_SAVE,
                               ghost_cons_t,
                               NULL,
                               ...
                               0,
                               NULL};
consvar_t cv_ghost_bestlap = {"ghost_bestlap",
                              "Show All",
                              CV_SAVE,
                              ghost_cons_t,
                              NULL,
                              ...
                              0,
                              NULL};
consvar_t cv_ghost_last = {
    "ghost_last", "Show All", CV_SAVE, ghost_cons_t, NULL, 0, NULL,
    NULL,         0,          0,       NULL};
consvar_t cv_ghost_guest = {
    "ghost_guest", "Show", CV_SAVE, ghost2_cons_t, NULL, 0, NULL,
    NULL,          0,      0,       NULL};
consvar_t cv_ghost_staff = {
    "ghost_staff", "Show", CV_SAVE, ghost2_cons_t, NULL, 0, NULL,
    NULL,          0,      0,       NULL};
...
CV_PossibleValue_t splitplayers_cons_t[] = {
    {1, "One"}, {2, "Two"}, {3, "Three"}, {4, "Four"}, {0, NULL}};
consvar_t cv_splitplayers = {"splitplayers",
                             "One",
                             CV_CALL,
                             splitplayers_cons_t,
                             Splitplayers_OnChange,
                             0,
                             NULL,
                             NULL,
                             0,
...
static CV_PossibleValue_t dummymenuplayer_cons_t[] = {
    {0, "NOPE"}, {1, "P1"}, {2, "P2"}, {3, "P3"}, {4, "P4"}, {0, NULL}};
static CV_PossibleValue_t dummyteam_cons_t[] = {
    {0, "Spectator"}, {1, "Red"}, {2, "Blue"}, {0, NULL}};
static CV_PossibleValue_t dummyspectate_cons_t[] = {
    {0, "Spectator"}, {1, "Playing"}, {0, NULL}};
static CV_PossibleValue_t dummyscramble_cons_t[] = {
    {0, "Random"}, {1, "Points"}, {0, NULL}};
static CV_PossibleValue_t ringlimit_cons_t[] = {
    {0, "MIN"}, {9999, "MAX"}, {0, NULL}};
static CV_PossibleValue_t liveslimit_cons_t[] = {
    {0, "MIN"}, {99, "MAX"}, {0, NULL}};
/*static CV_PossibleValue_t dummymares_cons_t[] = {
        {-1, "END"}, {0,"Overall"}, {1,"Mare 1"}, {2,"Mare 2"}, {3,"Mare 3"},
{4,"Mare 4"}, {5,"Mare 5"}, {6,"Mare 6"}, {7,"Mare 7"}, {8,"Mare 8"}, {0,NULL}
};*/
static CV_PossibleValue_t dummystaff_cons_t[] = {
    {0, "MIN"}, {100, "MAX"}, {0, NULL}};

static consvar_t cv_dummymenuplayer = {"dummymenuplayer",
                                       "P1",
                                       CV_HIDEN | CV_CALL,
                                       dummymenuplayer_cons_t,
                                       ...
                                       0,
                                       NULL};
static consvar_t cv_dummyteam = {
    "dummyteam", "Spectator", CV_HIDEN, dummyteam_cons_t, NULL, 0, NULL, NULL,
    0,           0,           NULL};
static consvar_t cv_dummyspectate = {"dummyspectate",
                                     "Spectator",
                                     CV_HIDEN,
                                     dummyspectate_cons_t,
                                     NULL,
                                     0,
                                     NULL,
                                     NULL,
                                     ...
                                     0,
                                     NULL};
static consvar_t cv_dummyscramble = {"dummyscramble",
                                     "Random",
                                     CV_HIDEN,
                                     dummyscramble_cons_t,
                                     NULL,
                                     0,
                                     NULL,
                                     NULL,
                                     ...
                                     0,
                                     NULL};
static consvar_t cv_dummyrings = {
    "dummyrings", "0", CV_HIDEN, ringlimit_cons_t, NULL, 0, NULL, NULL, 0, 0,
    NULL};
static consvar_t cv_dummylives = {
    "dummylives", "0", CV_HIDEN, liveslimit_cons_t, NULL, 0, NULL, NULL, 0, 0,
    NULL};
static consvar_t cv_dummycontinues = {"dummycontinues",
                                      "0",
                                      CV_HIDEN,
                                      liveslimit_cons_t,
                                      NULL,
                                      ...
                                      0,
                                      NULL};
// static consvar_t cv_dummymares = {"dummymares", "Overall", CV_HIDEN|CV_CALL,
// dummymares_cons_t, Dummymares_OnChange, 0, NULL, NULL, 0, 0, NULL};
static consvar_t cv_dummystaff = {"dummystaff",
                                  "0",
                                  CV_HIDEN | CV_CALL,
                                  dummystaff_cons_t,
                                  Dummystaff_OnChange,
...
static menuitem_t MISC_AddonsMenu[] = {
    {IT_KEYHANDLER | IT_NOTHING, NULL, "", M_HandleAddons,
     0}, // dummy menuitem for the control func
};

static menuitem_t MISC_ReplayHutMenu[] = {
    {IT_KEYHANDLER | IT_NOTHING, NULL, "", M_HandleReplayHutList,
     0}, // Dummy menuitem for the replay list
    {IT_NOTHING, NULL, "", NULL,
     0}, // Dummy for handling wrapping to the top of the menu..
};
...
static menuitem_t MISC_ReplayOptionsMenu[] = {
    {IT_CVAR | IT_STRING, NULL, "Record Replays", &cv_recordmultiplayerdemos,
     0},
    {IT_CVAR | IT_STRING, NULL, "Sync Check Interval", &cv_netdemosyncquality,
     10},
};

static tic_t playback_last_menu_interaction_leveltime = 0;
static menuitem_t PlaybackMenu[] = {
    {IT_CALL | IT_STRING, "M_PHIDE", "Hide Menu (Esc)", M_SelectableClearMenus,
     0},

    {IT_CALL | IT_STRING, "M_PREW", "Rewind ([)", M_PlaybackRewind, 20},
    {IT_CALL | IT_STRING, "M_PPAUSE", "Pause (\\)", M_PlaybackPause, 36},
    {IT_CALL | IT_STRING, "M_PFFWD", "Fast-Forward (])", M_PlaybackFastForward,
     52},
    {IT_CALL | IT_STRING, "M_PSTEPB", "Backup Frame ([)", M_PlaybackRewind, 20},
    {IT_CALL | IT_STRING, "M_PRESUM", "Resume", M_PlaybackPause, 36},
    {IT_CALL | IT_STRING, "M_PFADV", "Advance Frame (])", M_PlaybackAdvance,
     52},

    {IT_ARROWS | IT_STRING, "M_PVIEWS", "View Count (- and =)",
     M_PlaybackSetViews, 72},
    {IT_ARROWS | IT_STRING, "M_PNVIEW", "Viewpoint (1)", M_PlaybackAdjustView,
     88},
    {IT_ARROWS | IT_STRING, "M_PNVIEW", "Viewpoint 2 (2)", M_PlaybackAdjustView,
     104},
    {IT_ARROWS | IT_STRING, "M_PNVIEW", "Viewpoint 3 (3)", M_PlaybackAdjustView,
     120},
    {IT_ARROWS | IT_STRING, "M_PNVIEW", "Viewpoint 4 (4)", M_PlaybackAdjustView,
     136},

    {IT_CALL | IT_STRING, "M_PVIEWS", "Toggle Free Camera (')",
     M_PlaybackToggleFreecam, 156},
...
typedef enum { mapause_continue, mapause_retry, mapause_abort } mapause_e;
...
static menuitem_t MPauseMenu[] = {
    ...
    {IT_STRING | IT_SUBMENU, NULL, "Scramble Teams...", &MISC_ScrambleTeamDef,
     16},
    {IT_STRING | IT_CALL, NULL, "Switch Map...", M_MapChange, 24},

#ifdef HAVE_DISCORDRPC
    {IT_STRING | IT_SUBMENU, NULL, "Ask To Join Requests...",
     &MISC_DiscordRequestsDef, 24},
#endif

    {IT_CALL | IT_STRING, NULL, "Continue", M_SelectableClearMenus, 40},
    {IT_CALL | IT_STRING, NULL, "P1 Setup...", M_SetupMultiPlayer,
     48}, // splitscreen
    {IT_CALL | IT_STRING, NULL, "P2 Setup...", M_SetupMultiPlayer2,
     56}, // splitscreen
    {IT_CALL | IT_STRING, NULL, "P3 Setup...", M_SetupMultiPlayer3,
     64}, // splitscreen
    {IT_CALL | IT_STRING, NULL, "P4 Setup...", M_SetupMultiPlayer4,
     72}, // splitscreen
    ...
    {IT_STRING | IT_SUBMENU, NULL, "Enter/Spectate...", &MISC_ChangeSpectateDef,
     48},
    {IT_CALL | IT_STRING, NULL, "Player Setup...", M_SetupMultiPlayer,
     56}, // alone
...
static menuitem_t SPauseMenu[] = {
    ...
    //{IT_CALL | IT_STRING,    NULL, "Level Select...", M_LoadGameLevelSelect,
    // 32},
...
static menuitem_t SR_MainMenu[] = {
    ...
    {IT_CALL | IT_STRING | IT_CALL_NOTMODIFIED, NULL, "Statistics",
     M_Statistics, 108},
...
static menuitem_t SP_MainMenu[] = {
    //{IT_CALL | IT_STRING,                       NULL, "Start Game",
    //M_LoadGame,
    // 92},
    {IT_SECRET, NULL, "Record Attack", M_TimeAttack, 100},
    //{IT_SECRET,                                 NULL, "NiGHTS Mode",
    // M_NightsAttack,   108},
    {IT_CALL | IT_STRING | IT_CALL_NOTMODIFIED, NULL, "Statistics",
     M_Statistics, 108},
};
...
{
        {IT_KEYHANDLER | IT_NOTHING, NULL, "", M_HandleLoadSave, '\0'},     //
dummy menuitem for the control func
};
...
static menuitem_t SP_TimeAttackMenu[] = {
    ...
    {IT_WHITESTRING | IT_CALL | IT_CALL_NOTMODIFIED, NULL, "Start",
     M_ChooseTimeAttack, 130},
};
...
static menuitem_t SP_ReplayMenu[] = {
    {IT_WHITESTRING | IT_CALL, NULL, "Replay Best Time", M_ReplayTimeAttack,
     90},
    ...
    {IT_WHITESTRING | IT_KEYHANDLER, NULL, "Replay Staff", M_HandleStaffReplay,
     122},
...
{
        {IT_WHITESTRING|IT_CALL, NULL, "Replay Best Score", M_ReplayTimeAttack,
0}, {IT_WHITESTRING|IT_CALL, NULL, "Replay Best Time",  M_ReplayTimeAttack,16},
        ...
        {IT_WHITESTRING|IT_KEYHANDLER, NULL, "Replay
Staff",M_HandleStaffReplay,37},

        {IT_WHITESTRING|IT_SUBMENU, NULL, "Back",           &SP_NightsAttackDef,
50}
};*/

static menuitem_t SP_GuestReplayMenu[] = {
    {IT_WHITESTRING | IT_CALL, NULL, "Save Best Time as Guest",
     M_SetGuestReplay, 94},
    {IT_WHITESTRING | IT_CALL, NULL, "Save Best Lap as Guest", M_SetGuestReplay,
     102},
    {IT_WHITESTRING | IT_CALL, NULL, "Save Last as Guest", M_SetGuestReplay,
     110},

    {IT_WHITESTRING | IT_CALL, NULL, "Delete Guest Replay", M_SetGuestReplay,
     120},
...
{
        {IT_WHITESTRING|IT_CALL, NULL, "Save Best Score as Guest",
M_SetGuestReplay, 8}, {IT_WHITESTRING|IT_CALL, NULL, "Save Best Time as Guest",
M_SetGuestReplay,16}, {IT_WHITESTRING|IT_CALL, NULL, "Save Last as Guest",
M_SetGuestReplay,24},

        {IT_WHITESTRING|IT_CALL, NULL, "Delete Guest Replay",
M_SetGuestReplay,37},
...
{
        {IT_STRING|IT_CVAR,         NULL, "Best Score",  &cv_ghost_bestscore,
0}, {IT_STRING|IT_CVAR,         NULL, "Best Time",   &cv_ghost_besttime,  8},
...
/*static menuitem_t SP_NightsAttackMenu[] =
{
        ...
        {IT_STRING|IT_CVAR,        NULL, "Show Records For", &cv_dummymares,
54},

        {IT_DISABLED,              NULL, "Guest Option...",
&SP_NightsGuestReplayDef,   108}, {IT_DISABLED,              NULL, "Replay...",
&SP_NightsReplayDef,        118}, {IT_DISABLED,              NULL, "Ghosts...",
&SP_NightsGhostDef,         128}, {IT_WHITESTRING|IT_CALL|IT_CALL_NOTMODIFIED,
NULL, "Start",            M_ChooseNightsAttack, 138},
};*/
...
static menuitem_t MP_MainMenu[] = {
    ...
    {IT_STRING | IT_CVAR, NULL, "Number of local players", &cv_splitplayers,
     10},

    {IT_STRING | IT_KEYHANDLER, NULL, "Player setup...", M_SetupMultiHandler,
     18},

    {IT_HEADER, NULL, "Host a game", NULL, 100 - 24},
#ifndef NONET
    {IT_STRING | IT_CALL, NULL, "Internet/LAN...", M_PreStartServerMenu,
     110 - 24},
#else
    {IT_GRAYEDOUT, NULL, "Internet/LAN...", NULL, 110 - 24},
#endif
    {IT_STRING | IT_CALL, NULL, "Offline...", M_StartOfflineServerMenu,
     118 - 24},

    {IT_HEADER, NULL, "Join a game", NULL, 132 - 24},
#ifndef NONET
    {IT_STRING | IT_CALL, NULL, "Internet server browser...", M_PreConnectMenu,
     142 - 24},
    {IT_STRING | IT_KEYHANDLER, NULL,
     "Specify IPv4 address:", M_HandleConnectIP, 150 - 24},
#else
    ...
    //{IT_STRING|IT_CALL,       NULL, "Name, character, color...",
    // M_SetupMultiPlayer,       90},
};
...
static menuitem_t MP_ServerMenu[] = {
    ...
    {IT_STRING | IT_CVAR | IT_CV_STRING, NULL, "Server Name", &cv_servername,
     30},
...
static menuitem_t MP_PlayerSetupMenu[] = {
    ...
    {IT_KEYHANDLER | IT_STRING, NULL, "Character", M_HandleSetupMultiPlayer,
     16}, // Tails 01-18-2001
...
enum { mp_connect_sort, mp_connect_page, mp_connect_refresh, FIRSTSERVERLINE };
#endif
...
static menuitem_t OP_MainMenu[] = {
    ...
    {IT_SUBMENU | IT_STRING, NULL, "Gameplay Options...", &OP_GameOptionsDef,
     70},
    {IT_SUBMENU | IT_STRING, NULL, "Server Options...", &OP_ServerOptionsDef,
     80},
...
static menuitem_t OP_ControlsMenu[] = {
    {IT_CALL | IT_STRING, NULL, "Player 1 Controls...", M_Setup1PControlsMenu,
     10},
    {IT_CALL | IT_STRING, NULL, "Player 2 Controls...", M_Setup2PControlsMenu,
     20},

    {IT_CALL | IT_STRING, NULL, "Player 3 Controls...", &M_Setup3PControlsMenu,
     30},
    {IT_CALL | IT_STRING, NULL, "Player 4 Controls...", &M_Setup4PControlsMenu,
     40},
...
/*static menuitem_t OP_MouseOptionsMenu[] =
{
        ...
        {IT_STRING | IT_CVAR, NULL, "First-Person MouseLook",
&cv_alwaysfreelook,   30}, {IT_STRING | IT_CVAR, NULL, "Third-Person MouseLook",
&cv_chasefreelook,   40}, {IT_STRING | IT_CVAR, NULL, "Mouse Move",
&cv_mousemove,        50}, {IT_STRING | IT_CVAR, NULL, "Invert Mouse",
&cv_invertmouse,      60}, {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL, "Mouse X
Speed",    &cv_mousesens,        70}, {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL,
"Mouse Y Speed",    &cv_mouseysens,        80},
};
...
static menuitem_t OP_Mouse2OptionsMenu[] =
{
        ...
        {IT_STRING | IT_CVAR, NULL, "Second Mouse Serial Port",
                                                        &cv_mouse2port, 20},
        {IT_STRING | IT_CVAR, NULL, "First-Person MouseLook",
&cv_alwaysfreelook2,  30}, {IT_STRING | IT_CVAR, NULL, "Third-Person MouseLook",
&cv_chasefreelook2,  40}, {IT_STRING | IT_CVAR, NULL, "Mouse Move",
&cv_mousemove2,       50}, {IT_STRING | IT_CVAR, NULL, "Invert Mouse",
&cv_invertmouse2,     60}, {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL, "Mouse X
Speed",    &cv_mousesens2,       70}, {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL,
"Mouse Y Speed",    &cv_mouseysens2,      80},
};*/

static menuitem_t OP_VideoOptionsMenu[] = {
    {IT_STRING | IT_CALL, NULL, "Set Resolution...", M_VideoModeMenu, 10},
    {IT_STRING | IT_CVAR, NULL, "Fullscreen", &cv_fullscreen, 20},
    {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL, "Gamma", &cv_usegamma, 30},

    {IT_STRING | IT_CVAR, NULL, "Draw Distance", &cv_drawdist, 45},
    //{IT_STRING | IT_CVAR,	NULL,	"NiGHTS Draw Dist",
    //&cv_drawdist_nights,	 55},
    {IT_STRING | IT_CVAR, NULL, "Weather Draw Distance", &cv_drawdist_precip,
     55},
    //{IT_STRING | IT_CVAR,	NULL,	"Weather Density",
    //&cv_precipdensity,		 65},
    ...
    {IT_SUBMENU | IT_STRING, NULL, "OpenGL Options...", &OP_OpenGLOptionsDef,
     130},
};
...
static menuitem_t OP_VideoModeMenu[] = {
    {IT_KEYHANDLER | IT_NOTHING, NULL, "", M_HandleVideoMode,
     '\0'}, // dummy menuitem for the control func
};

static menuitem_t OP_OpenGLOptionsMenu[] = {
    {IT_STRING | IT_CVAR, NULL, "3D Models", &cv_grmdls, 10},
    {IT_STRING | IT_CVAR, NULL, "Fallback Player 3D Model",
     &cv_grfallbackplayermodel, 20},
    ...
    {IT_STRING | IT_CVAR, NULL, "Sprite Billboarding", &cv_grspritebillboarding,
     100},
...
static menuitem_t OP_SoundOptionsMenu[] = {
    ...
    {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL, "SFX Volume", &cv_soundvolume,
     18},

    {IT_STRING | IT_CVAR, NULL, "Music", &cv_gamedigimusic, 30},
    {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL, "Music Volume",
     &cv_digmusicvolume, 38},

    /* -- :nonnathisshit:
            {IT_STRING|IT_CVAR,			NULL, "MIDI",
    &cv_gamemidimusic,		 50}, {IT_STRING|IT_CVAR|IT_CV_SLIDER, NULL,
    "MIDI Volume",			&cv_midimusicvolume,	 58}, #ifdef
    PC_DOS {IT_STRING|IT_CVAR|IT_CV_SLIDER, NULL, "CD Volume",
    &cd_volume,				 40}, #endif*/

    //{IT_STRING|IT_CALL,			NULL, "Restart Audio System",
    // M_RestartAudio,			 50},

    {IT_STRING | IT_CVAR, NULL, "Reverse L/R Channels", &stereoreverse, 50},
    {IT_STRING | IT_CVAR, NULL, "Surround Sound", &surround, 60},

    {IT_STRING | IT_CVAR, NULL, "Chat Notifications", &cv_chatnotifications,
     75},
    ...
    {IT_STRING | IT_CVAR, NULL, "Play Music While Unfocused",
     &cv_playmusicifunfocused, 125},
    {IT_STRING | IT_CVAR, NULL, "Play SFX While Unfocused",
     &cv_playsoundifunfocused, 135},
};

static menuitem_t OP_DataOptionsMenu[] = {

    {IT_STRING | IT_CALL, NULL, "Screenshot Options...", M_ScreenshotOptions,
     10},
    {IT_STRING | IT_CALL, NULL, "Addon Options...", M_AddonsOptions, 20},
    {IT_STRING | IT_SUBMENU, NULL, "Replay Options...", &MISC_ReplayOptionsDef,
     30},
#ifdef HAVE_DISCORDRPC
    {IT_STRING | IT_SUBMENU, NULL, "Discord Options...", &OP_DiscordOptionsDef,
     40},
...
static menuitem_t OP_ScreenshotOptionsMenu[] = {
    ...
    {IT_STRING | IT_CVAR | IT_CV_STRING, NULL, "Custom Folder",
     &cv_screenshot_folder, 20},
...
static menuitem_t OP_AddonsOptionsMenu[] = {
    ...
    {IT_STRING | IT_CVAR, NULL, "Show unsupported file types",
     &cv_addons_showall, 58},
...
static menuitem_t OP_HUDOptionsMenu[] = {
    ...
    {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL, "HUD Visibility",
     &cv_translucenthud, 20},

    {IT_STRING | IT_SUBMENU, NULL, "Online HUD options...", &OP_ChatOptionsDef,
     35},
    {IT_STRING | IT_CVAR, NULL, "Background Glass", &cons_backcolor, 45},

    {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL, "Minimap Visibility",
     &cv_kartminimap, 60},
    ...
    // highlight info - (GOOD HIGHLIGHT, WARNING HIGHLIGHT) - 105 (see
    // M_DrawHUDOptions)
...
// Ok it's still called chatoptions but we'll put ping display in here to be
// clean
static menuitem_t OP_ChatOptionsMenu[] = {
    // will ANYONE who doesn't know how to use the console want to touch this
    // one?
    {IT_STRING | IT_CVAR, NULL, "Chat Mode", &cv_consolechat,
     10}, // nonetheless...

    {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL, "Chat Box Width", &cv_chatwidth,
     25},
    {IT_STRING | IT_CVAR | IT_CV_SLIDER, NULL, "Chat Box Height",
     &cv_chatheight, 35},
    ...
    {IT_STRING | IT_CVAR, NULL, "Local ping display", &cv_showping,
     90}, // shows ping next to framerate if we want to.
};

static menuitem_t OP_GameOptionsMenu[] = {
    {IT_STRING | IT_SUBMENU, NULL, "Random Item Toggles...",
     &OP_MonitorToggleDef, 10},
    ...
    {IT_STRING | IT_CVAR, NULL, "Restrict Character Changes",
     &cv_restrictskinchange, 150},
};
...
static menuitem_t OP_ServerOptionsMenu[] = {
    ...
    {IT_STRING | IT_CVAR, NULL, "Voting Rule Changes", &cv_kartvoterulechanges,
     70},

#ifndef NONET
    {IT_STRING | IT_CVAR, NULL, "Max. Player Count", &cv_maxplayers, 90},
    {IT_STRING | IT_CVAR, NULL, "Allow Players to Join", &cv_allownewplayer,
     100},
    {IT_STRING | IT_CVAR, NULL, "Allow Addon Downloading", &cv_downloading,
     110},
    {IT_STRING | IT_CVAR, NULL, "Pause Permission", &cv_pause, 120},
    {IT_STRING | IT_CVAR, NULL, "Mute All Chat", &cv_mute, 130},

    {IT_SUBMENU | IT_STRING, NULL, "Advanced Options...",
     &OP_AdvServerOptionsDef, 150},
#endif
};

#ifndef NONET
static menuitem_t OP_AdvServerOptionsMenu[] = {
    {IT_STRING | IT_CVAR | IT_CV_STRING, NULL, "Server Browser Address",
     &cv_masterserver, 10},

    {IT_STRING | IT_CVAR, NULL, "Attempts to resynchronise",
     &cv_resynchattempts, 40},
    {IT_STRING | IT_CVAR, NULL, "Delay limit (frames)", &cv_maxping, 50},
    {IT_STRING | IT_CVAR, NULL, "Delay timeout (s)", &cv_pingtimeout, 60},
    {IT_STRING | IT_CVAR, NULL, "Connection timeout (tics)", &cv_nettimeout,
     70},
    {IT_STRING | IT_CVAR, NULL, "Join timeout (tics)", &cv_jointimeout, 80},

    {IT_STRING | IT_CVAR, NULL, "Max. file transfer send (KB)", &cv_maxsend,
     100},
    {IT_STRING | IT_CVAR, NULL, "File transfer packet rate", &cv_downloadspeed,
     110},
...
/*static menuitem_t OP_NetgameOptionsMenu[] =
{
        ...
        {IT_STRING | IT_CVAR, NULL, "Point Limit",           &cv_pointlimit,
18},

        {IT_STRING | IT_CVAR, NULL, "Frantic Items",         &cv_kartfrantic,
34},

        {IT_STRING | IT_CVAR, NULL, "Item Respawn",          &cv_itemrespawn,
50}, {IT_STRING | IT_CVAR, NULL, "Item Respawn Delay",     &cv_itemrespawntime,
58},

        {IT_STRING | IT_CVAR, NULL, "Player Respawn Delay",  &cv_respawntime,
74},

        {IT_STRING | IT_CVAR, NULL, "Force Skin #",          &cv_forceskin, 90},
        {IT_STRING | IT_CVAR, NULL, "Restrict Skin Changes",
&cv_restrictskinchange, 98},

        //{IT_STRING | IT_CVAR, NULL, "Autobalance Teams", &cv_autobalance,
114},
        //{IT_STRING | IT_CVAR, NULL, "Scramble Teams on Map Change",
&cv_scrambleonchange, 122},
};*/
...
/*static menuitem_t OP_GametypeOptionsMenu[] =
{
        ...
        {IT_STRING | IT_CVAR, NULL, "Use Map Lap Counts",    &cv_usemapnumlaps,
34},

        {IT_HEADER,           NULL, "BATTLE",                NULL, 50},
        {IT_STRING | IT_CVAR, NULL, "Starting Bumpers",     &cv_kartbumpers,
58}, {IT_STRING | IT_CVAR, NULL, "Karma Comeback",        &cv_kartcomeback, 66},
};*/
...
static menuitem_t OP_MonitorToggleMenu[] = {
    ...
    // Instead of using this for dumb monitors, lets use the new item bools we
    // have :V
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Sneakers", M_HandleMonitorToggles,
     KITEM_SNEAKER},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Sneakers x3", M_HandleMonitorToggles,
     KRITEM_TRIPLESNEAKER},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Rocket Sneakers",
     M_HandleMonitorToggles, KITEM_ROCKETSNEAKER},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Toggle All", M_HandleMonitorToggles, 0},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Bananas", M_HandleMonitorToggles,
     KITEM_BANANA},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Bananas x3", M_HandleMonitorToggles,
     KRITEM_TRIPLEBANANA},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Bananas x10", M_HandleMonitorToggles,
     KRITEM_TENFOLDBANANA},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Eggman Monitors",
     M_HandleMonitorToggles, KITEM_EGGMAN},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Orbinauts", M_HandleMonitorToggles,
     KITEM_ORBINAUT},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Orbinauts x3", M_HandleMonitorToggles,
     KRITEM_TRIPLEORBINAUT},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Orbinauts x4", M_HandleMonitorToggles,
     KRITEM_QUADORBINAUT},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Mines", M_HandleMonitorToggles,
     KITEM_MINE},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Jawz", M_HandleMonitorToggles,
     KITEM_JAWZ},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Jawz x2", M_HandleMonitorToggles,
     KRITEM_DUALJAWZ},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Ballhogs", M_HandleMonitorToggles,
     KITEM_BALLHOG},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Self-Propelled Bombs",
     M_HandleMonitorToggles, KITEM_SPB},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Invinciblity", M_HandleMonitorToggles,
     KITEM_INVINCIBILITY},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Grow", M_HandleMonitorToggles,
     KITEM_GROW},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Shrink", M_HandleMonitorToggles,
     KITEM_SHRINK},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Thunder Shields",
     M_HandleMonitorToggles, KITEM_THUNDERSHIELD},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Hyudoros", M_HandleMonitorToggles,
     KITEM_HYUDORO},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Pogo Springs", M_HandleMonitorToggles,
     KITEM_POGOSPRING},
    {IT_KEYHANDLER | IT_NOTHING, NULL, "Kitchen Sinks", M_HandleMonitorToggles,
     KITEM_KITCHENSINK},
...
menu_t MISC_ReplayOptionsDef = {"M_REPOPT",
                                sizeof(MISC_ReplayOptionsMenu) /
                                    sizeof(menuitem_t),
                                &OP_DataOptionsDef,
...
menu_t MISC_ReplayStartDef = {NULL,
...
menu_t PlaybackMenuDef = {NULL, sizeof(PlaybackMenu) / sizeof(menuitem_t), NULL,
                          PlaybackMenu, M_DrawPlaybackMenu,
                          // BASEVIDWIDTH/2 - 94, 2,
                          BASEVIDWIDTH / 2 - 88, 2, 0, NULL};
...
#ifdef HAVE_DISCORDRPC
menu_t MISC_DiscordRequestsDef = {NULL,
                                  sizeof(MISC_DiscordRequestsMenu) /
                                      sizeof(menuitem_t),
                                  &MPauseDef,
...
// Misc Main Menu
menu_t MISC_ScrambleTeamDef =
    DEFAULTMENUSTYLE(NULL, MISC_ScrambleTeamMenu, &MPauseDef, 27, 40);
menu_t MISC_ChangeTeamDef =
    DEFAULTMENUSTYLE(NULL, MISC_ChangeTeamMenu, &MPauseDef, 27, 40);
menu_t MISC_ChangeSpectateDef =
    DEFAULTMENUSTYLE(NULL, MISC_ChangeSpectateMenu, &MPauseDef, 27, 40);
menu_t MISC_ChangeLevelDef =
    MAPICONMENUSTYLE(NULL, MISC_ChangeLevelMenu, &MPauseDef);
...
INT32
HU_GetHighlightColor(void) {
  M_GetGametypeColor(); // update flag colour reguardless of the menu being
                        // opened or not.
  return highlightflags;
}

// Sky Room
menu_t SR_PandoraDef = {"M_PANDRA",
...
// menu_t SR_LevelSelectDef = MAPICONMENUSTYLE(NULL, SR_LevelSelectMenu,
// &SR_MainDef);

menu_t SR_UnlockChecklistDef = {
    NULL, 1, &SR_MainDef, SR_UnlockChecklistMenu, M_DrawChecklist, 280,
    185,  0, NULL};
menu_t SR_EmblemHintDef = {NULL,
...
menu_t SP_LevelSelectDef = MAPICONMENUSTYLE(NULL, SP_LevelSelectMenu,
&SP_LoadDef);*/

menu_t SP_LevelStatsDef = {
    "M_STATS", 1, &SR_MainDef, SP_LevelStatsMenu, M_DrawLevelStats, 280,
    185,       0, NULL};

static menu_t SP_TimeAttackDef = {"M_ATTACK",
                                  sizeof(SP_TimeAttackMenu) /
                                      sizeof(menuitem_t),
...
static menu_t SP_ReplayDef = {"M_ATTACK",
                              ...
                              0,
                              NULL};
static menu_t SP_GuestReplayDef = {"M_ATTACK",
                                   sizeof(SP_GuestReplayMenu) /
                                       sizeof(menuitem_t),
                                   &SP_TimeAttackDef,
                                   SP_GuestReplayMenu,
                                   M_DrawTimeAttackMenu,
                                   ...
                                   0,
                                   NULL};
static menu_t SP_GhostDef = {"M_ATTACK",
...
menu_t MP_OfflineServerDef =
    MAPICONMENUSTYLE("M_MULTI", MP_OfflineServerMenu, &MP_MainDef);

#ifndef NONET
menu_t MP_ServerDef = MAPICONMENUSTYLE("M_MULTI", MP_ServerMenu, &MP_MainDef);

menu_t MP_ConnectDef = {"M_MULTI",
                        ...
                        M_CancelConnect};
#endif
menu_t MP_PlayerSetupDef = {NULL, //"M_SPLAYR"
...
menu_t OP_ControlsDef =
    DEFAULTMENUSTYLE("M_CONTRO", OP_ControlsMenu, &OP_MainDef, 60, 30);
menu_t OP_AllControlsDef =
    CONTROLMENUSTYLE(OP_AllControlsMenu, &OP_ControlsDef);
menu_t OP_Joystick1Def =
    DEFAULTMENUSTYLE("M_CONTRO", OP_Joystick1Menu, &OP_AllControlsDef, 60, 30);
menu_t OP_Joystick2Def =
    DEFAULTMENUSTYLE("M_CONTRO", OP_Joystick2Menu, &OP_AllControlsDef, 60, 30);
menu_t OP_Joystick3Def =
    DEFAULTMENUSTYLE("M_CONTRO", OP_Joystick3Menu, &OP_AllControlsDef, 60, 30);
menu_t OP_Joystick4Def =
    DEFAULTMENUSTYLE("M_CONTRO", OP_Joystick4Menu, &OP_AllControlsDef, 60, 30);
menu_t OP_JoystickSetDef = {"M_CONTRO",
...
menu_t OP_VideoOptionsDef = {"M_VIDEO",
...
menu_t OP_VideoModeDef = {"M_VIDEO",
                          1,
                          &OP_VideoOptionsDef,
                          OP_VideoModeMenu,
                          M_DrawVideoMode,
...
menu_t OP_SoundOptionsDef = {"M_SOUND",
...
menu_t OP_ChatOptionsDef =
    DEFAULTMENUSTYLE("M_HUD", OP_ChatOptionsMenu, &OP_HUDOptionsDef, 30, 30);

menu_t OP_GameOptionsDef =
    DEFAULTMENUSTYLE("M_GAME", OP_GameOptionsMenu, &OP_MainDef, 30, 30);
menu_t OP_ServerOptionsDef =
    DEFAULTMENUSTYLE("M_SERVER", OP_ServerOptionsMenu, &OP_MainDef, 24, 30);
#ifndef NONET
menu_t OP_AdvServerOptionsDef = DEFAULTMENUSTYLE(
    "M_SERVER", OP_AdvServerOptionsMenu, &OP_ServerOptionsDef, 24, 30);
#endif

// menu_t OP_NetgameOptionsDef = DEFAULTMENUSTYLE("M_SERVER",
// OP_NetgameOptionsMenu, &OP_ServerOptionsDef, 30, 30); menu_t
// OP_GametypeOptionsDef = DEFAULTMENUSTYLE("M_SERVER", OP_GametypeOptionsMenu,
// &OP_ServerOptionsDef, 30, 30); menu_t OP_ChatOptionsDef =
// DEFAULTMENUSTYLE("M_GAME", OP_ChatOptionsMenu, &OP_GameOptionsDef, 30, 30);
menu_t OP_MonitorToggleDef = {"M_GAME",
...
menu_t OP_OpenGLOptionsDef = DEFAULTMENUSTYLE("M_VIDEO", OP_OpenGLOptionsMenu,
                                              &OP_VideoOptionsDef, 30, 30);
menu_t OP_OpenGLColorDef = {"M_VIDEO",
                            ...
                            0,
                            NULL};
menu_t OP_DataOptionsDef =
    DEFAULTMENUSTYLE("M_DATA", OP_DataOptionsMenu, &OP_MainDef, 60, 30);
menu_t OP_ScreenshotOptionsDef = DEFAULTMENUSTYLE(
    "M_SCSHOT", OP_ScreenshotOptionsMenu, &OP_DataOptionsDef, 30, 30);
menu_t OP_AddonsOptionsDef = DEFAULTMENUSTYLE("M_ADDONS", OP_AddonsOptionsMenu,
                                              &OP_DataOptionsDef, 30, 30);
#ifdef HAVE_DISCORDRPC
menu_t OP_DiscordOptionsDef =
    DEFAULTMENUSTYLE(NULL, OP_DiscordOptionsMenu, &OP_DataOptionsDef, 30, 30);
#endif
menu_t OP_EraseDataDef =
    DEFAULTMENUSTYLE("M_DATA", OP_EraseDataMenu, &OP_DataOptionsDef, 30, 30);
...
static void Nextmap_OnChange(void) {
  ...
  cv_nextmap.string = cv_nextmap.zstring =
      leveltitle ? leveltitle : Z_StrDup(G_BuildMapName(cv_nextmap.value));
  ...
  if (currentMenu == &SP_TimeAttackDef) {
    ...
    sprintf(gpath, "%s" PATHSEP "replay" PATHSEP "%s" PATHSEP "%s", srb2home,
            timeattackfolder, G_BuildMapName(cv_nextmap.value));
    ...
    if (FIL_FileExists(
            va("%s-%s-time-best.lmp", gpath, cv_chooseskin.string))) {
    ...
    } else if (itemOn == tareplay) // Reset lastOn so replay isn't still
                                   // selected when not available.
    {
    ...
    if (mapheaderinfo[cv_nextmap.value - 1] &&
        mapheaderinfo[cv_nextmap.value - 1]->forcecharacter[0] != '\0')
      CV_Set(&cv_chooseskin,
             mapheaderinfo[cv_nextmap.value - 1]->forcecharacter);
...
static void Dummystaff_OnChange(void) {
  ...
  if ((l = W_CheckNumForName(va("%sS01", G_BuildMapName(cv_nextmap.value)))) ==
      LUMPERROR) {
    CV_StealthSetValue(&cv_dummystaff, 0);
    return;
  } else {
    ...
    UINT8 numstaff = 1;
    while (numstaff < 99 && (l = W_CheckNumForName(
                                 va("%sS%02u", G_BuildMapName(cv_nextmap.value),
                                    numstaff + 1))) != LUMPERROR)
      numstaff++;
    ...
    if ((l = W_CheckNumForName(va("%sS%02u", G_BuildMapName(cv_nextmap.value),
                                  cv_dummystaff.value))) == LUMPERROR)
...
static void Newgametype_OnChange(void) {
  if (cv_nextmap.value && menuactive) {
    ...
    if ((cv_newgametype.value == GT_RACE &&
         !(mapheaderinfo[cv_nextmap.value - 1]->typeoflevel &
           TOL_RACE)) || // SRB2kart
                         //(cv_newgametype.value == GT_COMPETITION &&
                         //!(mapheaderinfo[cv_nextmap.value-1]->typeoflevel &
                         // TOL_COMPETITION)) || (cv_newgametype.value ==
                         // GT_RACE
                         //&& !(mapheaderinfo[cv_nextmap.value-1]->typeoflevel &
                         // TOL_RACE)) ||
        ((cv_newgametype.value == GT_MATCH ||
          cv_newgametype.value == GT_TEAMMATCH) &&
         !(mapheaderinfo[cv_nextmap.value - 1]->typeoflevel & TOL_MATCH))) // ||
    //((cv_newgametype.value == GT_TAG || cv_newgametype.value ==
    // GT_HIDEANDSEEK) && !(mapheaderinfo[cv_nextmap.value-1]->typeoflevel &
    // TOL_TAG)) || (cv_newgametype.value == GT_CTF &&
    //!(mapheaderinfo[cv_nextmap.value-1]->typeoflevel & TOL_CTF)))
    {
      INT32 value = 0;
...
void Screenshot_option_Onchange(void) {
  OP_ScreenshotOptionsMenu[op_screenshot_folder].status =
      (cv_screenshot_option.value == 3 ? IT_CVAR | IT_STRING | IT_CV_STRING
                                       : IT_DISABLED);
}
...
void Addons_option_Onchange(void) {
  OP_AddonsOptionsMenu[op_addons_folder].status =
      (cv_addons_option.value == 3 ? IT_CVAR | IT_STRING | IT_CV_STRING
                                   : IT_DISABLED);
}
...
static void M_ChangeCvar(INT32 choice) {
  ...
  if (((currentMenu->menuitems[itemOn].status & IT_CVARTYPE) == IT_CV_SLIDER) ||
      ((currentMenu->menuitems[itemOn].status & IT_CVARTYPE) ==
       IT_CV_INVISSLIDER) ||
...
static void M_NextOpt(void) {
  ...
  do {
    if (itemOn + 1 > currentMenu->numitems - 1)
      ...
      itemOn++;
  } while (oldItemOn != itemOn &&
           (currentMenu->menuitems[itemOn].status & IT_TYPE) == IT_SPACE);
}
...
boolean M_Responder(event_t *ev) {
  ...
  if (dedicated || (demo.playback && demo.title) || gamestate == GS_INTRO ||
      gamestate == GS_CUTSCENE || gamestate == GS_GAMEEND ||
  ...
  if (noFurtherInput) {
    ...
    if (ev->type == ev_joystick) {
      const INT32 jxdeadzone =
          ((JOYAXISRANGE - 1) * max(cv_xdeadzone.value, FRACUNIT / 2)) >>
          FRACBITS;
      const INT32 jydeadzone =
          ((JOYAXISRANGE - 1) * max(cv_ydeadzone.value, FRACUNIT / 2)) >>
          FRACBITS;
        ...
        if (ev->data3 != INT32_MAX) {
          if (Joystick.bGamepadStyle || abs(ev->data3) > jydeadzone) {
            if (joywaity < thistime &&
                (pjoyy == 0 ||
                 (ev->data3 < 0) !=
                     (pjoyy < 0))) // no previous direction OR change direction
            {
        ...
        if (ev->data2 != INT32_MAX && joywaitx < thistime) {
          if (Joystick.bGamepadStyle || abs(ev->data2) > jxdeadzone) {
            if (joywaitx < thistime &&
                (pjoyx == 0 ||
                 (ev->data2 < 0) !=
                     (pjoyx < 0))) // no previous direction OR change direction
            {
          ...
          if (retaxis != INT32_MAX) {
            ...
            if (Joystick.bGamepadStyle || retaxis > jacceldeadzone) {
              if (joywaitaccel < thistime &&
                  retaxis > pjoyaccel) // only on upwards event
              {
                ch = KEY_ENTER;
  ...
  if (ch == -1)
    ...
    ch = KEY_ESCAPE;
  else if ((ch == gamecontrol[gc_accelerate][0] ||
            ch == gamecontrol[gc_accelerate][1]) &&
           ch >= KEY_MOUSE1)
    ch = KEY_ENTER;
  ...
  if ((ch == gamecontrol[gc_brake][0] || ch == gamecontrol[gc_brake][1]) &&
      ch >= KEY_MOUSE1) // do this here, otherwise brake opens the menu mid-game
    ch = KEY_ESCAPE;
  ...
  if (currentMenu->menuitems[itemOn].status == IT_MSGHANDLER) {
    if (currentMenu->menuitems[itemOn].alphaKey != MM_EVENTHANDLER) {
      ...
      // dirty hack: for customising controls, I want only buttons/keys, not
      // moves
      if (ev->type == ev_mouse || ev->type == ev_mouse2 ||
          ev->type == ev_joystick || ev->type == ev_joystick2 ||
          ev->type == ev_joystick3 || ev->type == ev_joystick4)
        return true;
      if (routine) {
        void (*otherroutine)(event_t * sev) =
            currentMenu->menuitems[itemOn].itemaction;
  ...
  if (currentMenu == &PlaybackMenuDef && !con_destlines) {
    ...
    // Flip left/right with up/down for the playback menu, since it's a
    // horizontal icon row.
    switch (ch) {
    case KEY_LEFTARROW:
      ch = KEY_UPARROW;
  ...
  case KEY_ENTER:
    ...
    if (routine) {
      if (((currentMenu->menuitems[itemOn].status & IT_TYPE) == IT_CALL ||
        ...
        if (((currentMenu->menuitems[itemOn].status & IT_CALLTYPE) &
             IT_CALL_NOTMODIFIED) &&
            majormods) {
          S_StartSound(NULL, sfx_menu1);
          M_StartMessage(
              M_GetText("This cannot be done with complex addons\nor in a "
                        "cheated game.\n\n(Press a key)\n"),
              NULL, MM_NOTHING);
          return true;
        }
  ...
  case KEY_ESCAPE:
    ...
    if (currentMenu->prevMenu) {
      ...
      if (currentMenu ==
          &SP_TimeAttackDef) //|| currentMenu == &SP_NightsAttackDef
      {
        // D_StartTitle does its own wipe, since GS_TIMEATTACK is now a
        // complete gamestate.
        menuactive = false;
        D_StartTitle();
      } else
  ...
  case KEY_BACKSPACE:
    if ((currentMenu->menuitems[itemOn].status) == IT_CONTROL) {
      ...
      G_ClearControlKeys(setupcontrols,
    ...
    if (routine &&
      ...
      if (cv == &cv_chooseskin || cv == &cv_dummystaff || cv == &cv_nextmap ||
          cv == &cv_newgametype)
        return true;
...
boolean M_DemoResponder(event_t *ev) {
  ...
  if (noFurtherInput) {
    ...
    return false;
             ...
             !con_destlines) // not while the console is on please
  {
    ch = ev->data1;
...
void M_Drawer(void) {
  ...
  if (menuactive) {
    ...
    if (!WipeInAction &&
        currentMenu !=
            &PlaybackMenuDef) // Replay playback has its own background
    ...
    if (currentMenu == &MainDef) {
      if (customversionstring[0] != '\0') {
        V_DrawThinString(vid.dupx, vid.height - 20 * vid.dupy,
                         V_NOSCALESTART | V_TRANSLUCENT, "Mod version:");
        V_DrawThinString(vid.dupx, vid.height - 10 * vid.dupy,
                         V_NOSCALESTART | V_TRANSLUCENT | V_ALLOWLOWERCASE,
                         customversionstring);
      } else {
  ...
  // focus lost notification goes on top of everything, even the former
  // everything
  if (window_notinfocus && cv_showfocuslost.value) {
    M_DrawTextBox((BASEVIDWIDTH / 2) - (60), (BASEVIDHEIGHT / 2) - (16), 13, 2);
    if (gamestate == GS_LEVEL && (P_AutoPause() || paused))
      V_DrawCenteredString(BASEVIDWIDTH / 2, (BASEVIDHEIGHT / 2) - (4),
                           highlightflags, "Game Paused");
    else
      V_DrawCenteredString(BASEVIDWIDTH / 2, (BASEVIDHEIGHT / 2) - (4),
                           highlightflags, "Focus Lost");
  }
...
void M_StartControlPanel(void) {
  ...
  if (demo.playback) {
    ...
    // Secret menu!
    // MainMenu[secrets].status = (M_AnySecretUnlocked()) ? (IT_STRING |
    // IT_CALL) : (IT_DISABLED);
  ...
  {
    if (gamestate !=
        GS_LEVEL /*|| ultimatemode*/) // intermission, so gray out stuff.
    {
      SPauseMenu[spause_pandora].status =
          (M_SecretUnlocked(SECRET_PANDORA)) ? (IT_GRAYEDOUT) : (IT_DISABLED);
      SPauseMenu[spause_retry].status = IT_GRAYEDOUT;
    } else {
      // INT32 numlives = 2;

      SPauseMenu[spause_pandora].status = (M_SecretUnlocked(SECRET_PANDORA))
                                              ? (IT_STRING | IT_CALL)
                                              : (IT_DISABLED);
      ...
      // The list of things that can disable retrying is (was?) a little too
      complex
    ...
    // SPauseMenu[spause_levelselect].status = (gamecomplete) ? (IT_STRING |
    // IT_CALL) : (IT_DISABLED);

    // And emblem hints.
    SPauseMenu[spause_hints].status = (M_SecretUnlocked(SECRET_EMBLEMHINTS))
                                          ? (IT_STRING | IT_CALL)
                                          : (IT_DISABLED);
  ...
  } else // multiplayer
  {
    ...
    if (splitscreen) {
      MPauseMenu[mpause_psetupsplit].status =
          MPauseMenu[mpause_psetupsplit2].status = IT_STRING | IT_CALL;
      MISC_ChangeTeamMenu[0].status = MISC_ChangeSpectateMenu[0].status =
          IT_STRING | IT_CVAR;
      ...
      } else // in this odd case, we still want something to be on the menu even
             // if it's useless
...
void M_EndModeAttackRun(void) { M_ModeAttackEndGame(0); }
...
void M_ClearMenus(boolean callexitmenufunc) {
  ...
  if (currentMenu->quitroutine && callexitmenufunc &&
      !currentMenu->quitroutine())
    return; // we can't quit this menu (also used to set parameter from the
            // menu)
...
void M_SetupNextMenu(menu_t *menudef) {
  ...
  if (currentMenu->quitroutine) {
    // If you're going from a menu to itself, why are you running the
    // quitroutine? You're not quitting it! -SH
...
void M_Init(void) {
  ...
  quitmsg[QUITMSG] =
      M_GetText("Eggman's tied explosives\nto your girlfriend, and\nwill "
                "activate them if\nyou press the 'Y' key!\nPress 'N' to save "
                "her!\n\n(Press 'Y' to quit)");
  ...
  quitmsg[QUITMSG3] =
      M_GetText("Forget your studies!\nPlay some more!\n\n(Press 'Y' to quit)");
  quitmsg[QUITMSG4] =
      M_GetText("You're trying to say you\nlike Sonic R better than\nthis, "
                "aren't you?\n\n(Press 'Y' to quit)");
  quitmsg[QUITMSG5] = M_GetText("Don't leave yet -- there's a\nsuper emerald "
                                "around that corner!\n\n(Press 'Y' to quit)");
  quitmsg[QUITMSG6] =
      M_GetText("You'd rather work than play?\n\n(Press 'Y' to quit)");
  quitmsg[QUITMSG7] = M_GetText(
      "Go ahead and leave. See if I care...\n*sniffle*\n\n(Press 'Y' to quit)");

  quitmsg[QUIT2MSG] = M_GetText("If you leave now,\nEggman will take over the "
                                "world!\n\n(Press 'Y' to quit)");
  quitmsg[QUIT2MSG1] = M_GetText(
      "On your mark,\nget set,\nhit the 'N' key!\n\n(Press 'Y' to quit)");
  quitmsg[QUIT2MSG2] =
      M_GetText("Aw c'mon, just\na few more laps!\n\n(Press 'Y' to quit)");
  quitmsg[QUIT2MSG3] =
      M_GetText("Did you get all those Chaos Emeralds?\n\n(Press 'Y' to quit)");
  quitmsg[QUIT2MSG4] = M_GetText(
      "If you leave, I'll use\nmy Jawz on you!\n\n(Press 'Y' to quit)");
  quitmsg[QUIT2MSG5] = M_GetText(
      "Don't go!\nYou might find the hidden\nlevels!\n\n(Press 'Y' to quit)");
  quitmsg[QUIT2MSG6] =
      M_GetText("Hit the 'N' key, Sonic!\nThe 'N' key!\n\n(Press 'Y' to quit)");

  quitmsg[QUIT3MSG] = M_GetText(
      "Are you really going to give up?\nWe certainly would never give "
      "you up.\n\n(Press 'Y' to quit)");
  quitmsg[QUIT3MSG1] =
      M_GetText("Come on, just ONE more netgame!\n\n(Press 'Y' to quit)");
  quitmsg[QUIT3MSG2] =
      M_GetText("Press 'N' to unlock\nthe Golden Kart!\n\n(Press 'Y' to quit)");
  quitmsg[QUIT3MSG3] =
      M_GetText("Couldn't handle\nthe banana meta?\n\n(Press 'Y' to quit)");
  quitmsg[QUIT3MSG4] = M_GetText("Every time you press 'Y', an\nSRB2Kart "
                                 "Developer cries...\n\n(Press 'Y' to quit)");
  quitmsg[QUIT3MSG5] = M_GetText("You'll be back to play soon, "
                                 "though...\n...right?\n\n(Press 'Y' to quit)");
...
void M_InitCharacterTables(void) {
  ...
  for (i = 0; i < MAXSKINS; i++) {
    if (i == 0) {
      strcpy(
          description[i].notes,
          "\x82Sonic\x80 is the fastest of the three, but also the hardest to "
          "control. Beginners beware, but experts will find Sonic very "
          "powerful.\n\n\x82"
          "Ability:\x80 Speed Thok\nDouble jump to zoom forward with a huge "
          "burst of speed.\n\n\x82Tip:\x80 Simply letting go of forward does "
          "not "
          "slow down in SRB2. To slow down, hold the opposite direction.");
      strcpy(description[i].picname, "");
      strcpy(description[i].skinname, "sonic");
    } else if (i == 1) {
      strcpy(
          description[i].notes,
          "\x82Tails\x80 is the most mobile of the three, but has the slowest "
          "speed. Because of his mobility, he's well-\nsuited to "
          "beginners.\n\n\x82"
          "Ability:\x80 Fly\nDouble jump to start flying for a limited time. "
          "Repetitively hit the jump button to ascend.\n\n\x82Tip:\x80 To "
          "quickly descend while flying, hit the spin button.");
      strcpy(description[i].picname, "");
      strcpy(description[i].skinname, "tails");
    } else if (i == 2) {
      strcpy(
          description[i].notes,
          "\x82Knuckles\x80 is well-\nrounded and can destroy breakable walls "
          "simply by touching them, but he can't jump as high as the other "
          "two.\n\n\x82"
          "Ability:\x80 Glide & Climb\nDouble jump to glide in the air as long "
          "as jump is held. Glide into a wall to climb it.\n\n\x82Tip:\x80 "
          "Press "
          "spin while climbing to jump off the wall; press jump instead to "
          "jump "
          "off\nand face away from\nthe wall.");
      strcpy(description[i].picname, "");
      ...
      strcpy(
          ...
          "while Tails desperately struggles to keep up.\n\nPlayer 2 can "
          "control "
          "Tails directly by setting the controls in the options "
          "menu.\nTails's "
          "directional controls are relative to Player 1's camera.\n\nTails "
          "can "
          "pick up Sonic while flying and carry him around.");
...
static void M_DrawThermo(INT32 x, INT32 y, consvar_t *cv) {
  ...
  for (i = 0; i < 16; i++) {
    V_DrawScaledPatch(xx, y, V_WRAPX,
                      W_CachePatchNum(centerlump[i & 1], PU_CACHE));
    xx += 8;
  }
...
static void M_DrawSlider(INT32 x, INT32 y, const consvar_t *cv, boolean ontop) {
  ...
  if (ontop) {
    V_DrawCharacter(x - 16 - (skullAnimCounter / 5), y, '\x1C' | highlightflags,
                    false); // left arrow
...
void M_DrawTextBox(INT32 x, INT32 y, INT32 width, INT32 boxlines) {
  ...
  /*
          ...
          cx = x;
          cy = y;
          V_DrawScaledPatch(cx, cy, 0, W_CachePatchNum(viewborderlump[BRDR_TL],
     PU_CACHE)); cy += boff; p = W_CachePatchNum(viewborderlump[BRDR_L],
     PU_CACHE); for (n = 0; n < boxlines; n++)
          {
                  V_DrawScaledPatch(cx, cy, V_WRAPY, p);
                  cy += step;
          }
          V_DrawScaledPatch(cx, cy, 0, W_CachePatchNum(viewborderlump[BRDR_BL],
     PU_CACHE));

          // draw middle
          V_DrawFlatFill(x + boff, y + boff, width*step, boxlines*step,
     st_borderpatchnum);
          ...
          while (width > 0)
          {
                  V_DrawScaledPatch(cx, cy, V_WRAPX,
     W_CachePatchNum(viewborderlump[BRDR_T], PU_CACHE)); V_DrawScaledPatch(cx, y
     + boff + boxlines*step, V_WRAPX, W_CachePatchNum(viewborderlump[BRDR_B],
     PU_CACHE)); width--; cx += step;
          }

          // draw right side
          cy = y;
          V_DrawScaledPatch(cx, cy, 0, W_CachePatchNum(viewborderlump[BRDR_TR],
     PU_CACHE)); cy += boff; p = W_CachePatchNum(viewborderlump[BRDR_R],
     PU_CACHE); for (n = 0; n < boxlines; n++)
          {
                  V_DrawScaledPatch(cx, cy, V_WRAPY, p);
                  cy += step;
          }
          V_DrawScaledPatch(cx, cy, 0, W_CachePatchNum(viewborderlump[BRDR_BR],
     PU_CACHE));
  */
}
...
/*static void M_DrawSaveLoadBorder(INT32 x,INT32 y)
{
        ...
        {
                V_DrawScaledPatch
(x,y+7,0,W_CachePatchName("M_LSCNTR",PU_CACHE)); x += 8;
        }
...
static void M_CentreText(INT32 y, const char *string) {
  INT32 x;
  // added : 02-02-98 : centre on 320, because V_DrawString centers on
  // vid.width...
  ...
  while (emblem) {
    ...
    if (emblem->collected)
      V_DrawSmallMappedPatch(
          x, y, 0, W_CachePatchName(M_GetEmblemPatch(emblem), PU_CACHE),
          R_GetTranslationColormap(TC_DEFAULT, M_GetEmblemColor(emblem),
                                   GTC_MENUCACHE));
    else
...
static void M_DrawGenericMenu(void) {
  ...
  for (i = 0; i < currentMenu->numitems; i++) {
      ...
      case IT_CVAR: {
        ...
        default:
          ...
          V_DrawString(BASEVIDWIDTH - x - w, y,
                       ((cv->flags & CV_CHEAT) && !CV_IsSetToDefault(cv)
                            ? warningflags
                            : highlightflags),
                       cv->string);
          if (i == itemOn) {
            V_DrawCharacter(BASEVIDWIDTH - x - 10 - w - (skullAnimCounter / 5),
                            y, '\x1C' | highlightflags,
                            false); // left arrow
    ...
    case IT_QUESTIONMARKS:
      ...
      V_DrawString(x, y, V_TRANSLUCENT | V_OLDSPACING,
                   M_CreateSecretMenuOption(currentMenu->menuitems[i].text));
      y += SMALLLINEHEIGHT;
      break;
  ...
  if (((currentMenu->menuitems[itemOn].status & IT_DISPLAY) == IT_PATCH) ||
    ...
    V_DrawScaledPatch(currentMenu->x - 24, cursory, 0,
                      W_CachePatchName("M_CURSOR", PU_CACHE));
    V_DrawString(currentMenu->x, cursory, highlightflags,
...
static void M_DrawPauseMenu(void) {
  ...
  if (currentMenu == &MPauseDef && discordRequestList != NULL) {
    ...
    if ((leveltime % freq) >= freq / 2) {
      V_DrawFixedPatch(
          204 * FRACUNIT,
          (currentMenu->y + MPauseMenu[mpause_discordrequests].alphaKey - 1) *
              FRACUNIT,
          FRACUNIT, 0, W_CachePatchName("K_REQUE2", PU_CACHE), NULL);
    }
  }
#endif
...
static void M_DrawCenteredMenu(void) {
  ...
  for (i = 0; i < currentMenu->numitems; i++) {
    ...
    case IT_WHITESTRING:
      ...
      if ((currentMenu->menuitems[i].status & IT_DISPLAY) == IT_STRING)
        ...
        V_DrawCenteredString(x, y, highlightflags,
  ...
  if (((currentMenu->menuitems[itemOn].status & IT_DISPLAY) == IT_PATCH) ||
    ...
    V_DrawScaledPatch(
        x - V_StringWidth(currentMenu->menuitems[itemOn].text, 0) / 2 - 24,
        cursory, 0, W_CachePatchName("M_CURSOR", PU_CACHE));
    V_DrawCenteredString(x, cursory, highlightflags,
                         currentMenu->menuitems[itemOn].text);
  }
}
...
static void M_PrepareLevelSelect(void) {
  if (levellistmode != LLM_CREATESERVER)
    ...
    Newgametype_OnChange(); // Make sure to start on an appropriate map if wads
                            // have been added
}
...
boolean M_CanShowLevelInList(INT32 mapnum, INT32 gt) {
  ...
  case LLM_CREATESERVER:
    ...
    if (gt == GT_COMPETITION && (mapheaderinfo[mapnum]->typeoflevel &
    TOL_COMPETITION)) return true;

    if (gt == GT_CTF && (mapheaderinfo[mapnum]->typeoflevel & TOL_CTF))
            return true;

    if ((gt == GT_TAG || gt == GT_HIDEANDSEEK) &&
    (mapheaderinfo[mapnum]->typeoflevel & TOL_TAG)) return true;*/

    if ((gt == GT_MATCH || gt == GT_TEAMMATCH) &&
        (mapheaderinfo[mapnum]->typeoflevel & TOL_MATCH))
      return true;
...
void M_StartMessage(const char *string, void *routine,
  ...
  // Simple and effective. Does not handle nonuniform letter sizes, colors, etc.
  // but who cares.
  strlines = 0;
  for (i = 0; message[i]; i++) {
    if (message[i] == ' ') {
  ...
  if (!routine && itemtype != MM_NOTHING)
    itemtype = MM_NOTHING;
  switch (itemtype) {
  case MM_NOTHING:
...
static void M_DrawMessageMenu(void) {
  ...
  while (*(msg + start)) {
    ...
    V_DrawString((BASEVIDWIDTH - V_StringWidth(string, 0)) / 2, y,
                 V_ALLOWLOWERCASE, string);
...
static void M_DrawImageDef(void) {
  patch_t *patch =
      W_CachePatchName(currentMenu->menuitems[itemOn].text, PU_CACHE);
  ...
  if (currentMenu->menuitems[itemOn].alphaKey) {
    V_DrawString(2, BASEVIDHEIGHT - 10, V_YELLOWMAP,
                 va("%d",
                    (itemOn << 1) -
                        1)); // intentionally not highlightflags, unlike below
    V_DrawRightAlignedString(BASEVIDWIDTH - 2, BASEVIDHEIGHT - 10, V_YELLOWMAP,
                             va("%d", itemOn << 1)); // ditto
  } else {
    ...
    V_DrawCharacter(x - 10 - (skullAnimCounter / 5), y, '\x1C' | highlightflags,
                    false); // left arrow
    V_DrawCharacter(x + 2 + (skullAnimCounter / 5), y, '\x1D' | highlightflags,
                    false); // right arrow
...
static void M_Addons(INT32 choice) {
  ...
  if (addonsp[0]) // never going to have some provided but not all, saves
...
static char *M_AddonsHeaderPath(void) {
  ...
  strlcpy(header,
          va("%s folder%s", cv_addons_option.string,
             menupath + menupathindex[menudepth - 1] - 1),
          1024);
  len = strlen(header);
  if (len > 34) {
    len = len - 34;
    ...
    if (refreshdirmenu & REFRESHDIR_NOTLOADED) {
      ...
      if (refreshdirmenu & REFRESHDIR_MAX)
        message = va(
            ...
            "loaded.\nIf you wish to play with this addon, restart the game "
      ...
      message =
          va("%c%s\x80\nA file was loaded with %s.\nCheck the console log for "
             "more information.\n\n(Press a key)\n",
             ('\x80' + (highlightflags >> V_CHARCOLORSHIFT)), refreshdirname,
             ((refreshdirmenu & REFRESHDIR_ERROR) ? "errors" : "warnings"));
    } else if (majormods && !prevmajormods) {
      S_StartSound(NULL, sfx_s221);
      message =
          va("%c%s\x80\nYou've loaded a gameplay-modifying addon.\n\nRecord "
             "Attack has been disabled, but you\ncan still play alone in local "
             "Multiplayer.\n\nIf you wish to play Record Attack mode, restart "
             "the game to disable loaded addons.\n\n(Press a key)\n",
             ('\x80' + (highlightflags >> V_CHARCOLORSHIFT)), refreshdirname);
...
static void M_DrawAddons(void) {
  ...
  if (Playing())
    V_DrawCenteredString(BASEVIDWIDTH / 2, 5, warningflags,
                         "Adding files mid-game may cause problems.");
  else
    V_DrawCenteredString(
        BASEVIDWIDTH / 2, 5, 0,
        (recommendedflags == V_SKYMAP ? LOCATIONSTRING2 : LOCATIONSTRING1));
  ...
  if (numwadfiles <= mainwads + 1)
    ...
    y = FixedDiv(((ssize_t)(numwadfiles) - (ssize_t)(mainwads + 1)) << FRACBITS,
                 ((ssize_t)MAX_WADFILES - (ssize_t)(mainwads + 1)) << FRACBITS);
  ...
  V_DrawString(x - 21, (y - 16) + (lsheadingheight - 12),
               highlightflags | V_ALLOWLOWERCASE, M_AddonsHeaderPath());
  V_DrawFill(x - 21, (y - 16) + (lsheadingheight - 3), MAXSTRINGLENGTH * 8 + 6,
             1, hilicol);
  V_DrawFill(x - 21, (y - 16) + (lsheadingheight - 2), MAXSTRINGLENGTH * 8 + 6,
             1, 30);
  ...
  if (sizedirmenu <= (2 * numaddonsshown + 1))
    ...
    if (dir_on[menudepthleft] <= numaddonsshown) // all the way up
      i = 0;
             ...
             (dir_on[menudepthleft] + numaddonsshown + 1)) // all the way down
      i = q - m;
    else
      i = ((dir_on[menudepthleft] - numaddonsshown) * (q - m)) /
          (sizedirmenu - (2 * numaddonsshown + 1));
  }
...
#define type (UINT8)(dirmenu[i][DIR_TYPE])
    {
      if (type & EXT_LOADED) {
        flags |= V_TRANSLUCENT;
        V_DrawSmallScaledPatch(x - (16 + 4), y, V_TRANSLUCENT,
                               addonsp[(type & ~EXT_LOADED)]);
        V_DrawSmallScaledPatch(x - (16 + 4), y, 0, addonsp[NUM_EXT + 2]);
      } else
        V_DrawSmallScaledPatch(x - (16 + 4), y, 0,
                               addonsp[(type & ~EXT_LOADED)]);

      if ((size_t)i == dir_on[menudepthleft]) {
        V_DrawFixedPatch((x - (16 + 4)) << FRACBITS, (y) << FRACBITS,
                         FRACUNIT / 2, 0, addonsp[NUM_EXT + 1], flashcol);
        flags = V_ALLOWLOWERCASE | highlightflags;
      }

#define charsonside 14
      if (dirmenu[i][DIR_LEN] > (charsonside * 2 + 3))
        V_DrawString(x, y + 4, flags,
                     va("%.*s...%s", charsonside, dirmenu[i] + DIR_STRING,
                        dirmenu[i] + DIR_STRING + dirmenu[i][DIR_LEN] -
                            (charsonside + 1)));
#undef charsonside
      else
...
#undef type
  ...
  if (menusearch[0])
    ...
    V_DrawString(x - 18, y + 8, V_ALLOWLOWERCASE | V_TRANSLUCENT,
                 "Type to search...");
  if (skullAnimCounter < 4)
  ...
  x -= (21 + 5 + 16);
  V_DrawSmallScaledPatch(x, y + 4, (menusearch[0] ? 0 : V_TRANSLUCENT),
                         addonsp[NUM_EXT + 3]);

  x = BASEVIDWIDTH - x - 16;
  V_DrawSmallScaledPatch(x, y + 4, ((!majormods) ? 0 : V_TRANSLUCENT),
                         addonsp[NUM_EXT + 4]);
...
static void M_AddonExec(INT32 ch) {
  ...
  COM_BufAddText(va("exec \"%s%s\"", menupath,
...
static void M_HandleAddons(INT32 choice) {
  ...
  case KEY_PGDN: {
    UINT8 i;
    for (i = numaddonsshown; i && (dir_on[menudepthleft] < sizedirmenu - 1);
         i--)
      dir_on[menudepthleft]++;
  }
    S_StartSound(NULL, sfx_menu1);
  ...
  case KEY_ENTER: {
    ...
    if (!dirmenu[dir_on[menudepthleft]])
      ...
      case EXT_FOLDER:
        strcpy(&menupath[menupathindex[menudepthleft]],
               dirmenu[dir_on[menudepthleft]] + DIR_STRING);
        if (menudepthleft) {
          ...
          S_StartSound(NULL, sfx_s26d);
          M_StartMessage(va("%c%s\x80\nThis folder is too deep to navigate "
                            "to!\n\n(Press a key)\n",
                            ('\x80' + (highlightflags >> V_CHARCOLORSHIFT)),
                            M_AddonsHeaderPath()),
                         NULL, MM_NOTHING);
...
#endif
      case EXT_PK3:
        COM_BufAddText(va("addfile \"%s%s\"", menupath,
                          dirmenu[dir_on[menudepthleft]] + DIR_STRING));
        break;
      default:
        S_StartSound(NULL, sfx_s26d);
...
static void PrepReplayList(void) {
  ...
  for (i = 0; i < sizedirmenu; i++) {
    if (dirmenu[i][DIR_TYPE] == EXT_UP) {
      ...
      snprintf(demolist[i].filepath, 255, "%s%s", menupath,
               dirmenu[i] + DIR_STRING);
...
void M_ReplayHut(INT32 choice) {
  ...
  if (!demo.inreplayhut) {
    snprintf(menupath, 1024, "%s" PATHSEP "replay" PATHSEP "online" PATHSEP,
             srb2home);
...
static void M_HandleReplayHutList(INT32 choice) {
  ...
  case KEY_DOWNARROW:
    if (dir_on[menudepthleft] < sizedirmenu - 1)
      ...
      return;
    // itemOn = 0; // Not M_NextOpt because that would take us to the extra
    // dummy item
  ...
  case KEY_ENTER:
    ...
    case EXT_UP:
      ...
      break;
    default:
      // We can't just use M_SetupNextMenu because that'll run ReplayDef's
      // quitroutine and boot us back to the title screen!
      currentMenu->lastOn = itemOn;
      ...
      case DFILE_ERROR_INCOMPLETEOUTOFORDER:
        // Show "Load Addons and Watch Replay" and "Watch Replay Without
        // Addons"
...
static void DrawReplayHutReplayInfo(void) {
  ...
  case MD_INVALID:
    V_DrawCenteredString(160, 40, V_SNAPTOTOP | warningflags,
  ...
  case MD_OUTDATED:
    V_DrawThinString(
        17, 64, V_SNAPTOTOP | V_ALLOWLOWERCASE | V_TRANSLUCENT | highlightflags,
        "Recorded on an outdated version.");
    /*fallthru*/
  default:
    // Draw level stuff
    x = 15;
    ...
    // CONS_Printf("%d %s\n", demolist[dir_on[menudepthleft]].map,
    // G_BuildMapName(demolist[dir_on[menudepthleft]].map));
    lumpnum = W_CheckNumForName(
        va("%sP", G_BuildMapName(demolist[dir_on[menudepthleft]].map)));
    ...
    if (!(demolist[dir_on[menudepthleft]].kartspeed & DF_ENCORE))
...

      {
        ...
        V_DrawFixedPatch((x + (w >> 2)) << FRACBITS,
                         ((y + (h >> 2)) << FRACBITS) - (rubyheight << 1),
                         FRACUNIT, V_SNAPTOTOP,
                         W_CachePatchName("RUBYICON", PU_CACHE), NULL);
    ...
    if (mapheaderinfo[demolist[dir_on[menudepthleft]].map - 1]) {
      ...
      V_DrawString(x, y, V_SNAPTOTOP | V_ALLOWLOWERCASE | V_TRANSLUCENT,
                   "Level is not loaded.");

    if (demolist[dir_on[menudepthleft]].numlaps)
      V_DrawThinString(
          x, y + 9, V_SNAPTOTOP | V_ALLOWLOWERCASE,
          va("(%d laps)", demolist[dir_on[menudepthleft]].numlaps));

    V_DrawString(
        x, y + 20, V_SNAPTOTOP | V_ALLOWLOWERCASE,
        demolist[dir_on[menudepthleft]].gametype == GT_RACE
            ? va("Race (%s speed)",
                 kartspeed_cons_t[demolist[dir_on[menudepthleft]].kartspeed &
                                  ~DF_ENCORE]
                     .strvalue)
            : "Battle Mode");
    ...
    if (!demolist[dir_on[menudepthleft]].standings[0].ranking) {
      ...
      V_DrawString(x, y + 39, V_SNAPTOTOP | V_ALLOWLOWERCASE | V_TRANSLUCENT,
    ...
    V_DrawString(x + 38, y + 30, V_SNAPTOTOP | V_ALLOWLOWERCASE,
                 demolist[dir_on[menudepthleft]].standings[0].name);
    ...
    if (demolist[dir_on[menudepthleft]].standings[0].timeorscore ==
        (UINT32_MAX - 1)) {
      ...
      V_DrawRightAlignedString(
          x + 84, y + 40, V_SNAPTOTOP,
          va("%d'%02d\"%02d",
             G_TicsToMinutes(
                 demolist[dir_on[menudepthleft]].standings[0].timeorscore,
                 true),
             G_TicsToSeconds(
                 demolist[dir_on[menudepthleft]].standings[0].timeorscore),
      ...
      V_DrawString(
          x + 32, y + 40, V_SNAPTOTOP,
          va("%d", demolist[dir_on[menudepthleft]].standings[0].timeorscore));
    }

    // Character face!
    if (demolist[dir_on[menudepthleft]].standings[0].skin < numskins &&
        W_CheckNumForName(
            skins[demolist[dir_on[menudepthleft]].standings[0].skin]
                .facewant) != LUMPERROR) {
      patch = facewantprefix[demolist[dir_on[menudepthleft]].standings[0].skin];
      colormap = R_GetTranslationColormap(
          demolist[dir_on[menudepthleft]].standings[0].skin,
          demolist[dir_on[menudepthleft]].standings[0].color, GTC_MENUCACHE);
    } else {
      patch = W_CachePatchName("M_NOWANT", PU_CACHE);
      colormap = R_GetTranslationColormap(
          TC_RAINBOW, demolist[dir_on[menudepthleft]].standings[0].color,
          GTC_MENUCACHE);
    }

    V_DrawMappedPatch(BASEVIDWIDTH - 15 - SHORT(patch->width), y + 20,
                      V_SNAPTOTOP, patch, colormap);
...
static void M_DrawReplayHut(void) {
  ...
  if (itemOn == replaylistitem) {
    ...
    cursory = y + currentMenu->menuitems[replaylistitem].alphaKey +
              dir_on[menudepthleft] * 10;
    maxy =
        y + currentMenu->menuitems[replaylistitem].alphaKey + sizedirmenu * 10;
  ...
  for (i = 0; i < replaylistitem; i++) {
    ...
    if ((currentMenu->menuitems[i].status & IT_DISPLAY) == IT_STRING)
      V_DrawString(x, localy, V_SNAPTOTOP | V_SNAPTOLEFT,
                   currentMenu->menuitems[i].text);
    else
      V_DrawString(x, localy, V_SNAPTOTOP | V_SNAPTOLEFT | highlightflags,
                   currentMenu->menuitems[i].text);
  }
  ...
  for (i = 0; i < (INT16)sizedirmenu; i++) {
    ...
    if (demolist[i].type == MD_SUBDIR) {
      localx += 8;
      V_DrawScaledPatch(x - 4, localy, V_SNAPTOTOP | V_SNAPTOLEFT,
                        W_CachePatchName(dirmenu[i][DIR_TYPE] == EXT_UP
                                             ? "M_RBACK"
                                             : "M_RFLDR",
                                         PU_CACHE));
    }
    ...
    if (itemOn == replaylistitem && i == (INT16)dir_on[menudepthleft]) {
      ...
      if (!interpTimerHackAllow)
        ...
        if (replayScrollTitle <
            (V_StringWidth(demolist[i].title, 0) - (SCALEDVIEWWIDTH - (x << 1)))
                << 1)
          replayScrollTitle++;
        else {
          replayScrollDelay = TICRATE;
      ...
      V_DrawString(localx - (replayScrollTitle >> 1), localy,
                   V_SNAPTOTOP | V_SNAPTOLEFT | highlightflags |
                       V_ALLOWLOWERCASE,
                   demolist[i].title);
    } else
      V_DrawString(localx, localy,
                   V_SNAPTOTOP | V_SNAPTOLEFT | V_ALLOWLOWERCASE,
                   demolist[i].title);
  }
  ...
  if (y > SCALEDVIEWHEIGHT - 80) {
    V_DrawFill(BASEVIDWIDTH - 4, 75, 4, SCALEDVIEWHEIGHT - 80,
               V_SNAPTOTOP | V_SNAPTORIGHT | 239);
    V_DrawFill(
        BASEVIDWIDTH - 3, 76 + (SCALEDVIEWHEIGHT - 80) * replayhutmenuy / y, 2,
        (((SCALEDVIEWHEIGHT - 80) * (SCALEDVIEWHEIGHT - 80)) - 1) / y - 1,
        V_SNAPTOTOP | V_SNAPTORIGHT | 229);
  }

  // Draw the cursor
  V_DrawScaledPatch(currentMenu->x - 24, cursory, V_SNAPTOTOP | V_SNAPTOLEFT,
                    W_CachePatchName("M_CURSOR", PU_CACHE));
  V_DrawString(currentMenu->x, cursory,
               V_SNAPTOTOP | V_SNAPTOLEFT | highlightflags,
               currentMenu->menuitems[itemOn].text);
...
#define STARTY 62 - (replayScrollTitle >> 1)
  ...
  for (i = 1;
       i < MAXPLAYERS && demolist[dir_on[menudepthleft]].standings[i].ranking;
       i++) {
    patch_t *patch;
    UINT8 *colormap;

    V_DrawRightAlignedString(
        BASEVIDWIDTH - 100, STARTY + i * 20, V_SNAPTOTOP | highlightflags,
        va("%2d", demolist[dir_on[menudepthleft]].standings[i].ranking));
    V_DrawThinString(BASEVIDWIDTH - 96, STARTY + i * 20,
                     V_SNAPTOTOP | V_ALLOWLOWERCASE,
                     demolist[dir_on[menudepthleft]].standings[i].name);

    if (demolist[dir_on[menudepthleft]].standings[i].timeorscore ==
        UINT32_MAX - 1)
      V_DrawThinString(BASEVIDWIDTH - 92, STARTY + i * 20 + 9, V_SNAPTOTOP,
                       "NO CONTEST");
    else if (demolist[dir_on[menudepthleft]].gametype == GT_RACE)
      V_DrawRightAlignedString(
          BASEVIDWIDTH - 40, STARTY + i * 20 + 9, V_SNAPTOTOP,
          va("%d'%02d\"%02d",
             G_TicsToMinutes(
                 demolist[dir_on[menudepthleft]].standings[i].timeorscore,
                 true),
             G_TicsToSeconds(
                 demolist[dir_on[menudepthleft]].standings[i].timeorscore),
             G_TicsToCentiseconds(
      ...
      V_DrawString(
          BASEVIDWIDTH - 92, STARTY + i * 20 + 9, V_SNAPTOTOP,
          va("%d", demolist[dir_on[menudepthleft]].standings[i].timeorscore));

    // Character face!
    if (demolist[dir_on[menudepthleft]].standings[i].skin < numskins &&
        W_CheckNumForName(
            skins[demolist[dir_on[menudepthleft]].standings[i].skin]
                .facerank) != LUMPERROR) {
      patch = facerankprefix[demolist[dir_on[menudepthleft]].standings[i].skin];
      colormap = R_GetTranslationColormap(
          demolist[dir_on[menudepthleft]].standings[i].skin,
          demolist[dir_on[menudepthleft]].standings[i].color, GTC_MENUCACHE);
    } else {
      patch = W_CachePatchName("M_NORANK", PU_CACHE);
      colormap = R_GetTranslationColormap(
          TC_RAINBOW, demolist[dir_on[menudepthleft]].standings[i].color,
          GTC_MENUCACHE);
    }

    V_DrawMappedPatch(BASEVIDWIDTH - 5 - SHORT(patch->width), STARTY + i * 20,
                      V_SNAPTOTOP, patch, colormap);
  }
#undef STARTY
  ...
  V_DrawString(10, 72, V_SNAPTOTOP | highlightflags | V_ALLOWLOWERCASE,
               demolist[dir_on[menudepthleft]].title);

  // Draw a warning prompt if needed
  switch (demolist[dir_on[menudepthleft]].addonstatus) {
  case DFILE_ERROR_CANNOTLOAD:
    warning = "Some addons in this replay cannot be loaded.\nYou can watch "
              "anyway, but desyncs may occur.";
    break;

  case DFILE_ERROR_NOTLOADED:
  case DFILE_ERROR_INCOMPLETEOUTOFORDER:
    warning = "Loading addons will mark your game as modified, and Record "
              "Attack may be unavailable.\nYou can watch without loading "
              "addons, but desyncs may occur.";
    break;

  case DFILE_ERROR_EXTRAFILES:
    warning = "You have addons loaded that were not present in this "
              "replay.\nYou can watch anyway, but desyncs may occur.";
    break;

  case DFILE_ERROR_OUTOFORDER:
    warning = "You have this replay's addons loaded, but they are out of "
              "order.\nYou can watch anyway, but desyncs may occur.";
    break;
  ...
  V_DrawSmallString(4, BASEVIDHEIGHT - 14,
                    V_SNAPTOBOTTOM | V_SNAPTOLEFT | V_ALLOWLOWERCASE, warning);
}

static boolean M_QuitReplayHut(void) {
  // D_StartTitle does its own wipe, since GS_TIMEATTACK is now a complete
  // gamestate.
  menuactive = false;
  D_StartTitle();
...
void M_SetPlaybackMenuPointer(void) { itemOn = playback_pause; }

static void M_DrawPlaybackMenu(void) {
  INT16 i;
  patch_t *icon;
  UINT8 *activemap =
      R_GetTranslationColormap(TC_RAINBOW, SKINCOLOR_GOLD, GTC_MENUCACHE);
  UINT32 transmap =
      max(0, (INT32)(leveltime - playback_last_menu_interaction_leveltime -
                     4 * TICRATE)) /
      5;
  ...
  if (paused && !demo.rewinding) {
    PlaybackMenu[playback_pause].status =
        PlaybackMenu[playback_fastforward].status =
            PlaybackMenu[playback_rewind].status = IT_DISABLED;
    PlaybackMenu[playback_resume].status =
        PlaybackMenu[playback_advanceframe].status =
            PlaybackMenu[playback_backframe].status = IT_CALL | IT_STRING;
    ...
    PlaybackMenu[playback_pause].status =
        PlaybackMenu[playback_fastforward].status =
            PlaybackMenu[playback_rewind].status = IT_CALL | IT_STRING;
    PlaybackMenu[playback_resume].status =
        PlaybackMenu[playback_advanceframe].status =
            PlaybackMenu[playback_backframe].status = IT_DISABLED;
  ...
  for (i = 0; i < currentMenu->numitems; i++) {
    ...
    if (i >= playback_view1 && i <= playback_view4) {
      ...
      if (splitscreen >= i - playback_view1) {
        ...
        if (i != itemOn)
          inactivemap = R_GetTranslationColormap(
              players[ply].skin, players[ply].skincolor, GTC_MENUCACHE);
      } else if (currentMenu->menuitems[i].patch &&
                 W_CheckNumForName(currentMenu->menuitems[i].patch) !=
                     LUMPERROR)
      ...
      continue;
             ...
             W_CheckNumForName(currentMenu->menuitems[i].patch) != LUMPERROR)
      icon = W_CachePatchName(currentMenu->menuitems[i].patch, PU_CACHE);
    else
      icon = W_CachePatchName("PLAYRANK", PU_CACHE); // temp

    if ((i == playback_fastforward && cv_playbackspeed.value > 1) ||
        (i == playback_rewind && demo.rewinding))
      V_DrawMappedPatch(
          currentMenu->x + currentMenu->menuitems[i].alphaKey, currentMenu->y,
          transmap | V_SNAPTOTOP, icon,
          R_GetTranslationColormap(TC_RAINBOW, SKINCOLOR_JAWZ, GTC_MENUCACHE));
    else
      V_DrawMappedPatch(currentMenu->x + currentMenu->menuitems[i].alphaKey,
                        currentMenu->y, transmap | V_SNAPTOTOP, icon,
                        (i == itemOn) ? activemap : inactivemap);

    if (i == itemOn) {
      V_DrawCharacter(currentMenu->x + currentMenu->menuitems[i].alphaKey + 4,
                      currentMenu->y + 14,
                      '\x1A' | transmap | V_SNAPTOTOP | highlightflags, false);

      V_DrawCenteredString(BASEVIDWIDTH / 2, currentMenu->y + 18,
                           transmap | V_SNAPTOTOP | V_ALLOWLOWERCASE,
                           currentMenu->menuitems[i].text);
      ...
      if ((currentMenu->menuitems[i].status & IT_TYPE) == IT_ARROWS) {
        ...
        if (!(i == playback_viewcount && splitscreen == 3))
          V_DrawCharacter(BASEVIDWIDTH / 2 - 4,
                          currentMenu->y + 28 - (skullAnimCounter / 5),
                          '\x1A' | transmap | V_SNAPTOTOP | highlightflags,
                          false); // up arrow

        if (!(i == playback_viewcount && splitscreen == 0))
          V_DrawCharacter(BASEVIDWIDTH / 2 - 4,
                          currentMenu->y + 48 + (skullAnimCounter / 5),
                          '\x1B' | transmap | V_SNAPTOTOP | highlightflags,
                          false); // down arrow
        ...
        V_DrawCenteredString(
            BASEVIDWIDTH / 2, currentMenu->y + 38,
            transmap | V_SNAPTOTOP | V_ALLOWLOWERCASE | highlightflags, str);
      }
    }
  }
}
...
static void M_PlaybackToggleFreecam(INT32 choice) {
  ...
  } else                      // toggle off
  {
    ...
    democam.keyboardlook = false; // reset only these. localangle / aiming gets
                                  // set before the cam does anything anyway
  }
}
...
static void M_Options(INT32 choice) {
  ...
  OP_MainMenu[4].status = OP_MainMenu[5].status =
      (Playing() && !(server || IsPlayerAdmin(consoleplayer)))
          ? (IT_GRAYEDOUT)
          : (IT_STRING | IT_SUBMENU);

  OP_MainMenu[8].status =
      (Playing()) ? (IT_GRAYEDOUT) : (IT_STRING | IT_CALL); // Play credits

#ifdef HAVE_DISCORDRPC
  OP_DataOptionsMenu[4].status =
      (Playing()) ? (IT_GRAYEDOUT) : (IT_STRING | IT_SUBMENU); // Erase data
#else
  OP_DataOptionsMenu[3].status =
      (Playing()) ? (IT_GRAYEDOUT) : (IT_STRING | IT_SUBMENU); // Erase data
#endif

  OP_GameOptionsMenu[3].status = (M_SecretUnlocked(SECRET_ENCORE))
                                     ? (IT_CVAR | IT_STRING)
                                     : IT_SECRET; // cv_kartencore
...
void M_PopupMasterServerRules(void) {
  ...
  if (cv_advertise.value &&
      ((serverrunning && netgame) || currentMenu == &MP_ServerDef) &&
      firstDismissedRulesThisBoot) {
...
G_BuildMapName(cv_nextmap.value)); return;
        }
...
static char *M_GetConditionString(condition_t cond) {
  switch (cond.type) {
  case UC_PLAYTIME:
    return va("Play for %i:%02i:%02i", G_TicsToHours(cond.requirement),
...
static void M_DrawChecklist(void) {
  ...
  for (i = 0; i < MAXUNLOCKABLES; i++) {
    ...
    secret = (!M_Achieved(unlockables[i].showconditionset - 1) &&
              !unlockables[i].unlocked);

    if (unlockables[i].name[0] == 0 || unlockables[i].nochecklist ||
        !unlockables[i].conditionset ||
        unlockables[i].conditionset > MAXCONDITIONSETS ||
        (unlockables[i].type == SECRET_HELLATTACK &&
         secret)) // TODO: turn this into an unlockable setting instead of tying
                  // it to Hell Attack
      continue;
    ...
    V_DrawString(
        8, (line * 8),
        V_RETURN8 | (unlockables[i].unlocked ? recommendedflags : warningflags),
        (secret ? secretname : unlockables[i].name));
    ...
    if (conditionSets[unlockables[i].conditionset - 1].numconditions) {
      ...
      for (c = 0;
           c < conditionSets[unlockables[i].conditionset - 1].numconditions;
           c++) {
        condition_t cond =
            conditionSets[unlockables[i].conditionset - 1].condition[c];
        ...
        if (lastid == -1 || cond.id != (UINT32)lastid) {
          V_DrawString(16, (line * 8),
                       V_MONOSPACE | V_ALLOWLOWERCASE |
                           (achieved ? highlightflags : 0),
                       "*");
          V_DrawString(32, (line * 8),
                       V_MONOSPACE | V_ALLOWLOWERCASE |
                           (achieved ? highlightflags : 0),
...
static void M_EmblemHints(INT32 choice) {
  (void)choice;
  SR_EmblemHintMenu[0].status = (M_SecretUnlocked(SECRET_ITEMFINDER))
                                    ? (IT_CVAR | IT_STRING)
                                    : (IT_SECRET);
...
static void M_DrawEmblemHints(void) {
  ...
  for (i = 0; i < numemblems; i++) {
    ...
    if (emblem->collected) {
      ...
      V_DrawMappedPatch(12, 12 + (28 * j), 0,
                        W_CachePatchName(M_GetEmblemPatch(emblem), PU_CACHE),
                        R_GetTranslationColormap(TC_DEFAULT,
                                                 M_GetEmblemColor(emblem),
                                                 GTC_MENUCACHE));
    } else {
      collected = 0;
      V_DrawScaledPatch(12, 12 + (28 * j), 0,
    ...
    V_DrawString(40, 8 + (28 * j), V_RETURN8 | V_ALLOWLOWERCASE | collected,
                 hint);
  ...
  if (!j)
    V_DrawCenteredString(160, 48, highlightflags,
                         "No hidden medals on this map.");
...
static void M_DrawSkyRoom(void) {
  ...
  if (currentMenu == &OP_SoundOptionsDef) {
    V_DrawRightAlignedString(BASEVIDWIDTH - currentMenu->x,
                             currentMenu->y +
                                 currentMenu->menuitems[0].alphaKey,
                             (sound_disabled ? warningflags : highlightflags),
                             (sound_disabled ? "OFF" : "ON"));

    V_DrawRightAlignedString(BASEVIDWIDTH - currentMenu->x,
                             currentMenu->y +
                                 currentMenu->menuitems[2].alphaKey,
  ...
  if (y) {
    ...
    V_DrawRightAlignedString(BASEVIDWIDTH - currentMenu->x, y, highlightflags,
                             cv_soundtest.string);
    if (cv_soundtest.value)
      V_DrawRightAlignedString(BASEVIDWIDTH - currentMenu->x, y + 8,
                               highlightflags, S_sfx[cv_soundtest.value].name);
  ...
  if (lengthstring) {
    V_DrawCharacter(BASEVIDWIDTH - currentMenu->x - 10 - lengthstring -
                        (skullAnimCounter / 5),
                    currentMenu->y + currentMenu->menuitems[itemOn].alphaKey,
                    '\x1C' | highlightflags,
                    false); // left arrow
    V_DrawCharacter(BASEVIDWIDTH - currentMenu->x + 2 + (skullAnimCounter / 5),
                    currentMenu->y + currentMenu->menuitems[itemOn].alphaKey,
                    '\x1D' | highlightflags,
                    false); // right arrow
  }
...
/*static void M_SecretsMenu(INT32 choice)
{
        ...
        for (i = 1; i < MAXUNLOCKABLES+1; ++i)
        {
                ...
                {
                        if (!unlockables[j].height || done[j] ||
unlockables[j].type < 0) continue;
                ...
                if (unlockables[ul].unlocked)
                {
                        switch (unlockables[ul].type)
                        {
                                case SECRET_LEVELSELECT:
                                        SR_MainMenu[i].status =
IT_STRING|IT_CALL; SR_MainMenu[i].itemaction = M_CustomLevelSelect; break; case
SECRET_WARP: SR_MainMenu[i].status = IT_STRING|IT_CALL;
                                        SR_MainMenu[i].itemaction =
M_CustomWarp; break; case SECRET_CREDITS: SR_MainMenu[i].status =
IT_STRING|IT_CALL; SR_MainMenu[i].itemaction = M_Credits; break; case
SECRET_SOUNDTEST: SR_MainMenu[i].status = IT_STRING|IT_KEYHANDLER;
                                        SR_MainMenu[i].itemaction =
M_HandleSoundTest; default: break;
                        }
                }
        }
...
/*static void M_CustomLevelSelect(INT32 choice)
{
        ...
        {
                M_StartMessage(M_GetText("No selectable levels
found.\n"),NULL,MM_NOTHING); return;
        }
...
static void M_DrawLoadGameData(void)
{
        ...
        if (saveSlotSelected == NOSAVESLOT) // last slot is play without saving
        {
                ...
                {
                        V_DrawCenteredString(ecks + 68, 144, V_ORANGEMAP,
"ULTIMATE MODE"); V_DrawCenteredString(ecks + 68, 156, 0, "NO RINGS, NO
ONE-UPS,"); V_DrawCenteredString(ecks + 68, 164, 0, "NO CONTINUES, ONE LIFE,");
                        V_DrawCenteredString(ecks + 68, 172, 0, "FINAL
DESTINATION.");
                }
                else
                {
                        V_DrawCenteredString(ecks + 68, 144, V_ORANGEMAP, "PLAY
WITHOUT SAVING"); V_DrawCenteredString(ecks + 68, 156, 0, "THIS GAME WILL NOT
BE"); V_DrawCenteredString(ecks + 68, 164, 0, "SAVED, BUT YOU CAN STILL");
                        V_DrawCenteredString(ecks + 68, 172, 0, "GET MEDALS AND
SECRETS.");
                }
                return;
        }
        ...
        {
                V_DrawCenteredString(ecks + 68, 144, warningflags, "CORRUPT SAVE
FILE"); V_DrawCenteredString(ecks + 68, 156, 0, "THIS SAVE FILE");
                V_DrawCenteredString(ecks + 68, 164, 0, "CAN NOT BE LOADED.");
                V_DrawCenteredString(ecks + 68, 172, 0, "DELETE USING
BACKSPACE."); return;
        }
        ...
        if (savegameinfo[saveSlotSelected].skincolor == 0)
                V_DrawScaledPatch(SP_LoadDef.x,144+8,0,W_CachePatchName(skins[savegameinfo[saveSlotSelected].skinnum].face,
PU_CACHE)); else
        {
                UINT8 *colormap =
R_GetTranslationColormap(savegameinfo[saveSlotSelected].skinnum,
savegameinfo[saveSlotSelected].skincolor, GTC_MENUCACHE);
                V_DrawMappedPatch(SP_LoadDef.x,144+8,0,W_CachePatchName(skins[savegameinfo[saveSlotSelected].skinnum].face,
PU_CACHE), colormap);
        }

        V_DrawString(ecks + 12, 152, 0,
savegameinfo[saveSlotSelected].playername);

#ifdef SAVEGAMES_OTHERVERSIONS
        if (savegameinfo[saveSlotSelected].gamemap & 16384)
                V_DrawCenteredString(ecks + 68, 144, warningflags, "OUTDATED
SAVE FILE!"); #endif

        if (savegameinfo[saveSlotSelected].gamemap & 8192)
                V_DrawString(ecks + 12, 160, recommendedflags, "CLEAR!");
        else
                V_DrawString(ecks + 12, 160, 0, va("%s",
savegameinfo[saveSlotSelected].levelname));

        // Use the big face pic for lives, duh. :3
        V_DrawScaledPatch(ecks + 12, 175, 0, W_CachePatchName("STLIVEX",
PU_HUDGFX)); V_DrawTallNum(ecks + 40, 172, 0,
savegameinfo[saveSlotSelected].lives);

        // Absolute ridiculousness, condensed into another function.
        V_DrawContinueIcon(ecks + 58, 182, 0,
savegameinfo[saveSlotSelected].skinnum,
savegameinfo[saveSlotSelected].skincolor); V_DrawScaledPatch(ecks + 68, 175, 0,
W_CachePatchName("STLIVEX", PU_HUDGFX)); V_DrawTallNum(ecks + 96, 172, 0,
savegameinfo[saveSlotSelected].continues);

        for (i = 0; i < 7; ++i)
        {
                if (savegameinfo[saveSlotSelected].numemeralds & (1 << i))
                        V_DrawScaledPatch(ecks + 104 + (i * 8), 172, 0,
tinyemeraldpics[i]);
        }
}
...
static void M_DrawLoad(void)
{
        ...
        V_DrawCenteredString(BASEVIDWIDTH/2, 40, 0, "Press backspace to delete a
save.");

        for (i = MAXSAVEGAMES + saveSlotSelected - 2 + offset, j = 0;i <=
MAXSAVEGAMES + saveSlotSelected + 2 + offset; i++, j++)
        {
                ...
                {
                        if (ultimate_selectable)
                                V_DrawCenteredString(SP_LoadDef.x+92,
LOADBARHEIGHT - 1, V_ORANGEMAP, "ULTIMATE MODE"); else
                                V_DrawCenteredString(SP_LoadDef.x+92,
LOADBARHEIGHT - 1, V_ORANGEMAP, "PLAY WITHOUT SAVING"); continue;
                }

                if (savegameinfo[i%MAXSAVEGAMES].lives == -42)
                        V_DrawString(SP_LoadDef.x-6, LOADBARHEIGHT - 1,
V_TRANSLUCENT, "NO DATA"); else if (savegameinfo[i%MAXSAVEGAMES].lives == -666)
                        V_DrawString(SP_LoadDef.x-6, LOADBARHEIGHT - 1,
warningflags, "CORRUPT SAVE FILE"); else if
(savegameinfo[i%MAXSAVEGAMES].gamemap & 8192) V_DrawString(SP_LoadDef.x-6,
LOADBARHEIGHT - 1, recommendedflags, "CLEAR!"); else
                        V_DrawString(SP_LoadDef.x-6, LOADBARHEIGHT - 1, 0,
va("%s", savegameinfo[i%MAXSAVEGAMES].levelname));

                //Draw the save slot number on the right side
                V_DrawRightAlignedString(SP_LoadDef.x+192, LOADBARHEIGHT - 1, 0,
va("%d",(i%MAXSAVEGAMES) + 1));
        }

        //Draw cursors on both sides.
        V_DrawScaledPatch( 32, CURSORHEIGHT, 0, W_CachePatchName("M_CURSOR",
PU_CACHE)); V_DrawScaledPatch(274, CURSORHEIGHT, 0, W_CachePatchName("M_CURSOR",
PU_CACHE));
...
static void M_ReadSavegameInfo(UINT32 slot)
{
        ...
        {
                strcpy(savegameinfo[slot].levelname, mapheaderinfo[(fake-1) &
8191]->lvlttl); savegameinfo[slot].actnum = 0; //mapheaderinfo[(fake-1) &
8191]->actnum
        }
        ...
        if (fake & (1<<10))
        {
                ...
                CHECKPOS
                savegameinfo[slot].botcolor = READUINT8(save_p); // because why
not.
        }
        else
                savegameinfo[slot].botskin = 0;
...
static void M_HandleLoadSave(INT32 choice)
{
        ...
        switch (choice)
        {
                ...
                case KEY_ENTER:
                        S_StartSound(NULL, sfx_menu1);
                        if (savegameinfo[saveSlotSelected].lives != -666) //
don't allow loading of "bad saves" M_LoadSelect(saveSlotSelected); break;
                ...
                case KEY_BACKSPACE:
                        ...
                        // Nor allow people to 'delete' slots with no saves in
them. if (saveSlotSelected != NOSAVESLOT && savegameinfo[saveSlotSelected].lives
!= -42) M_StartMessage(M_GetText("Are you sure you want to delete\nthis save
...
mapheaderinfo[startmap-1]->forcecharacter[0] != '\0')
        {
                M_ChoosePlayer(0); //oh for crying out loud just get STARTED, it
doesn't matter! return;
        }
...
"&"); for (j = 0; j < numskins; j++) if (stricmp(skins[j].name, picname) == 0)
                                {
                                        Z_Free(picname);
                ...
                if (SHORT(patch->width) >= 256)
                        V_DrawCroppedPatch(8<<FRACBITS, (my + 8)<<FRACBITS,
FRACUNIT/2, 0, patch, 0, SHORT(patch->height) - 64 + o*2, SHORT(patch->width),
SHORT(patch->height)); else V_DrawCroppedPatch(8<<FRACBITS, (my + 8)<<FRACBITS,
FRACUNIT, 0, patch, 0, SHORT(patch->height) - 32 + o, SHORT(patch->width),
SHORT(patch->height)); W_UnlockCachedPatch(patch);
        }
...
"&"); for (j = 0; j < numskins; j++) if (stricmp(skins[j].name, picname) == 0)
                ...
                patch = W_CachePatchName(picname, PU_CACHE);
                if (SHORT(patch->width) >= 256)
                        V_DrawCroppedPatch(8<<FRACBITS, (my + 168 -
o)<<FRACBITS, FRACUNIT/2, 0, patch, 0, 0, SHORT(patch->width), o*2); else
                        V_DrawCroppedPatch(8<<FRACBITS, (my + 168 -
o)<<FRACBITS, FRACUNIT, 0, patch, 0, 0, SHORT(patch->width), o);
...
"&"); for (j = 0; j < numskins; j++) if (stricmp(skins[j].name, picname) == 0)
                ...
                {
                        if (SHORT(patch->width) >= 256)
                                V_DrawSmallScaledPatch(8, my + 40 - o, 0,
patch); else V_DrawScaledPatch(8, my + 40 - o, 0, patch);
                }
                else
                {
                        if (SHORT(patch->width) >= 256)
                                V_DrawCroppedPatch(8<<FRACBITS, (my +
8)<<FRACBITS, FRACUNIT/2, 0, patch, 0, (o - 32)*2, SHORT(patch->width),
SHORT(patch->height)); else V_DrawCroppedPatch(8<<FRACBITS, (my + 8)<<FRACBITS,
FRACUNIT, 0, patch, 0, o - 32, SHORT(patch->width), SHORT(patch->height));
                }
                W_UnlockCachedPatch(patch);
        }
        ...
        if (!char_notes)
                char_notes = V_WordWrap(0, 21*8, V_ALLOWLOWERCASE,
description[itemOn].notes); V_DrawString(146, my + 9,
V_RETURN8|V_ALLOWLOWERCASE, char_notes);
}
...
static void M_ChoosePlayer(INT32 choice)
{
        char *skin1,*skin2;
        INT32 skinnum;
        //boolean ultmode = (ultimate_selectable && SP_PlayerDef.prevMenu ==
&SP_LoadDef && saveSlotSelected == NOSAVESLOT);

        // skip this if forcecharacter
        if (mapheaderinfo[startmap-1] &&
mapheaderinfo[startmap-1]->forcecharacter[0] == '\0')
        {
                // M_SetupChoosePlayer didn't call us directly, that means we've
been properly set up. char_scroll = itemOn*128*FRACUNIT; // finish scrolling the
menu M_DrawSetupChoosePlayerMenu(); // draw the finally selected character one
last time for the fadeout
        }
        M_ClearMenus(true);
        ...
        G_DeferedInitNew(false, G_BuildMapName(startmap), (UINT8)skinnum, 0,
fromlevelselect); COM_BufAddText("dummyconsvar 1\n"); // G_DeferedInitNew
doesn't do this
}*/
...
static void M_DrawStatsMaps(int location) {
  ...
  if (location)
    V_DrawCharacter(10, y - (skullAnimCounter / 5), '\x1A' | highlightflags,
                    false); // up arrow
  ...
  while (statsMapList[++i] != -1) {
    ...
    if (mapheaderinfo[mnum]->levelflags & LF_NOZONE)
      V_DrawString(20, y, 0,
                   va("%s %s", mapheaderinfo[mnum]->lvlttl,
                      mapheaderinfo[mnum]->actnum));
    else
      V_DrawString(
          20, y, 0,
          va("%s %s %s", mapheaderinfo[mnum]->lvlttl,
             (mapheaderinfo[mnum]->zonttl[0] ? mapheaderinfo[mnum]->zonttl
                                             : "Zone"),
             mapheaderinfo[mnum]->actnum));
  ...
  for (i = -2; i < numextraemblems; ++i) {
    ...
    if (i >= 0) {
      ...
      if (exemblem->collected)
        V_DrawSmallMappedPatch(
            295, y, 0,
            W_CachePatchName(M_GetExtraEmblemPatch(exemblem), PU_CACHE),
            R_GetTranslationColormap(
                TC_DEFAULT, M_GetExtraEmblemColor(exemblem), GTC_MENUCACHE));
      else
...
bottomarrow:
  if (dobottomarrow)
    V_DrawCharacter(10, y - 8 + (skullAnimCounter / 5), '\x1B' | highlightflags,
                    false); // down arrow
}
...
static void M_DrawLevelStats(void) {
  ...
  V_DrawRightAlignedString(BASEVIDWIDTH - 16, 42, 0,
                           va("%i played", matchesplayed));
  ...
  sprintf(beststr, "%i:%02i:%02i.%02i", G_TicsToHours(besttime),
          G_TicsToMinutes(besttime, false), G_TicsToSeconds(besttime),
          G_TicsToCentiseconds(besttime));
  V_DrawRightAlignedString(BASEVIDWIDTH - 16, 62,
                           (mapsunfinished ? warningflags : 0), beststr);

  if (mapsunfinished)
    V_DrawRightAlignedString(BASEVIDWIDTH - 16, 70, warningflags,
                             va("(%d unfinished)", mapsunfinished));
  else
    V_DrawRightAlignedString(BASEVIDWIDTH - 16, 70, recommendedflags,
                             "(complete)");

  V_DrawString(32, 70, 0,
               va("x %d/%d", M_CountEmblems(), numemblems + numextraemblems));
...
static void M_HandleLevelStats(INT32 choice) {
  ...
  case KEY_PGDN:
    S_StartSound(NULL, sfx_menu1);
    statsLocation +=
        (statsLocation + 13 >= statsMax) ? statsMax - statsLocation : 13;
    break;
...
void M_DrawTimeAttackMenu(void) {
  ...
  // S_ChangeMusicInternal("racent", true); // Eww, but needed for when user
  // hits escape during demo playback
  ...
  if (W_CheckNumForName(skins[cv_chooseskin.value - 1].facewant) != LUMPERROR) {
    UINT8 *colormap = R_GetTranslationColormap(
        cv_chooseskin.value - 1, cv_playercolor.value, GTC_MENUCACHE);
    V_DrawMappedPatch(BASEVIDWIDTH - x -
                          SHORT(facewantprefix[cv_chooseskin.value - 1]->width),
                      y, 0, facewantprefix[cv_chooseskin.value - 1], colormap);
  }
  ...
  for (i = 0; i < currentMenu->numitems; ++i) {
    ...
    V_DrawString(x, y, (dispstatus == IT_WHITESTRING) ? highlightflags : 0,
                 currentMenu->menuitems[i].text);
    ...
    if ((currentMenu->menuitems[i].status & IT_TYPE) == IT_CVAR) {
      ...
      if (currentMenu->menuitems[i].status & IT_CV_STRING) {
        ...
        if (itemOn == i && skullAnimCounter < 4) // blink cursor
          V_DrawCharacter(x + 40 + V_StringWidth(cv->string, V_ALLOWLOWERCASE),
                          y, '_', false);
      } else {
        const char *str =
            ((cv == &cv_chooseskin) ? skins[cv_chooseskin.value - 1].realname
                                    : cv->string);
        ...
        if (i == itemOn) {
          V_DrawCharacter(BASEVIDWIDTH - x - soffset - 10 - strw -
                              (skullAnimCounter / 5),
                          y, '\x1C' | highlightflags,
                          false); // left arrow
          V_DrawCharacter(BASEVIDWIDTH - x - soffset + 2 +
                              (skullAnimCounter / 5),
                          y, '\x1D' | highlightflags,
                          false); // right arrow
        }
      }
    } else if ((currentMenu->menuitems[i].status & IT_TYPE) == IT_KEYHANDLER &&
               cv_dummystaff.value) // bad hacky assumption: IT_KEYHANDLER is
                                    // assumed to be staff ghost selector
    {
      INT32 strw = V_StringWidth(dummystaffname, V_ALLOWLOWERCASE);
      V_DrawString(BASEVIDWIDTH - x - strw, y,
                   highlightflags | V_ALLOWLOWERCASE, dummystaffname);
      if (i == itemOn) {
        V_DrawCharacter(BASEVIDWIDTH - x - 10 - strw - (skullAnimCounter / 5),
                        y, '\x1C' | highlightflags,
                        false); // left arrow
        V_DrawCharacter(BASEVIDWIDTH - x + 2 + (skullAnimCounter / 5), y,
                        '\x1D' | highlightflags,
  ...
  /*{
          ...
          if (!mainrecords[cv_nextmap.value-1] ||
  !mainrecords[cv_nextmap.value-1]->time) sprintf(beststr, "(none)"); else
                  sprintf(beststr, "%i:%02i.%02i",
  G_TicsToMinutes(mainrecords[cv_nextmap.value-1]->time, true),
          ...
          V_DrawRightAlignedString(BASEVIDWIDTH - 64 - 24 - 8, y+48,
  V_ALLOWLOWERCASE, beststr);

          if (!mainrecords[cv_nextmap.value-1] ||
  !mainrecords[cv_nextmap.value-1]->lap) sprintf(beststr, "(none)"); else
                  sprintf(beststr, "%i:%02i.%02i",
  G_TicsToMinutes(mainrecords[cv_nextmap.value-1]->lap, true),
          ...
          V_DrawRightAlignedString(BASEVIDWIDTH - 64 - 24 - 8, y+56,
  V_ALLOWLOWERCASE, beststr);
          ...
          while (em)
          {
                  ...
                  if (em->collected)
                          V_DrawMappedPatch(BASEVIDWIDTH - 64 - 24, y+48, 0,
  W_CachePatchName(M_GetEmblemPatch(em), PU_CACHE),
                                                 R_GetTranslationColormap(TC_DEFAULT,
  M_GetEmblemColor(em), GTC_MENUCACHE)); else V_DrawScaledPatch(BASEVIDWIDTH -
  64 - 24, y+48, 0, W_CachePatchName("NEEDIT", PU_CACHE));
  ...
  // ALWAYS DRAW player name, level name, skin and color even when not on this
  // menu!
  if (currentMenu != &SP_TimeAttackDef) {
    consvar_t *ncv;
    ...
    for (i = 0; i < 4; ++i) {
      ...
      if (SP_TimeAttackMenu[i].status & IT_CV_STRING) {
        ...
        const char *str =
            ((ncv == &cv_chooseskin) ? skins[cv_chooseskin.value - 1].realname
                                     : ncv->string);
        INT32 soffset = 40, strw = V_StringWidth(str, 0);
        ...
        // Should see nothing but strings
        V_DrawString(BASEVIDWIDTH - x - soffset - strw, y,
                     highlightflags | V_TRANSLUCENT, str);
      }
    }
  }
}
...
hits escape during demo playback
        ...
        //  A 160x100 image of the level as entry MAPxxP
        lumpnum = W_CheckNumForName(va("%sP",
G_BuildMapName(cv_nextmap.value)));
        ...
        if (cv_nextmap.value)
        {
                ...
                UINT8 bestoverall	= G_GetBestNightsGrade(cv_nextmap.value,
0); UINT8 bestgrade		= G_GetBestNightsGrade(cv_nextmap.value,
cv_dummymares.value); UINT32 bestscore	= G_GetBestNightsScore(cv_nextmap.value,
cv_dummymares.value);
                tic_t besttime		= G_GetBestNightsTime(cv_nextmap.value,
cv_dummymares.value);

                if (P_HasGrades(cv_nextmap.value, 0))
                        V_DrawScaledPatch(200, 28 + 8, 0,
ngradeletters[bestoverall]);

                if (currentMenu == &SP_NightsAttackDef)
                {
                        if (P_HasGrades(cv_nextmap.value, cv_dummymares.value))
                        {
                                V_DrawString(160-88, 112, highlightflags, "BEST
GRADE:"); V_DrawSmallScaledPatch(160 + 86 - (ngradeletters[bestgrade]->width/2),
                                        112 + 8 -
(ngradeletters[bestgrade]->height/2), 0, ngradeletters[bestgrade]);
                        }
                        ...
                        V_DrawString(160 - 88, 122, highlightflags, "BEST
SCORE:"); V_DrawRightAlignedString(160 + 88, 122, V_ALLOWLOWERCASE, beststr);
...
G_TicsToMinutes(besttime, true), G_TicsToSeconds(besttime),
                        ...
                        V_DrawRightAlignedString(160+88, 132, V_ALLOWLOWERCASE,
beststr);
                        ...
                        if (cv_dummymares.value == 0) {
                                ...
                                while (em)
                                {
                                        switch (em->type)
                                        {
                                                case ET_NGRADE: yHeight = 112;
break; case ET_NTIME:  yHeight = 132; break; default: goto skipThisOne;
                                        }

                                        if (em->collected)
                                                V_DrawSmallMappedPatch(160+88,
yHeight, 0, W_CachePatchName(M_GetEmblemPatch(em), PU_CACHE),
                                                                                                                                         R_GetTranslationColormap(TC_DEFAULT, M_GetEmblemColor(em), GTC_MENUCACHE));
                                        else
                                                V_DrawSmallScaledPatch(160+88,
yHeight, 0, W_CachePatchName("NEEDIT", PU_CACHE));
                ...
                else
                {
                        ...
                        V_DrawString(x, y + SP_NightsAttackMenu[0].alphaKey,
V_TRANSLUCENT, SP_NightsAttackMenu[0].text); V_DrawString(BASEVIDWIDTH - x -
V_StringWidth(ncv->string, 0), y + SP_NightsAttackMenu[0].alphaKey,
highlightflags|V_TRANSLUCENT, ncv->string);
                }
        }
}*/
...
/*static void M_NightsAttack(INT32 choice)
{
        ...
        levellistmode = LLM_NIGHTSATTACK; // Don't be dependent on
cv_newgametype

        if (M_CountLevelsToShowInList() == 0)
        {
                M_StartMessage(M_GetText("No NiGHTS-attackable levels
found.\n"),NULL,MM_NOTHING); return;
        }

        // This is really just to make sure Sonic is the played character, just
in case M_PatchSkinNameTable();
...
"replay"PATHSEP"%s"PATHSEP"%s-last", timeattackfolder,
G_BuildMapName(cv_nextmap.value));
...
static void M_ChooseTimeAttack(INT32 choice) {
  char *gpath;
  const size_t glen =
      strlen("replay") + 1 + strlen(timeattackfolder) + 1 + strlen("MAPXX") + 1;
  char nameofdemo[256];
  (void)choice;
  emeralds = 0;
  M_ClearMenus(true);
  ...
  sprintf(gpath, "replay" PATHSEP "%s" PATHSEP "%s", timeattackfolder,
          G_BuildMapName(cv_nextmap.value));
  snprintf(nameofdemo, sizeof nameofdemo, "%s-%s-last", gpath,
           cv_chooseskin.string);
  ...
  G_DeferedInitNew(false, G_BuildMapName(cv_nextmap.value),
                   (UINT8)(cv_chooseskin.value - 1), 0, false);
}

static void M_HandleStaffReplay(INT32 choice) {
  boolean exitmenu = false; // exit to previous menu
  lumpnum_t l = W_CheckNumForName(
      va("%sS%02u", G_BuildMapName(cv_nextmap.value), cv_dummystaff.value));
  ...
  case KEY_ENTER:
    ...
    demo.ignorefiles =
        true; // Just assume that record attack replays have the files needed
    G_DoPlayDemo(
        va("%sS%02u", G_BuildMapName(cv_nextmap.value), cv_dummystaff.value));
    break;
  default:
...
static void M_ReplayTimeAttack(INT32 choice) {
  const char *which;
  M_ClearMenus(true);
  modeattacking = ATTACKING_RECORD; // set modeattacking before G_DoPlayDemo so
                                    // the map loader knows
  demo.loadfiles = false;
  demo.ignorefiles =
      true; // Just assume that record attack replays have the files needed
  ...
  if (currentMenu == &SP_ReplayDef) {
    ...
    case 3: // guest
      ...
      G_DoPlayDemo(va("%s" PATHSEP "replay" PATHSEP "%s" PATHSEP "%s-guest.lmp",
                      srb2home, timeattackfolder,
                      G_BuildMapName(cv_nextmap.value)));
      return;
    }
    // srb2/replay/main/map01-sonic-time-best.lmp
    G_DoPlayDemo(va("%s" PATHSEP "replay" PATHSEP "%s" PATHSEP "%s-%s-%s.lmp",
                    srb2home, timeattackfolder,
                    G_BuildMapName(cv_nextmap.value), cv_chooseskin.string,
                    which));
  }
  /*else if (currentMenu == &SP_NightsReplayDef)
  {
          ...
          G_DoPlayDemo(va("%s"PATHSEP"replay"PATHSEP"%s"PATHSEP"%s-%s.lmp",
  srb2home, timeattackfolder, G_BuildMapName(cv_nextmap.value), which));
  }*/
}

static void M_EraseGuest(INT32 choice) {
  const char *rguest =
      va("%s" PATHSEP "replay" PATHSEP "%s" PATHSEP "%s-guest.lmp", srb2home,
         timeattackfolder, G_BuildMapName(cv_nextmap.value));
  (void)choice;
...
static void M_OverwriteGuest(const char *which) {
  char *rguest = Z_StrDup(
      va("%s" PATHSEP "replay" PATHSEP "%s" PATHSEP "%s-guest.lmp", srb2home,
         timeattackfolder, G_BuildMapName(cv_nextmap.value)));
  UINT8 *buf;
  size_t len;
  len = FIL_ReadFile(
      va("%s" PATHSEP "replay" PATHSEP "%s" PATHSEP "%s-%s-%s.lmp", srb2home,
         timeattackfolder, G_BuildMapName(cv_nextmap.value),
         cv_chooseskin.string, which),
      &buf);
  if (!len) {
    return;
  }
...
static void M_SetGuestReplay(INT32 choice) {
  ...
  if (FIL_FileExists(
          va("%s" PATHSEP "replay" PATHSEP "%s" PATHSEP "%s-guest.lmp",
             srb2home, timeattackfolder, G_BuildMapName(cv_nextmap.value))))
    M_StartMessage(M_GetText("Are you sure you want to\noverwrite the guest "
                             "replay data?\n\n(Press 'Y' to confirm)\n"),
                   which, MM_YESNO);
  else
...
static void M_Connect(INT32 choice) {
  ...
  COM_BufAddText(va(
      "connect node %d\n",
      serverlist[choice - FIRSTSERVERLINE + serverlistpage * SERVERS_PER_PAGE]
          .node));
}
...
static void M_DrawServerCountAndHorizontalBar(void) {
  ...
  default:
    if (serverlistultimatecount > serverlistcount) {
      text = va("%d/%d servers found%.*s", serverlistcount,
                serverlistultimatecount, I_GetTime() / NEWTICRATE % 4, "...");
...
static void M_DrawServerLines(INT32 x, INT32 page) {
  ...
  for (i = 0;
       i < min(serverlistcount - page * SERVERS_PER_PAGE, SERVERS_PER_PAGE);
       i++) {
    INT32 slindex = i + page * SERVERS_PER_PAGE;
    UINT32 globalflags =
        ((serverlist[slindex].info.numberofplayer >=
          serverlist[slindex].info.maxplayer)
             ? V_TRANSLUCENT
             : 0) |
        ((itemOn == FIRSTSERVERLINE + i) ? highlightflags : 0) |
        V_ALLOWLOWERCASE;

    V_DrawString(x, S_LINEY(i), globalflags,
                 serverlist[slindex].info.servername);

    // Don't use color flags intentionally, the global yellow color will auto
    // override the text color code
    if (serverlist[slindex].info.modifiedgame)
      V_DrawSmallString(x + 202, S_LINEY(i) + 8, globalflags,
                        "\x85"
                        "Mod");
    if (serverlist[slindex].info.cheatsenabled)
      V_DrawSmallString(x + 222, S_LINEY(i) + 8, globalflags,
                        "\x83"
                        "Cheats");

    V_DrawSmallString(
        x, S_LINEY(i) + 8, globalflags,
    ...
    if (serverlist[slindex].info.gametype == GT_RACE) {
      spd = kartspeed_cons_t[serverlist[slindex].info.kartvars & SV_SPEEDMASK]
                .strvalue;

      V_DrawSmallString(x + 132, S_LINEY(i) + 8, globalflags,
                        va("(%s Speed)", spd));
    }
...
static void M_DrawConnectMenu(void) {
  UINT16 i;
  INT32 numPages =
      (serverlistcount + (SERVERS_PER_PAGE - 1)) / SERVERS_PER_PAGE;
  INT32 mservflags = V_ALLOWLOWERCASE;

  for (i = FIRSTSERVERLINE;
       i < min(localservercount, SERVERS_PER_PAGE) + FIRSTSERVERLINE; i++)
  ...
  V_DrawRightAlignedString(
      ...
      currentMenu->y + MP_ConnectMenu[mp_connect_page].alphaKey, highlightflags,
      va("%u of %d", serverlistpage + 1, numPages));
  ...
  V_DrawRightAlignedSmallString(
      BASEVIDWIDTH - currentMenu->x,
      currentMenu->y + 3 + MP_ConnectMenu[mp_connect_refresh].alphaKey,
  ...
  if (oldserverlistpage != serverlistpage) {
    ...
    const INT32 x =
        (FLOAT_TO_FIXED(serverlistslidex) + ease * rendertimefrac) / FRACUNIT;
...
#define SERVER_LIST_ENTRY_COMPARATOR(key)                                      \
  static int ServerListEntryComparator_##key(const void *entry1,               \
                                             const void *entry2) {             \
    const serverelem_t *sa = (const serverelem_t *)entry1,                     \
                       *sb = (const serverelem_t *)entry2;                     \
...
#define SERVER_LIST_ENTRY_COMPARATOR_REVERSE(key)                              \
  static int ServerListEntryComparator_##key##_reverse(const void *entry1,     \
                                                       const void *entry2) {   \
    const serverelem_t *sa = (const serverelem_t *)entry1,                     \
                       *sb = (const serverelem_t *)entry2;                     \
...
static int ServerListEntryComparator_modified(const void *entry1,
                                              const void *entry2) {
  const serverelem_t *sa = (const serverelem_t *)entry1,
                     *sb = (const serverelem_t *)entry2;
  ...
  int modstate_a =
      (sa->info.cheatsenabled ? 1 : 0) | (sa->info.modifiedgame ? 2 : 0);
  int modstate_b =
      (sb->info.cheatsenabled ? 1 : 0) | (sb->info.modifiedgame ? 2 : 0);
...
void M_SortServerList(void) {
  ...
  case 0: // Ping.
    qsort(serverlist, serverlistcount, sizeof(serverelem_t),
  ...
  case 5: // Gametype.
    qsort(serverlist, serverlistcount, sizeof(serverelem_t),
          ServerListEntryComparator_gametype);
    break;
  }
#endif
}
...
static void M_ConnectMenuModChecks(INT32 choice) {
  (void)choice;
  // okay never mind we want to COMMUNICATE to the player pre-emptively instead
  // of letting them try and then get confused when it doesn't work

  if (modifiedgame) {
    M_StartMessage(
        M_GetText(
            "You have addons loaded.\nYou won't be able to join "
...
static void M_HandleMasterServerResetChoice(event_t *ev) {
  ...
  if (ev->type == ev_keydown) {
    if (choice == ' ' || choice == 'y' || choice == KEY_ENTER ||
        choice == gamecontrol[gc_accelerate][0] ||
        choice == gamecontrol[gc_accelerate][1]) {
      CV_Set(&cv_masterserver, cv_masterserver.defaultvalue);
      CV_Set(&cv_masterserver_nagattempts,
             cv_masterserver_nagattempts.defaultvalue);
      S_StartSound(NULL, sfx_s221);
    } else {
      if (firstDismissedNagThisBoot) {
        if (cv_masterserver_nagattempts.value > 0) {
          CV_SetValue(&cv_masterserver_nagattempts,
                      cv_masterserver_nagattempts.value - 1);
        }
...
static void M_PreStartServerMenu(INT32 choice) {
  ...
  if (!CV_IsSetToDefault(&cv_masterserver) &&
      cv_masterserver_nagattempts.value > 0) {
    M_StartMessage(
        M_GetText(
            "Hey! You've changed the Server Browser address.\n\nYou won't "
            "be able to host games on the official Server Browser.\nUnless "
            "you're from the future, this probably isn't what you "
            "want.\n\n\x83Press Accel\x80 to fix this and "
...
static void M_PreConnectMenu(INT32 choice) {
  ...
  if (!CV_IsSetToDefault(&cv_masterserver) &&
    ...
    M_StartMessage(
        M_GetText(
            "Hey! You've changed the Server Browser address.\n\nYou won't "
            "be able to see games from the official Server "
            "Browser.\nUnless you're from the future, this probably isn't "
            "what you want.\n\n\x83Press Accel\x80 to fix this and "
            "continue.\x80\nPress any other key to continue anyway.\n"),
...
static void M_StartServer(INT32 choice) {
  ...
  if (!cv_nextmap.value)
    CV_SetValue(&cv_nextmap, G_RandMap(G_TOLFlag(cv_newgametype.value), -1,
                                       false, 0, false, NULL) +
                                 1);
  ...
  if (currentMenu == &MP_OfflineServerDef) // offline server
  {
    ...
    D_MapChange(cv_nextmap.value, cv_newgametype.value,
                (boolean)cv_kartencore.value, 1, 1, false, false);
  } else {
    D_MapChange(cv_nextmap.value, cv_newgametype.value,
                (boolean)cv_kartencore.value, 1, 1, false, false);
...
static void M_DrawLevelSelectOnly(boolean leftfade, boolean rightfade) {
  lumpnum_t lumpnum;
  patch_t *PictureOfLevel;
  INT32 x, y, w, i, oldval, trans,
      dupadjust = ((vid.width / vid.dupx) - BASEVIDWIDTH) >> 1;
  ...
  if (currentMenu->menuitems[itemOn].itemaction == &cv_nextmap &&
      skullAnimCounter < 4)
    trans = 120;
  else
  ...
  if (!cv_kartencore.value || gamestate == GS_TIMEATTACK ||
      cv_newgametype.value != GT_RACE)
    ...
    V_DrawFixedPatch((x + w) << FRACBITS, (y) << FRACBITS, FRACUNIT / 2, V_FLIP,
                     PictureOfLevel, 0);

    {
      ...
      const fixed_t rubyheight = FINESINE(rubyfloattime >> ANGLETOFINESHIFT);
      V_DrawFixedPatch((x + w / 2) << FRACBITS,
                       ((y + i / 2) << FRACBITS) - (rubyheight << 1), FRACUNIT,
                       0, W_CachePatchName("RUBYICON", PU_CACHE), NULL);
      rubyfloattime += FixedMul(ANGLE_MAX / NEWTICRATE, renderdeltatics);
    }
  }
...
#define horizspac 2
  do {
    ...
    do {
      ...
      if (!mapheaderinfo[i])
        continue; // Don't allocate the header.  That just makes memory usage
                  // skyrocket.
...
static void M_DrawServerMenu(void) {
  ...
  if (currentMenu == &MP_ServerDef &&
      cv_advertise.value) // Remind players where they're hosting.
  {
    ...
    if (CV_IsSetToDefault(&cv_masterserver))
      ...
      mservflags = mservflags | warningflags;
    V_DrawCenteredThinString(BASEVIDWIDTH / 2, BASEVIDHEIGHT - 12, mservflags,
                             va("Master Server: %s", cv_masterserver.string));
  }
  M_DrawGenericMenu();
}
...
static void M_DrawMPMainMenu(void) {
  ...
  V_DrawFill(x + 5, y + 4 + 5, /*16*8 + 6,*/ BASEVIDWIDTH - 2 * (x + 5), 8 + 6,
             239);
  ...
  if (itemOn == 8 && skullAnimCounter < 4) // blink cursor
    V_DrawCharacter(x + 8 + V_StringWidth(setupm_ip, V_ALLOWLOWERCASE), y + 12,
                    '_', false);
#endif
...
#define incrwidth (iconwidth + spacingwidth)
    ...
    while (++i <= 4) {
      ...
      V_DrawFixedPatch(x << FRACBITS, y << FRACBITS, FRACUNIT, trans,
                       facewantprefix[pskin], colmap);
      ...
      if (itemOn == 2 && i == setupm_pselect) {
        ...
        V_DrawFixedPatch(
            x << FRACBITS, y << FRACBITS, FRACUNIT, 0,
            W_CachePatchName(va("K_BHILI%d", (cursorframe >> FRACBITS) + 1),
                             PU_CACHE),
            NULL);
      }
...
static void M_ConnectIP(INT32 choice) {
  ...
  V_DrawCenteredString(BASEVIDWIDTH / 2, BASEVIDHEIGHT / 2, 0,
...
static void M_HandleConnectIP(INT32 choice) {
  ...
  default:
    ...
    // Rudimentary number and period enforcing - also allows letters so
    // hostnames can be used instead
    if ((choice >= '-' && choice <= ':') || (choice >= 'A' && choice <= 'Z') ||
        (choice >= 'a' && choice <= 'z')) {
      S_StartSound(NULL, sfx_menu1); // Tails
      setupm_ip[l] = (char)choice;
      setupm_ip[l + 1] = 0;
    } else if (choice >= 199 && choice <= 211 && choice != 202 &&
               choice != 206) // numpad too!
    {
      char keypad_translation[] = {'7', '8', '9', '-', '4', '5', '6',
                                   '+', '1', '2', '3', '0', '.'};
...
static void M_DrawSetupMultiPlayerMenu(void) {
  ...
  if (!itemOn && skullAnimCounter < 4) // blink cursor
    V_DrawCharacter(mx + 40 + V_StringWidth(setupm_name, V_ALLOWLOWERCASE), my,
                    '_', false);

  // draw skin string
  st = V_StringWidth(skins[setupm_fakeskin].realname, 0);
  V_DrawString(BASEVIDWIDTH - mx - st, my + 16,
               ((MP_PlayerSetupMenu[2].status & IT_TYPE) == IT_SPACE
                    ? V_TRANSLUCENT
                    : 0) |
                   highlightflags | V_ALLOWLOWERCASE,
               skins[setupm_fakeskin].realname);
  if (itemOn == 1) {
    V_DrawCharacter(BASEVIDWIDTH - mx - 10 - st - (skullAnimCounter / 5),
                    my + 16, '\x1C' | highlightflags,
                    false); // left arrow
  ...
  V_DrawString(BASEVIDWIDTH - mx - st, my + 152,
               highlightflags | V_ALLOWLOWERCASE,
               KartColor_Names[setupm_fakecolor]); // SRB2kart
  if (itemOn == 2) {
    V_DrawCharacter(BASEVIDWIDTH - mx - 10 - st - (skullAnimCounter / 5),
                    my + 152, '\x1C' | highlightflags,
                    false); // left arrow
  ...
  // labels
  V_DrawThinString(statx + 16, staty, V_6WIDTHSPACE | highlightflags,
                   "Acceleration");
  V_DrawThinString(statx + 91, staty, V_6WIDTHSPACE | highlightflags,
                   "Max Speed");
  V_DrawThinString(statx, staty + 12, V_6WIDTHSPACE | highlightflags,
                   "Handling");
  V_DrawThinString(statx + 7, staty + 77, V_6WIDTHSPACE | highlightflags,
                   "Weight");
  // label arrows
  V_DrawFixedPatch((statx + 64) << FRACBITS, staty << FRACBITS, FRACUNIT, 0,
                   statlr, flashcol);
  V_DrawFixedPatch((statx + 24) << FRACBITS, (staty + 22) << FRACBITS, FRACUNIT,
                   0, statud, flashcol);
  // bg
  V_DrawFixedPatch((statx + 34) << FRACBITS, (staty + 10) << FRACBITS, FRACUNIT,
                   0, statbg, 0);
  ...
  for (i = 0; i < numskins; i++) // draw the stat dots
  {
    if (i != setupm_fakeskin && R_SkinAvailable(skins[i].name) != -1) {
      ...
      V_DrawFixedPatch(((BASEVIDWIDTH - mx - 80) + ((speed - 1) * 8))
                           << FRACBITS,
                       ((my + 76) + ((weight - 1) * 8)) << FRACBITS, FRACUNIT,
                       0, statdot, NULL);
    }
  }
  ...
  if (skullAnimCounter <
      4) // SRB2Kart: we draw this dot later so that it's not covered if there's
         // multiple skins with the same stats
    V_DrawFixedPatch(((BASEVIDWIDTH - mx - 80) + ((speed - 1) * 8)) << FRACBITS,
                     ((my + 76) + ((weight - 1) * 8)) << FRACBITS, FRACUNIT, 0,
                     statdot, flashcol);
  else
    V_DrawFixedPatch(((BASEVIDWIDTH - mx - 80) + ((speed - 1) * 8)) << FRACBITS,
                     ((my + 76) + ((weight - 1) * 8)) << FRACBITS, FRACUNIT, 0,
  ...
  if (setupm_fakecolor)
    V_DrawFixedPatch(
        ((BASEVIDWIDTH - mx - 80) + ((speed - 1) * 8)) << FRACBITS,
        ((my + 76) + ((weight - 1) * 8)) << FRACBITS, FRACUNIT, 0, statdot,
        R_GetTranslationColormap(0, setupm_fakecolor, GTC_MENUCACHE));

    // 2.2 color bar backported with permission
#define charw 72
#define indexwidth 8
  {
    const INT32 colwidth =
        ((BASEVIDWIDTH - (2 * mx)) - charw) / (2 * indexwidth);
    INT32 j = -colwidth;
...
#define iconwidth 32
  {
    ...
    cursor = W_CachePatchName(va("K_BHILI%d", (cursorframe >> FRACBITS) + 1),
                              PU_CACHE);
    ...
    while (k <= icons) {
      ...
      V_DrawFixedPatch((x + offx) << FRACBITS, (my + 28 + offy) << FRACBITS,
                       FRACUNIT, 0, face, colmap);
      if (scale == FRACUNIT) // bit of a hack
        V_DrawFixedPatch((x + offx) << FRACBITS, (my + 28 + offy) << FRACBITS,
                         FRACUNIT, 0, cursor, colmap);
      if (++col >= numskins)
        col -= numskins;
...
#undef iconwidth
  ...
  if (setupm_fakecolor) // inverse should never happen
  {
    UINT8 *colormap = R_GetTranslationColormap(setupm_fakeskin,
                                               setupm_fakecolor, GTC_MENUCACHE);

    if (skins[setupm_fakeskin].flags & SF_HIRES) {
      V_DrawFixedPatch((mx + 43) << FRACBITS, (my + 131) << FRACBITS,
                       skins[setupm_fakeskin].highresscale, flags, patch,
                       colormap);
    } else
...
static void M_HandleSetupMultiPlayer(INT32 choice) {
  ...
  if ((choice == gamecontrol[gc_fire][0] ||
       choice == gamecontrol[gc_fire][1]) &&
      itemOn == 2)
...
static boolean M_QuitMultiPlayerMenu(void) {
  ...
  if (strcmp(setupm_name, setupm_cvname->string)) {
    ...
    for (l = strlen(setupm_name) - 1; (signed)l >= 0 && setupm_name[l] == ' ';
         l--)
      setupm_name[l] = 0;
...
static void M_EraseDataResponse(INT32 ch) {
  ...
  // Delete the data
  if (erasecontext == 2) {
    // SRB2Kart: This actually needs to be done FIRST, so that you don't
    // immediately regain playtime/matches secrets
    totalplaytime = 0;
    matchesplayed = 0;
    F_StartIntro();
  }
...
static void M_DrawJoystick(void) {
  ...
  for (i = 0; i < 8; i++) {
    M_DrawTextBox(OP_JoystickSetDef.x - 8,
                  OP_JoystickSetDef.y + LINEHEIGHT * i - 12, 28, 1);
    // M_DrawSaveLoadBorder(OP_JoystickSetDef.x,
    // OP_JoystickSetDef.y+LINEHEIGHT*i);
    ...
    if ((setupcontrolplayer == 4 && (i == compareval4)) ||
      ...
      V_DrawString(OP_JoystickSetDef.x,
                   OP_JoystickSetDef.y + LINEHEIGHT * i - 4, V_GREENMAP,
                   joystickInfo[i]);
    else
      V_DrawString(OP_JoystickSetDef.x,
                   OP_JoystickSetDef.y + LINEHEIGHT * i - 4, 0,
                   joystickInfo[i]);
  }
}
...
static void M_AssignJoystick(INT32 choice) {
  ...
  if (setupcontrolplayer == 4) {
    oldchoice = oldstringchoice = atoi(cv_usejoystick4.string) > numjoys
                                      ? atoi(cv_usejoystick4.string)
                                      : cv_usejoystick4.value;
    ...
    if (choice <= numjoys) {
      ...
      if (oldchoice != choice) {
        if (choice &&
            oldstringchoice > numjoys) // if we did not select "None", we likely
                                       // selected a used device
          CV_SetValue(
              &cv_usejoystick4,
              (oldstringchoice > numjoys ? oldstringchoice : oldchoice));

        if (oldstringchoice == (atoi(cv_usejoystick4.string) > numjoys
                                    ? atoi(cv_usejoystick4.string)
                                    : cv_usejoystick4.value))
    ...
    oldchoice = oldstringchoice = atoi(cv_usejoystick3.string) > numjoys
                                      ? atoi(cv_usejoystick3.string)
                                      : cv_usejoystick3.value;
    ...
    if (choice <= numjoys) {
      ...
      if (oldchoice != choice) {
        ...
        if (oldstringchoice == (atoi(cv_usejoystick3.string) > numjoys
                                    ? atoi(cv_usejoystick3.string)
                                    : cv_usejoystick3.value))
          M_StartMessage("This joystick is used by another\n"
                         "player. Reset the joystick\n"
    ...
    oldchoice = oldstringchoice = atoi(cv_usejoystick2.string) > numjoys
                                      ? atoi(cv_usejoystick2.string)
                                      : cv_usejoystick2.value;
    ...
    if (choice <= numjoys) {
      ...
      if (oldchoice != choice) {
        ...
        if (oldstringchoice == (atoi(cv_usejoystick2.string) > numjoys
                                    ? atoi(cv_usejoystick2.string)
                                    : cv_usejoystick2.value))
          M_StartMessage("This joystick is used by another\n"
                         "player. Reset the joystick\n"
    ...
    oldchoice = oldstringchoice = atoi(cv_usejoystick.string) > numjoys
                                      ? atoi(cv_usejoystick.string)
                                      : cv_usejoystick.value;
    ...
    if (choice <= numjoys) {
      ...
      if (oldchoice != choice) {
        ...
        if (oldstringchoice == (atoi(cv_usejoystick.string) > numjoys
                                    ? atoi(cv_usejoystick.string)
                                    : cv_usejoystick.value))
          M_StartMessage("This joystick is used by another\n"
                         "player. Reset the joystick\n"
...
static void M_Setup1PControlsMenu(INT32 choice) {
  ...
  setupcontrolplayer = 1;
  setupcontrols =
      gamecontrol; // was called from main Options (for console player, then)
  currentMenu->lastOn = itemOn;
...
static void M_DrawControl(void) {
  ...
  */
  ...
  for (i = itemOn;
       ((iter || currentMenu->menuitems[i].status == IT_GRAYEDOUT2) && i > 0);
       i--) {
  ...
  M_CentreText(28, (setupcontrolplayer > 1 ? va("\x86"
                                                "Set controls for "
                                                "\x82"
                                                "Player %d",
                                                setupcontrolplayer)
  ...
  if (i)
    V_DrawCharacter(currentMenu->x - 16, y - (skullAnimCounter / 5),
                    ...
                    false); // up arrow
  if (max != currentMenu->numitems)
    V_DrawCharacter(currentMenu->x - 16,
                    y + (SMALLLINEHEIGHT * (controlheight - 1)) +
                        (skullAnimCounter / 5) + (skullAnimCounter / 5),
                    '\x1B' | highlightflags,
                    false); // down arrow
  ...
  for (; i < max; i++) {
    ...
    if (currentMenu->menuitems[i].status == IT_CONTROL) {
      V_DrawString(x, y, ((i == itemOn) ? highlightflags : 0),
                   currentMenu->menuitems[i].text);
...
static void M_ChangecontrolResponse(event_t *ev) {
  ...
  if (ch != KEY_ESCAPE && ch != KEY_PAUSE) {
    ...
    // This buffer assumes a 125-character message plus a 32-character control
    // name (per controltochangetext buffer size)
    static char tmp[158];
    ...
    if (controltochange == gc_pause)
      sprintf(
          tmp,
          M_GetText("The \x82Pause Key \x80is enabled, but \nyou may select "
                    "another key. \n\nHit another key for\n%s\nESC for Cancel"),
          controltochangetext);
    else
      sprintf(tmp,
              M_GetText(
                  "The \x82Pause Key \x80is enabled, but \nit is not "
                  "configurable. \n\nHit another key for\n%s\nESC for Cancel"),
              controltochangetext);
...
static void M_ChangeControl(INT32 choice) {
  // This buffer assumes a 35-character message (per below) plus a max control
  // name limit of 32 chars (per controltochangetext) If you change the below
  // message, then change the size of this buffer!
  static char tmp[68];
...
static void M_ResetControls(INT32 choice) {
  (void)choice;
  M_StartMessage(va(M_GetText("Reset Player %d's controls to "
                              "defaults?\n\n(Press 'Y' to confirm)\n"),
                    setupcontrolplayer),
                 M_ResetControlsResponse, MM_YESNO);
}
...
static void M_DrawVideoMenu(void) {
  ...
  V_DrawRightAlignedString(BASEVIDWIDTH - currentMenu->x,
                           currentMenu->y + OP_VideoOptionsMenu[0].alphaKey,
                           (SCR_IsAspectCorrect(vid.width, vid.height)
                                ? recommendedflags
                                : highlightflags),
...
static void M_DrawHUDOptions(void) {
  ...
  INT32 w0 = V_StringWidth(str0, 0), w1 = V_StringWidth(str1, 0),
        w2 = V_StringWidth(str2, 0), w3 = V_StringWidth(str3, 0);
...
static void M_DrawVideoMode(void) {
  ...
  V_DrawCenteredString(BASEVIDWIDTH / 2, OP_VideoModeDef.y, highlightflags,
                       "Choose mode, reselect to change default");
  ...
  for (i = 0; i < vidm_nummodes; i++) {
    ...
    // Show multiples of 320x200 as green.
      ...
      V_DrawString(row, col, (modedescs[i].goodratio) ? recommendedflags : 0,
                   modedescs[i].desc);
  ...
  if (vidm_testingmode > 0) {
    ...
    M_CentreText(OP_VideoModeDef.y + 158, "or press ESC to return");
    ...
    M_CentreText(OP_VideoModeDef.y + 116,
                 va("Current mode is %c%dx%d",
                    ...
                    vid.width, vid.height));
    M_CentreText(
        OP_VideoModeDef.y + 124,
        va("Default mode is %c%dx%d",
           (SCR_IsAspectCorrect(cv_scr_width.value, cv_scr_height.value))
               ? 0x83
               : 0x80,
    ...
    V_DrawCenteredString(BASEVIDWIDTH / 2, OP_VideoModeDef.y + 158,
                         highlightflags,
                         "Larger modes may have performance issues.");
  }
  ...
  V_DrawScaledPatch(i - 8, j, 0, W_CachePatchName("M_CURSOR", PU_CACHE));
}
...
static consvar_t *kartitemcvs[NUMKARTRESULTS - 1] = {
    &cv_sneaker,       &cv_rocketsneaker,
    &cv_invincibility, &cv_banana,
    &cv_eggmanmonitor, &cv_orbinaut,
    &cv_jawz,          &cv_mine,
    &cv_ballhog,       &cv_selfpropelledbomb,
    &cv_grow,          &cv_shrink,
    &cv_thundershield, &cv_hyudoro,
    &cv_pogospring,    &cv_kitchensink,
    &cv_triplesneaker, &cv_triplebanana,
    &cv_decabanana,    &cv_tripleorbinaut,
    &cv_quadorbinaut,  &cv_dualjawz};
...
static void M_DrawMonitorToggles(void) {
  ...
  for (i = leftdraw; i <= rightdraw; i++) {
    ...
    for (j = 0; j < height; j++) {
      ...
      if (currentMenu->menuitems[thisitem].alphaKey == 255) {
        V_DrawScaledPatch(x, y, V_TRANSLUCENT,
                          W_CachePatchName("K_ISBG", PU_CACHE));
        continue;
      }
#endif
      ...
      if (drawnum != 0) {
        ...
        V_DrawScaledPatch(
            x, y, translucent,
            W_CachePatchName(
                K_GetItemPatch(currentMenu->menuitems[thisitem].alphaKey, true),
                PU_CACHE));
        V_DrawString(x + 24, y + 31, V_ALLOWLOWERCASE | translucent,
                     va("x%d", drawnum));
      } else
        V_DrawScaledPatch(
            x, y, translucent,
...

  {
    ...
    if (currentMenu->menuitems[itemOn].alphaKey == 255) {
      V_DrawScaledPatch(onx - 1, ony - 2, V_TRANSLUCENT,
                        W_CachePatchName("K_ITBG", PU_CACHE));
      if (shitsfree) {
        ...
        V_DrawScaledPatch(onx - 1, ony - 2, trans,
                          W_CachePatchName("K_ITFREE", PU_CACHE));
      }
    } else
#endif
        if (currentMenu->menuitems[itemOn].alphaKey == 0) {
      V_DrawScaledPatch(onx - 1, ony - 2, 0,
                        W_CachePatchName("K_ITBG", PU_CACHE));
      V_DrawScaledPatch(onx - 1, ony - 2, 0,
                        W_CachePatchName("K_ITTOGL", PU_CACHE));
    } else {
      ...
      if (cv->value)
        ...
        V_DrawScaledPatch(onx - 1, ony - 2, 0,
                          W_CachePatchName("K_ITBGD", PU_CACHE));

      if (drawnum != 0) {
        V_DrawScaledPatch(onx - 1, ony - 2, 0,
                          W_CachePatchName("K_ITMUL", PU_CACHE));
        V_DrawScaledPatch(
            onx - 1, ony - 2, translucent,
            W_CachePatchName(
                K_GetItemPatch(currentMenu->menuitems[itemOn].alphaKey, false),
                PU_CACHE));
        V_DrawScaledPatch(onx + 27, ony + 39, translucent,
                          W_CachePatchName("K_ITX", PU_CACHE));
  ...
  V_DrawCenteredString(BASEVIDWIDTH / 2, currentMenu->y, highlightflags,
                       va("* %s *", currentMenu->menuitems[itemOn].text));
}
...
static INT32 quitsounds[] = {
    ...
    sfx_kc2e,  sfx_kc2f,   sfx_cdfm01, sfx_ddash,  sfx_s3ka2,  sfx_s3k49,
    sfx_slip,  sfx_tossed, sfx_s3k7b,  sfx_itrolf, sfx_itrole, sfx_cdpcm9,
    sfx_s3k4e, sfx_s259,   sfx_3db06,  sfx_s3k3a,  sfx_peel,   sfx_cdfm28,
    sfx_s3k96, sfx_s3kc0s, sfx_cdfm39, sfx_hogbom, sfx_kc5a,   sfx_kc46,
    sfx_s3k92, sfx_s3k42,  sfx_kpogos, sfx_screec};
...
void M_QuitResponse(INT32 ch) {
  ...
  if (!(netgame || cv_debug)) {
    ...
    ptime =
        I_GetTime() +
        NEWTICRATE *
            2; // Shortened the quit time, used to be 2 seconds Tails 03-26-2001
    while (ptime > I_GetTime()) {
      V_DrawFill(0, 0, BASEVIDWIDTH, BASEVIDHEIGHT, 31);
      V_DrawSmallScaledPatch(
          0, 0, 0,
          W_CachePatchName("GAMEQUIT",
                           PU_CACHE)); // Demo 3 Quit Screen Tails 06-16-2001
...
static void M_QuitSRB2(INT32 choice) {
  ...
  (void)choice;
  M_StartMessage(quitmsg[M_RandomKey(NUM_QUITMESSAGES)], M_QuitResponse,
                 MM_YESNO);
}
...
static void M_OGL_DrawColorMenu(void) {
  ...
  V_DrawString(mx, my + currentMenu->menuitems[0].alphaKey - 10, highlightflags,
               "Gamma correction");
}
...
static void M_DrawSticker(INT32 x, INT32 y, INT32 width, INT32 flags,
                          boolean isSmall) {
  patch_t *stickerEnd;
  INT32 height;
  ...
  V_DrawFixedPatch(x * FRACUNIT, y * FRACUNIT, FRACUNIT, flags, stickerEnd,
                   NULL);
  V_DrawFill(x, y, width, height, 24 | flags);
  V_DrawFixedPatch((x + width) * FRACUNIT, y * FRACUNIT, FRACUNIT,
                   flags | V_FLIP, stickerEnd, NULL);
}
...
static void M_DrawDiscordRequests(void) {
  ...
  if (confirmDelay > 0) {
    if (confirmAccept == true) {
      colormap =
          R_GetTranslationColormap(TC_DEFAULT, SKINCOLOR_GREEN, GTC_MENUCACHE);
      hand = W_CachePatchName("K_LAPH02", PU_CACHE);
    } else {
      colormap =
          R_GetTranslationColormap(TC_DEFAULT, SKINCOLOR_RED, GTC_MENUCACHE);
    ...
    colormap =
        R_GetTranslationColormap(TC_DEFAULT, SKINCOLOR_GREY, GTC_MENUCACHE);
  }

  V_DrawFixedPatch(56 * FRACUNIT, 150 * FRACUNIT, FRACUNIT, 0,
                   W_CachePatchName("K_LAPE01", PU_CACHE), colormap);

  if (hand != NULL) {
    fixed_t handoffset = (4 - abs((signed)(skullAnimCounter - 4))) * FRACUNIT;
    V_DrawFixedPatch(56 * FRACUNIT, 150 * FRACUNIT + handoffset, FRACUNIT, 0,
                     hand, NULL);
  }

  M_DrawSticker(x + (slide * 32), y - 1,
                V_ThinStringWidth(M_GetDiscordName(curRequest),
                                  V_ALLOWLOWERCASE | V_6WIDTHSPACE),
                0, false);
  V_DrawThinString(x + (slide * 32), y,
                   V_ALLOWLOWERCASE | V_6WIDTHSPACE | V_YELLOWMAP,
                   M_GetDiscordName(curRequest));

  M_DrawSticker(x, y + 12,
                V_ThinStringWidth(wantText, V_ALLOWLOWERCASE | V_6WIDTHSPACE),
                0, true);
  V_DrawThinString(x, y + 10, V_ALLOWLOWERCASE | V_6WIDTHSPACE, wantText);

  M_DrawSticker(
      x, y + 26,
      V_ThinStringWidth(controlText, V_ALLOWLOWERCASE | V_6WIDTHSPACE), 0,
      true);
  ...
  while (curRequest->next != NULL) {
    ...
    M_DrawSticker(x, y - 1 + ySlide,
                  V_ThinStringWidth(M_GetDiscordName(curRequest),
                                    V_ALLOWLOWERCASE | V_6WIDTHSPACE),
                  0, false);
    V_DrawThinString(x, y + ySlide, V_ALLOWLOWERCASE | V_6WIDTHSPACE,
                     M_GetDiscordName(curRequest));
