...
// dehacked.c now has lists for the more named enums! PLEASE keep them up to
...
typedef enum sprite {
  ...
  SPR_LZI2, // ditto
  SPR_KLIT, // You have a twisted mind. But this actually is for the diagonal
            // lightning.
  ...
  // First person view sprites; this is a sprite so that it can be replaced by a
  // specialized MD2 draw later
  SPR_VIEW,
...
typedef enum state {
  ...
  S_PLAY_SUPERTRANS7,
  S_PLAY_SUPERTRANS8,
  S_PLAY_SUPERTRANS9, // This has special significance in the code. If you add
  more frames, search for it and make the appropriate changes.
  */
  ...
  S_ROAMINGSHADOW, // Roaming Shadow (the one that uses above's wind attack or
                   // smth)
...
typedef struct {
  spritenum_t sprite;
  UINT32
  frame; // we use the upper 16 bits for translucency and other shade effects
  INT32 tics;
  actionf_t action;
  INT32 var1;
  INT32 var2;
