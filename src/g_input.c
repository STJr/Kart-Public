...
void G_Controldefault(UINT8 player)
{
	if (player == 0 || player == 1)
	{
		...
		//gamecontrol[gc_talkkey    ][1] = KEY_HAT1+2; // D-Pad Left // useless for 90% of players
		gamecontrol[gc_scores     ][1] = KEY_HAT1+0; // D-Pad Up (previously gamecontrol[gc_scores     ][1] = KEY_HAT1+3; // D-Pad Right)
	}
