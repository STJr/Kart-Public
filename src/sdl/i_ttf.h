...
//-----------------------------------------------------------------------------
/// \file
/// \brief SDL_ttf interface code. Necessary for platforms with SDL inits that
...
// Draw TTF text to screen. It will accept four colour vales (red, green, blue
// and alpha) with foreground for draw modes Solid and Blended, and an extra
// four values for background colour with draw type Shaded.
