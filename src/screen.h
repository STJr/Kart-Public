...
typedef struct viddef_s {
  ...
  INT32 height;
  union { // don't need numpages for OpenGL, so we can use it for
          // fullscreen/windowed
    // mode
  ...
  INT32 /*fixed_t*/ fdupx, fdupy; // same as dupx, dupy, but exact value when
                                  // aspect ratio isn't 320/200
...
extern consvar_t cv_scr_width, cv_scr_height, cv_scr_depth, cv_renderview,
    cv_fullscreen, cv_vhseffect, cv_shittyscreen;
