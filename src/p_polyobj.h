...
typedef struct polyobj_s {
  ...
  struct visplane_s *visplane; // polyobject's visplane, for ease of putting
                               // into the list later
...
INT32
EV_DoPolyDoor(polydoordata_t *);
INT32
EV_DoPolyObjMove(polymovedata_t *);
INT32
EV_DoPolyObjWaypoint(polywaypointdata_t *);
INT32
EV_DoPolyObjRotate(polyrotdata_t *);
INT32
EV_DoPolyObjDisplace(polydisplacedata_t *);
INT32
EV_DoPolyObjFlag(struct line_s *);
