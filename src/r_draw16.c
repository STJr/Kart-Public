...
void R_DrawColumn_16(void) {
  ...
  do {
    // Re-map color indices from wall texture column using a lighting/special
    // effects LUT.
    *dest =
        hicolormaps[((INT16 *)(void *)dc_source)[(frac >> FRACBITS) & 127] >>
                    1];
...
void R_DrawWallColumn_16(void) {
  ...
  do {
    *dest =
        hicolormaps[((INT16 *)(void *)dc_source)[(frac >> FRACBITS) & 255] >>
                    1];
...
void R_DrawTranslucentColumn_16(void) {
  ...
  do {
    *dest = (INT16)((INT16)((color8to16[dc_source[frac >> FRACBITS]] >> 1) &
                            0x39ce) +
...
void R_DrawTranslatedColumn_16(void) {
  ...
  do {
    *dest =
        color8to16[dc_colormap[dc_translation[dc_source[frac >> FRACBITS]]]];
    dest += vid.width;
