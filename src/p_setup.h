...
// returns true if setup finished on this call, false otherwise (always true on
// fullsetup) throws I_Error if called without any partial adds started as a
// safeguard
