...
const char *KartColor_Names[MAXSKINCOLORS] =
{
	...
	"Canary",         // 28 // SKINCOLOR_CANARY
	"Peach",          // 29 // SKINCOLOR_PEACH
	"Creamsicle",     // 30 // SKINCOLOR_CREAMSICLE
	"Gold",           // 31 // SKINCOLOR_GOLD
	"Caramel",        // 32 // SKINCOLOR_CARAMEL
	"Vomit",          // 33 // SKINCOLOR_VOMIT
