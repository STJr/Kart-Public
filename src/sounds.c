...
sfxinfo_t S_sfx[NUMSFX] = {
    ...
    *****/
    ...
    //  name, singularity, priority, pitch, volume, data, length, skinsound,
    //  usefulness, lumpnum
    ...
    {"putput", false, 64, 0, -1, NULL, 0, SKSPUTPUT, -1,
     LUMPERROR}, // not as high a priority
    ...
    {"crumbl", true, 127, 0, -1, NULL, 0, -1, -1,
     LUMPERROR}, // Platform Crumble Tails 03-16-2001
    ...
    {"steam1", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Tails
                                                              // 06-19-2001
    {"steam2", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Tails
                                                              // 06-19-2001
    ...
    {"splish", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Splish Tails
                                                              // 12-08-2000
    ...
    {"wslap", false, 32, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Water Slap Tails
                                                             // 12-13-2000
    ...
    {"cgot", true, 120, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Got Emerald!
                                                            // Tails 09-02-2001
    ...
    {"strpst", true, 192, 0, -1, NULL, 0, -1, -1,
     LUMPERROR}, // Starpost Sound Tails 07-04-2002
    ...
    {"ptally", true, 64, 0, -1, NULL, 0, -1, -1,
     LUMPERROR}, // Point tally is identical to menu for now
    {"radio", false, 60, 0, -1, NULL, 0, -1, -1, LUMPERROR},
    {"wepchg", true, 64, 0, -1, NULL, 0, -1, -1,
     LUMPERROR}, // Weapon switch is identical to menu for now
    {"wtrdng", true, 212, 0, -1, NULL, 0, -1, -1,
     LUMPERROR}, // make sure you can hear the DING DING! Tails 03-08-2000
    ...
    {"ncspec", false, 204, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Tails
                                                               // 12-15-2003
    ...
    {"s1ac", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Misc. obstacle
                                                            // destroyed
    ...
    {"s1c9", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Item hit w/
                                                            // voices off
    ...
    {"s23e", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Title screen
                                                            // opening
    ...
    {"s25f", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Perfect start
                                                            // boost
    ...
    {"s3k42", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Kart Thunder
                                                             // Shield spawned
    ...
    {"s3k54", false, 64, 64, -1, NULL, 0, -1, -1, LUMPERROR}, // MetalSonic shot
                                                              // fire
    ...
    {"s3k7b", false, 96, 16, -1, NULL, 0, -1, -1, LUMPERROR}, // Kart successful
                                                              // hit
    ...
    {"s3k83", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Overcharged
                                                             // start boost
    ...
    {"s3ka2", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Kart drift spark
                                                             // gain
    ...
    {"s3kd8s", false, 64, 64, -1, NULL, 0, -1, -1,
     LUMPERROR}, // Sharp Spin (maybe use the long/L version?)
    ...
    // 3D Blast sounds (the "missing" ones are direct copies of S3K's, no minor
    ...
    // Sonic CD sounds
    {"cdfm00", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Undercharged
                                                              // start boost
    ...
    {"cdfm17", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Brake drift
                                                              // ambient
    {"cdfm18", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},
    {"cdfm19", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // CD SS1 UFO
                                                              // death
    ...
    {"cdfm28", false, 96, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Eggman item
                                                              // landing
    ...
    {"cdfm70", false, 96, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Trail item
                                                              // dragging
    ...
    {"kc31", false, 64, 64, -1, NULL, 0, -1, -1, LUMPERROR}, // NO CONTEST
                                                             // explosion
    ...
    {"kc42", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Unlock everything
                                                            // cheat
    ...
    {"kc51", false, 64, 64, -1, NULL, 0, -1, -1, LUMPERROR}, // NO CONTEST
                                                             // debris ambience
    ...
    {"screec", false, 48, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Tight turning
                                                              // screech
    {"drift", false, 48, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Drifting ambient
    {"ruburn", false, 48, 0, -1, NULL, 0, -1, -1, LUMPERROR},  // Rubber-burn
                                                               // turn ambient
    {"ddash", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},   // Respawn Drop
                                                               // Dash
    {"tossed", false, 192, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Item fired
    {"itpick", false, 128, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Pick up HUD
                                                               // drop
    {"peel", false, 96, 0, -1, NULL, 0, -1, -1, LUMPERROR},   // Edited S25A for
                                                              // banana landing
    {"hogbom", false, 96, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Ballhog
                                                              // explosions
    {"zio3", false, 128, 8, -1, NULL, 0, -1, -1, LUMPERROR},  // Thunder Shield
                                                              // use
    {"kpogos", false, 96, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Pogo Spring use
    {"alarmi", false, 255, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Invincibility
                                                               // alarm
    {"alarmg", false, 255, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Grow alarm
    {"kinvnc", false, 255, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Invincibility
                                                               // music
    {"kgrow", false, 255, 8, -1, NULL, 0, -1, -1, LUMPERROR},  // Grow music
    {"itrol1", true, 96, 0, -1, NULL, 0, -1, -1, LUMPERROR},   // Roulette
                                                               // spinning
    ...
    {"itrolm", true, 96, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Roulette end
                                                             // (mashed)
    {"itrolk", true, 96, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Roulette end
                                                             // (karma enhanced)
    {"itrole", true, 96, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Roulette end
                                                             // (Eggman)
    {"vroom", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Kart Krew
                                                             // opening vroom
    {"chaooo", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Chao audience
                                                              // cheer
    {"yeeeah", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Voting picks
                                                              // you
    {"noooo1", false, 64, 0, -1, NULL, 0, -1, -1,
     LUMPERROR}, // Voting picks hell (by chance)
    {"noooo2", false, 64, 0, -1, NULL, 0, -1, -1,
     LUMPERROR}, // Voting picks hell (on purpose)
    {"ruby1", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},  // Phantom Ruby
                                                              // charge up
    {"ruby2", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},  // Phantom Ruby
                                                              // teleport
    {"tcart", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},  // Twinkle Cart
    {"bfare", false, 128, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Pleasure Castle
                                                              // fanfare
    {"merry", false, 64, 0, -1, NULL, 0, -1, -1,
     LUMPERROR}, // Pleasure Castle merry-go-round ambient
    {"bowlh", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},  // Pleasure Castle
                                                              // pins
    {"tppop", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},  // Pleasure Castle
                                                              // bombs
    {"hsdoor", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Red Barrage
                                                              // Area door
    {"hstrn", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Red Barrage Area
                                                             // train
    {"aspkb", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR}, // Red Barrage Area
                                                             // spikeballs
    {"wind1", false, 64, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Midnight Channel
                                                             // monsters
    {"fire2", false, 64, 8, -1, NULL, 0, -1, -1, LUMPERROR},
    {"chain", false, 255, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Mementos Reaper
    {"mkuma", false, 96, 8, -1, NULL, 0, -1, -1, LUMPERROR},  // Trigger Happy
                                                              // Havoc Monokuma
    {"toada", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},  // Arid Sands Toad
                                                              // scream
    {"gemhit", false, 64, 0, -1, NULL, 0, -1, -1,
     LUMPERROR}, // Opulence gem/coin tumbling
    {"wrink", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},   // Some sort of
                                                               // ghoulie?
    {"bsnipe", false, 96, 8, -1, NULL, 0, -1, -1, LUMPERROR},  // Banana sniping
    {"join", true, 96, 8, -1, NULL, 0, -1, -1, LUMPERROR},     // Player joined
                                                               // server
    {"leave", true, 96, 8, -1, NULL, 0, -1, -1, LUMPERROR},    // Player left
                                                               // server
    {"requst", true, 96, 8, -1, NULL, 0, -1, -1, LUMPERROR},   // Got a Discord
                                                               // join request
    {"syfail", true, 96, 8, -1, NULL, 0, -1, -1, LUMPERROR},   // Funny sync
                                                               // failure
    {"itfree", false, 64, 0, -1, NULL, 0, -1, -1, LUMPERROR},  // :shitsfree:
    {"dbgsal", false, 255, 8, -1, NULL, 0, -1, -1, LUMPERROR}, // Debug
                                                               // notification
